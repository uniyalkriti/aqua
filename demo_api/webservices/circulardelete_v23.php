...
/*
$q ="select id from person where id = '$user_id'";
...
$q="update person_login set circular_id = '' where person_id = $person_id ";
//echo $q;die;
$res3 = mysqli_query($dbc, $q);
if($res3){
	echo"Y";
}
$qu="update circular set status = 'Deleted' where id = $circular_id AND circular_for_persons = $person_id ";
//echo $qu;die;
