   ...
   // print_r($voucher_list);
	...
	foreach($voucher_list as $co=>$coo)
	{
	   ...
	   // print_r($start);
		...
		if(!$result){
            ...
            if(!empty($product_list1)){
	     	...
	     	if($ncheck<=0){	
	     	$str[]="('$rId','$product_id','$product_name','$qty','$rate','$gst','$gst_amt','$dis_per','$dis_amt','$taxable_amt','$item_for','CR')";
	     	//print_r($str);
	     }else{
	     	$str[]="('$check_id','$product_id','$product_name','$qty','$rate','$gst','$gst_amt','$dis_per','$dis_amt','$taxable_amt','$item_for','CR')";
	     	//print_r($str);
	     }
		}
	  }
	  if(!empty($product_list2)){
	     	...
	     	$taxable_amt=str_replace(",","",$taxable_amt);
	     	if($ncheck<=0){	
	     	$str[]="('$rId','$product_id','$product_name','$qty','$rate','$gst','$gst_amt','$dis_per','$dis_amt','$taxable_amt','$item_for','DR')";
	     	//print_r($str);
	     }else{
	     	$str[]="('$check_id','$product_id','$product_name','$qty','$rate','$gst','$gst_amt','$dis_per','$dis_amt','$taxable_amt','$item_for','DR')";
	     	//print_r($str);
	     }
		}
	  }
	        ...
	        $strs = implode(',', $str);
	     	...
	     	if(!empty($strs)){
	     	$qdet="INSERT IGNORE `tally_demo_details`(`td_id`, `product_id`, `product_name`, `qty`, `rate`, `gst`, `gst_amt`, `dis_per`, `dis_amt`,`taxable_amt`,`item_for`,`cr_dr`) VALUES $strs";
