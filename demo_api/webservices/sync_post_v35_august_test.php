...
//                echo $cmp_query;die;
        ...
        if (!empty($dailyReporting)) {
            ...
            foreach ($dailyReporting as $newda) {
                ...
                $workTrackArray[] = "('$user_id','$c_date','$cs_time','$mcc_mnc_lac_cellid','$latlng','$geo_address','Daily Reporting',NOW(),'$battery_status','$gps_status','$company_id')";
            ...
            $daily_reporting_track="INSERT INTO `user_work_tracking`(`user_id`, `track_date`, `track_time`, `mnc_mcc_lat_cellid`, `lat_lng`, `track_address`, `status`, `server_date_time`,`battery_status`,`gps_status`,`company_id`) VALUES $workTrackArray";
        ...
        if (!empty($createcustomer)) {
            ...
            while ($cc < $customer) {
               ...
               // die;
                ...
                $workTrackArray[] = "('$user_id','$cr_date','$cr_time','$mccmnclaccellid','$lat_lng','$full_address','Retailer Creation',NOW(),'$battery_status','$gps_status','$company_id')";
...
//                     }
            ...
            $explodeString = implode(',',$workTrackArray);

             $retailer_track="INSERT INTO `user_work_tracking`(`user_id`, `track_date`, `track_time`, `mnc_mcc_lat_cellid`, `lat_lng`, `track_address`, `status`, `server_date_time`,`battery_status`,`gps_status`,`company_id`) VALUES $explodeString ";
        ...
        if (!empty($tracking)) {
            ...
            while ($tr < $track) {
                ...
                if ($num < 1) {
                    ...
                    $workTrackArray[] = "('$user_id','$track_date','$track_time','$mnc_mcc_lat_cellid','$lat_lng','$user_location','Tracking',NOW(),'$battery_status','$gps_status','$company_id')";
            ...
            $explodeString = explode(',',$workTrackArray);
            $qd="INSERT INTO `user_work_tracking`(`user_id`, `track_date`, `track_time`, `mnc_mcc_lat_cellid`, `lat_lng`, `track_address`, `status`, `server_date_time`,`battery_status`,`gps_status`,`company_id`) VALUES $explodeString";
            $rd = mysqli_query($dbc, $qd);
