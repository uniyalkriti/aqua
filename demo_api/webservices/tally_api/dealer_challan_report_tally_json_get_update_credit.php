	   ...
	   // print_r($start);
		...
		if(!$result){
            ...
            $str=array();
	     	...
	     	if($ncheck<=0){	
	     	$str[]="('$rId','$product_id','$product_name','$qty','$uint','$rate','$gst','$gst_amt','$dis_per','$dis_amt','$taxable_amt','$item_for')";
	     	//print_r($str);
	     }else{
	     	$str[]="('$check_id','$product_id','$product_name','$qty','$uint','$rate','$gst','$gst_amt','$dis_per','$dis_amt','$taxable_amt','$item_for')";
	     	//print_r($str);
	     }
		}
			$strs='';
