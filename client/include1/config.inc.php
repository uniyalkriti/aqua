...
define('PANEL_NAME', 'DS Spiceco Distributor Panel'); // The text that will be displayed across the ws logo.
define('GEN_TITLE', 'DS Spiceco Pvt. Ltd.   - Powered by Manacle Technologies (P) Ltd');
define('FOOTER', 'Copyright &copy; 2013 - 2017 DS Spiceco Pvt. Ltd. & Co. All rights reserved. ');
define('SESS', 'iclientdigimet'); // to allow multiple session of admin of different sites simultaneously open without conflict
define('EDSALT', 'dsgroup'); // this salt will be used to store the encrypted & decrypted password for users & admin mywerp//myclientdigimet
