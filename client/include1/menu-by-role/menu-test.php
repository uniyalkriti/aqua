    ...
    <ul>
      ...
      <li>
        ...
        <div id="academics" class="yui3-menu">
	      ...
	      <?php if(!empty($_SESSION[SESS.'data']['company_id'])) { ?>
              ...
              <li class="yui3-menuitem">
               ...
               <li class="yui3-menuitem">
                ...
                <div id="about" class="yui3-menu">
                  <div class="yui3-menu-content">
                    <ul>                        
                      <li class="yui3-menuitem"><a class="yui3-menuitem-content" href="index.php?option=add-user">User</a></li>
                      <li class="yui3-menuitem"><a class="yui3-menuitem-content" href="index.php?option=dealer-multi-wise-location">Dealer Location</a></li>
          ...
          <div class="yui3-menu-content">
            <ul> 
              <li class="yui3-menuitem"><a class="yui3-menuitem-content" href="index.php?option=sale-order-detailes">Sale Details</a></li>
               <li class="yui3-menuitem"><a class="yui3-menuitem-content" href="index.php?option=dsp-challan-list">Challan List</a></li>
