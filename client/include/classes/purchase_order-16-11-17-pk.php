...
// pre($_POST['quantity']); exit;
$extrawork = $this->purchase_order_extra('save', $orderno, $_POST['product_id'], $_POST['batch_no'], $_POST['base_price'], $_POST['quantity'], $_POST['scheme_quantity'],$_POST['purchase_inv'], $_POST['mfg_date'], $_POST['expiry_date'], $_POST['sale_price'],$_POST['company_id'],$_POST['cp']);
}
if (!$extrawork['status']) {
mysqli_rollback($dbc);
...
$str[] = "('$rId', '$value', '{$base_price[$key]}', '{$quantity[$key]}','{$scheme[$key]}', '$mfdate', '$expdate', '{$purchase_inv[$key]}','{$sale_price[$key]}', '{$cases[$key]}')";
...
$str[] = "('$rId', '$value', '{$base_price[$key]}', '{$quant[$key]}','{$schem[$key]}', '$mfdate', '$expdate', '{$purchase_inv[$key]}','{$sale_price[$key]}', '{$quantity[$key]}')";
...
$q = "INSERT INTO `purchase_order_details` (`order_id`, `product_id`, `rate`, `quantity`,`scheme_qty`,`purchase_inv`, `mfg_date`, `expiry_date`, `pr_rate`,`cases`) VALUES $str";
