        ...
        while ($row = mysqli_fetch_assoc($rs)) {
           ...
           $out[$id]['retailer_id'] = $retailer_map;
            ...
            $q = "SELECT challan_order_details.*,challan_order_details.product_id AS pid, "
                    . "catalog_product.name,catalog_product_rate_list.surcharge,"
                    . "catalog_product_rate_list.comunity_code,catalog_product.hsn_code FROM "
                    ...
                    . " AND catalog_product_rate_list.stateId ='$state_id'  WHERE ch_id = $id GROUP BY challan_order_details.product_id,challan_order_details.ch_id ";
    ...
    public function direct_challan_edit($id) {
      ...
      //  pre($d1); exit;
        ...
        if (!empty($d1['product_id'])) {
         ...
         $q="UPDATE `challan_order` SET `ch_no`='$chlaan_no',`ch_created_by`='$d1[uid]',
        ...
        $nid= $id;
         ...
         $q = "INSERT INTO challan_order_details (`ch_id`,`product_id`,`qty`,`product_rate`, `free_qty`,`tax`,`mrp`,`cd`,`cd_type`,`cd_amt`,`batch_no`,`dis_type`,`dis_amt`,`dis_percent`,`taxable_amt`,`remain_amount`,`vat_amt`) VALUES $str";
