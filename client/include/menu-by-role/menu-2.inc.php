    ...
    <body class="no-skin" style="font-family: 'Open Sans'; font-weight: bolder;">
      <div id="navbar" class="navbar navbar-default    navbar-collapse       h-navbar ace-save-state" style="height: 0px; background-color: #90d781; color:black; font-weight:bolder; font-family: 'Open Sans'; " >
        <div class="navbar-container ace-save-state" id="navbar-container">
          <div class="navbar-header pull-left">
            ...
            <a href="index.php" class="navbar-brand" style="color:black; font-weight: bolder;">
              <small>
		...
		//h1($query);
			...
			//h1($qs);
                     ...
                     <li class="transparent dropdown-modal">
                      <a title="LOW BALANCE STOCK OF (<?=$i?>) PRODUCTS" class="iframef" href="index.php?option=demand-order&showmode=1&mode=1" style="color: black;">
                    ...
                    <li class="transparent dropdown-modal">
                      <a title="Updtae Profile"  href="index.php?option=update-profile" style="color: black;">
            ...
            <?php 
                if($_SESSION[SESS.'signup_status'] == 1)
                {
                  ...
                  echo'<li class="active open hover">';    
                   ...
                   echo'<li class="open hover">'; ?>  
                    ...
                    <ul class="submenu">
                      ...
                      <li class="hover">
                        <a href="index.php?option=company">
                          <i class="menu-icon fa fa-caret-right"></i>
                          Brands
                        </a>
                        <b class="arrow"></b>
                      ...
                      <li class="hover">
                        <a href="index.php?option=brand-product">
                          <i class="menu-icon fa fa-caret-right"></i>
                          ...
                          <li class="hover">
                            ...
                            <b class="arrow"></b>
                                  ...
                                  <li class="active open hover">
                                    ...
                                    <ul class="submenu"> 
                            <li class="hover">
                            <a href="index.php?option=opening_stock">
                              <i class="menu-icon fa fa-caret-right"></i>
                              Opening Stock
                            </a>
                            <b class="arrow"></b>
                           ...
                           <li class="hover">
                        <a href="index.php?option=import_opening_stock">
                              <i class="menu-icon fa fa-caret-right"></i>
                  ...
                  echo'<li class="active open hover">';    
                   ...
                   echo'<li class="open hover">'; ?> 
                    ...
                    <ul class="submenu">
					  ...
					  <li class="hover">
                        <a href="index.php?option=direct-challan-retail">
                          <i class="menu-icon fa fa-caret-right"></i>
                  ...
                  if($menu=='payment')
                      ...
                      echo'<li class="active open hover">';    
                       ...
                       echo'<li class="open hover">'; ?> 
                        ...
                        <ul class="submenu">
                          <li class="hover">
                            <a href="index.php?option=old_payment">
                              <i class="menu-icon fa fa-caret-right"></i>
                              Old Dues
                            </a>
                            <b class="arrow"></b>
                          ...
                          <li class="hover">
                            <a href="index.php?option=payment-new">
                              <i class="menu-icon fa fa-caret-right"></i>
                              Payment Collection
                            </a>
                            <b class="arrow"></b>
                             ...
                             <li class="hover">
                                <a href="index.php?option=direct-challan-damage">
                                  <i class="menu-icon fa fa-caret-right"></i>
                              ...
                              <!-- new menu added -->
                              <li class="hover">
                                <a href="index.php?option=direct-challan-damage-depot">
                                  <i class="menu-icon fa fa-caret-right"></i>
                              ...
                              <li class="hover">
                                <a href="index.php?option=make-challan-damage">
                                  <i class="menu-icon fa fa-caret-right"></i>
                              ...
                              <li class="hover">
                                <a href="index.php?option=make-challan-damage-depot">
                                  <i class="menu-icon fa fa-caret-right"></i>
                      ...
                      <!-- <?php if($menu=='direct-challan-damage'||$menu=='make-challan-damage')
                      echo'<li class="active open hover">';    
                      else
                       echo'<li class="open hover">'; ?> 
                        <a href="#" class="dropdown-toggle">
                       ...
                       echo'<li class="open hover">'; ?> 
                        ...
                        <ul class="submenu">
                         ...
                         <li class="active open hover">
                          ...
                          <ul class="submenu">
                          <li class="hover">
                                        <a href="index.php?option=dealer-sale-performance">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=retailer-wise-sale-performance">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=product-wise-sale-performance">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=order-sale-performance">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=retailer-wise-sale-order-performance">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                   ...
                                   <!-- <li class="hover">
                                     ...
                                     <li class="hover">
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=bill-purchase-performance">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                    ...
                                    <!--   <li class="hover">
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=division_summary_report">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=division-wise">
                                          <i class="menu-icon fa fa-caret-right"></i>
                          ...
                          <ul class="submenu">
                                  ...
                                  <li class="active open hover">
                                    ...
                                    <ul class="submenu">
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=stock_summary">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                          Stock Summary
                                        </a>
                                        <b class="arrow"></b>
                                    ...
                                    <li class="hover">
                                        <a href="index.php?option=current-stock">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                          Current Stock
                                        </a>
                                        <b class="arrow"></b>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=stock-details">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                          Stock Details
                                        </a>
                                        <b class="arrow"></b>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=stock-ledger-tranc">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                          Stock Ledger
                                        </a>
                                        <b class="arrow"></b>
                                ...
                                <li class="active open hover">
                                    ...
                                    <ul class="submenu">
                                      <li class="hover">
                                        <a href="index.php?option=stock-ledger">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=product_wise_summary_report">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=gst_wise_summary">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=bill_summary_report">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                        <a href="index.php?option=retailerwise_bill_summary_report">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                        ...
                                        <li class="hover">
                                        <a href="index.php?option=retailerwise_summary_report">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                      ...
                                      <li class="hover">
                                       ...
                                       <li class="hover">
                                        <a href="index.php?option=purchase_report_details">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                ...
                                <li class="active open hover">
                                    ...
                                    <li class="hover">
                                      ...
                                      <li class="hover">
                                       <a href="index.php?option=productwise-dispatch-report">
                                         <i class="menu-icon fa fa-caret-right"></i>
                                     ...
                                     <li class="hover">
                                       <a href="index.php?option=datewise-dispatch-report">
                                         <i class="menu-icon fa fa-caret-right"></i>
                               ...
                               <!--   <li class="hover">
                                    ...
                                    <li class="hover">
                                      <a href="index.php?option=retailer_payment_collection_report">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        Payment Collection Report
                                      </a>
                                      <b class="arrow"></b>
                                     ...
                                     <li class="hover">
                                        <a href="index.php?option=retailer-ledger-tranc">
                                          <i class="menu-icon fa fa-caret-right"></i>
                                    ...
                                    <li class="hover">
                                        <a href="index.php?option=retailer-dues">
                                          <i class="menu-icon fa fa-caret-right"></i>
                            ...
                            echo'<li class="active open hover">';    
                             ...
                             echo'<li class="open hover">'; ?> 
                              ...
                              <ul class="submenu">
                                ...
                                <li class="hover">
                                  <a href="index.php?option=customer-feedback">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Feedback
                                  </a>
                                  <b class="arrow"></b>
                                ...
                                <?php
                                  if($menu=='Order-details' || $menu=='testing_dms'|| $menu=='test')
                                    ...
                                    echo'<li class="  open hover">'; ?> 
                                        ...
                                        <ul class="submenu">
                                            <li class="hover">
                                              <a href="https://demo.msell.in/public/Order-details/create">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Quick Order
                                              </a>
                                              <b class="arrow"></b>
                                            ...
                                            <li class="hover">
                                              <a href="https://demo.msell.in/public/Order-details">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Order History
                                              </a>
                                              <b class="arrow"></b>
                                            ...
                                            <li class="hover">
                                              <a href="https://demo.msell.in/public/short_item_list_report">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Order Status
                                              </a>
                                              <b class="arrow"></b>
                                            ...
                                            <li class="hover">
                                              <a href="https://demo.msell.in/public/invoice-details">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Invoice-Details
                                              </a>
                                              <b class="arrow"></b>
                                            ...
                                            <li class="hover">
                                              <a href="https://demo.msell.in/public/dms-payment-details/create">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Make a Payment
                                              </a>
                                              <b class="arrow"></b>
                                            ...
                                            <li class="hover">
                                              <a href="https://demo.msell.in/public/dms-payment-details">
                                                <i class="menu-icon fa fa-caret-right"></i>
                                                Payment History
                                              </a>
                                              <b class="arrow"></b>
                                    ...
                                    <?php
                                      if($menu=='Order-details' || $menu=='testing_dms'|| $menu=='test')
                                        ...
                                        echo'<li class="  open hover">'; ?> 
                                            <a  href="https://demo.msell.in/public/credit_debit_notes" >
                                        ...
                                        <li class="hover">
                                          <a href="https://demo.msell.in/public/dms_dealer_dashboard">
                                            <i class="menu-icon fa fa-server"></i>
                                            Dealer Dashboard
                                          </a>
                                          <b class="arrow"></b>
