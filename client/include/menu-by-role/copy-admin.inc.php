    ...
    <body class="no-skin">
      <div id="navbar" class="navbar navbar-default    navbar-collapse       h-navbar ace-save-state" style="height: 0px;">
            ...
            <button class="pull-right navbar-toggle navbar-toggle-img collapsed" type="button" data-toggle="collapse" data-target=".navbar-buttons,.navbar-menu">
              ...
              <!-- <img src="assets/images/avatars/user.jpg" alt="Jason's Photo" /> -->
                  ...
                  <div class="pull-right" role="navigation" style="color: #FFF;margin-right: 30px;margin-top: 5px;">
                    <span>
                      <a style="color: #FFF;" href="mailto:support@manacleindia.com">Email ID :- support@manacleindia.com</a>
                      <br/>                                  
    ...
    //h1($query);
      ...
      //h1($qs);
                     ...
                     <li class="transparent dropdown-modal">
                      <a title="LOW BALANCE STOCK OF (<?=$i?>) PRODUCTS" class="iframef" href="index.php?option=demand-order&showmode=1&mode=1">
                    ...
                    <li class="transparent dropdown-modal">
                      <a title="Updtae Profile"  href="index.php?option=update-profile">
                            ...
                            echo'<li class="active open hover">';    
                             ...
                             echo'<li class="open hover">'; ?> 
                              ...
                              <ul class="submenu">
                                ...
                                echo'<li class=" active open hover">'; ?> 
                                    <a  href=<?php echo "quick-order";?> >
                                      <i class="menu-icon fa fa-cart-arrow-down"></i>
                                      <span class="menu-text"> Quick Order </span>
                                    </a>
                                    <b class="arrow"></b>
                                  </li> 
