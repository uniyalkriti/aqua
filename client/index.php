...
{	
	...
	case 'customer-feedback': //for viewing the customers
	{
	   $page = 'misc/add-feedback.inc.php';
	   $page_title = 'Customer Feedback :: '.GEN_TITLE;
	   break;
	}
	...
	case 'productwise-dispatch-report': //for addition of new users
        ...
        case 'stock-threshold': //for addition of new users
        {
            $page = 'dispatch/stock_min_max_level.php';
            $page_title = 'Current Stock :: '.GEN_TITLE;
            break;
        }
        ...
        case 'stock-details-new':
        {
            $page = 'dispatch/stock_detail_report_new.php';
            $page_title = 'Stock Details :: '.GEN_TITLE;
            break;
        }
        case 'stock-ledger':
        {
            $page = 'dispatch/stock_ledger.php';
            $page_title = 'Stock Ledger :: '.GEN_TITLE;
            break;
        }
        case 'stock-ledger-new':
        {
            $page = 'dispatch/stock_ledger_new.php';
            $page_title = 'Stock Ledger :: '.GEN_TITLE;
            break;
        }
                case 'stock-ledger-tranc':
        {
            $page = 'dispatch/stock_ledger_tranc.php';
            $page_title = 'Stock Ledger :: '.GEN_TITLE;
            break;
        }
        case 'retailer-ledger-tranc':
        {
            $page = 'dispatch/retailer_ledger.php';
            $page_title = 'Retailer Ledger :: '.GEN_TITLE;
            break;
        }
case 'hsn-details':
        {
            $page = 'dispatch/hsn_detail_report.php';
            $page_title = 'HSN/SAC Details :: '.GEN_TITLE;
            break;
        }
 case 'book-details':
        {
            $page = 'dispatch/book_detail_report.php';
            $page_title = 'Document Details :: '.GEN_TITLE;
            break;
        } 
 case 'book-details-doc':
        {
            $page = 'dispatch/book_detail_doc_report.php';
            $page_title = 'Document Details :: '.GEN_TITLE;
            break;
        }             
        case 'hsn-detailed':
        {
            $page = 'dispatch/hsn_detailed_report.php';
            $page_title = 'HSN/SAC Details :: '.GEN_TITLE;
            break;
        }
        
        case 'hsn-purchase-details':
        {
            $page = 'dispatch/hsn_purchase_detail_report.php';
            $page_title = 'HSN/SAC Details :: '.GEN_TITLE;
            break;
        }
        case 'hsn-purchase-detailed':
        {
            $page = 'dispatch/hsn_purchase_detailed_report.php';
            $page_title = 'HSN/SAC Details :: '.GEN_TITLE;
            break;
        }
        case 'bill-detailed':
        {
            $page = 'dispatch/bill_detailed_report.php';
            $page_title = 'Bill Details :: '.GEN_TITLE;
            break;
        }
         case 'bill-detailed-gst':
        {
            $page = 'dispatch/bill_detailed_gst_report.php';
            $page_title = 'Bill Details :: '.GEN_TITLE;
            break;
        }
        case 'purchase-detailed':
        {
            $page = 'dispatch/purchase_detailed_report.php';
            $page_title = 'Purchase Details :: '.GEN_TITLE;
            break;
		}
		####
	 case 'purchase_report_details': //for challan & achievment
    {
       $page = 'reports/ledger/purchase_report_details.php';
...
case 'bill_summary_report': //for addition of new users
            ...
            case 'GSTR_report': //for addition of new users
            {
            $page = 'dispatch/GSTR_report.php';
            $page_title = 'GSTR 3B Report :: '.GEN_TITLE;
            break;
            }
            ...
            break;
             ...
             case 'retailerwise_summary_report': //for addition of new users
            {
            $page = 'dispatch/retailerwise_summary_report.php';
            $page_title = 'Retailerwise Summary :: '.GEN_TITLE;
            break;
            }
        ...
        case 'payment': //for addition of new users
	{
	   ...
	   case 'payment-new': //for addition of new users
	{
	   $page = 'payment/payment_collection_new.php';
	   $page_title = 'Payment Collection :: '.GEN_TITLE;
	   break;
	}
	case 'old_payment': //for addition of new users
	{
	   $page = 'payment/old_payment_collection.php';
	   $page_title = 'Old Payment Collection :: '.GEN_TITLE;
	   break;
	}
	...
	case 'import_invoice': //for addition of new users
	{
	   $page = 'import/import_invoice.php';
	   $page_title = 'Import Purchase Invoices :: '.GEN_TITLE;
	   break;
	}
	case 'import_opening_stock': //for addition of new users
	{
	   $page = 'import/import_opening_stock.php';
	   $page_title = 'Import Opening Stock :: '.GEN_TITLE;
	   break;
	}
	...
	case 'gst_return_summary': //for showing gst1 outward report 
	    ...
	    case 'gst_wise_summary': //for showing gst1 outward report 
	    {
	       $page = 'dispatch/gst_wise_report.php';
	       /*$page = 'reports/stock/tax_inv_sale_report.php';*/
	       $page_title = 'GST Wise Summary :: '.GEN_TITLE;
	       break;
	    }
	    case 'gst_wise_summary_new': //for showing gst1 outward report 
	    {
	       $page = 'dispatch/gst_wise_report_new.php';
	       /*$page = 'reports/stock/tax_inv_sale_report.php';*/
	       $page_title = 'GST Wise Summary :: '.GEN_TITLE;
	       break;
	    }
	case 'purchase_register': //for showing gst1 outward report 
	    {
	       $page = 'dispatch/purchase_register.php';
	       $page_title = 'Purchase :: '.GEN_TITLE;
	       break;
	    }
         ...
         case 'purchase-order': //for addition of new users
	{
	   ...
	   $page_title = 'Recieve Order :: '.GEN_TITLE;
	   break;
	}
	// case 'demand-order1': //for addition of new users
	// {
	//    $page = 'sales/order-details/1demand-order.inc.php';
	//    $page_title = 'Demand Order :: '.GEN_TITLE;
	//    break;
	// }
	case 'Order-details': //for addition of new users
	{
		// header('public/login');
	   	$page_title = 'Order-details :: '.GEN_TITLE;
		header("Location: ../public/Order-details"); 
		exit;
	   // $page = '../public/login';
	   // break;
	}
	...
	case 'received-order-test': //for addition of new users
	{
	   $page = 'sales/order-details/received-order-test.inc.php';
	   $page_title = 'Receive Order :: '.GEN_TITLE;
	   break;
	}
...
case 'user-bill-performance': //for challan & achievment
{
$page = 'reports/user-bill-performance.php';
$page_title = 'User Bill Performance :: '.GEN_TITLE;
break;
}
case 'bill-purchase-performance': //for challan & achievment
{
$page = 'reports/sales-purchase-performance.php';
$page_title = 'Bill Purchase Performance :: '.GEN_TITLE;
break;
}
case 'dealer-sale-performance': //for challan & achievment
{
$page = 'reports/dealer-sale-performance.php';
$page_title = 'Sale Performance :: '.GEN_TITLE;
break;
}

case 'order-sale-performance': //for challan & achievment
{
$page = 'reports/order-sale-performance.php';
$page_title = 'Order Sale Performance :: '.GEN_TITLE;
break;
}
case 'retailer-wise-sale-performance': //for challan & achievment
{
$page = 'reports/retailer-wise-sale-performance.php';
$page_title = 'Retailer Sale Performance :: '.GEN_TITLE;
break;
}
case 'retailer-wise-sale-order-performance': //for challan & achievment
{
$page = 'reports/retailer-wise-sale-order-performance.php';
$page_title = 'Retailer Sale Order Performance :: '.GEN_TITLE;
break;
}
case 'product-wise-sale-performance': //for challan & achievment
{
$page = 'reports/product-wise-sale-performance.php';
$page_title = 'Product Sale Performance :: '.GEN_TITLE;
break;
}
case 'retailer_payment_collection_report': //for challan & achievment
{
$page = 'reports/retailer_payment_collection_report.php';
$page_title = 'Payment Collection Report :: '.GEN_TITLE;
break;
}
      		case 'division_summary_report': //for addition of new users
            {
            $page = 'dispatch/division_summary_report.php';
            $page_title = 'Division Wise Summary :: '.GEN_TITLE;
            break;
            }
            case 'division_sp_summary_report': //for addition of new users
            {
            $page = 'dispatch/division_sp_summary_report.php';
            $page_title = 'Division Sale Purchase Wise Summary :: '.GEN_TITLE;
            break;
            }
            case 'stock_summary': //for addition of new users
            {
            $page = 'dispatch/stock_summary.php';
            $page_title = 'Stock Summary :: '.GEN_TITLE;
            break;
            }
...
case 'retailer-dues': //for challan & achievment
{
$page = 'reports/retailer-dues.php';
$page_title = 'Retailer Dues :: '.GEN_TITLE;
break;
}
	...
	case 'opening_stock': //for addition of new users
	{
	   $page = 'sales/order-details/opening_stock.inc.php';
	   $page_title = 'Stock :: '.GEN_TITLE;
	   break;
	}
        ...
        case 'sale-order-detailes': //for addition of new users
	{
	   ...
	   break;
		...
		case 'challan-against-order': //for addition of new users
	{
	   $page = 'dealer/order-against-details.inc.php';
	   $page_title = 'Dealer Demand Order :: '.GEN_TITLE;
	   break;
	}
    ...
    case 'add-van': //for addition of new users
	{
	   ...
	   $page_title = 'Add Supply Vehical :: '.GEN_TITLE;
	   break;
	}
    
    case 'company': //for addition of new users
	{
	   $page = 'vendor/company.inc.php';
	   $page_title = 'Add Company :: '.GEN_TITLE;
	   break;
	}

    case 'brand-product': //for addition of new users
	{
	   $page = 'vendor/brand_product.inc.php';
	   $page_title = 'Add Brand Product :: '.GEN_TITLE;
	   break;
	}
...
break;
        ...
        case 'location': 
	{
	   ...
	   break;
        ...
        case 'dsp-wise-challan': //for addition of new userschallan-order-wise-modal
	{
	   $page = 'challan/dsp-wise-challan.inc.php';
	   $page_title = 'DSP Wise Challan :: '.GEN_TITLE;
	   break;
	}
	case 'challan-order-wise-modal': //for addition of new users
	{
	   $page = 'challan/challan-order-wise-modal.inc.php';
	   $page_title = 'Order Wise Challan :: '.GEN_TITLE;
	   break;
	}
    ...
    case 'retailer-ledger': //for challan & achievment
        {
           $page = 'reports/stock/retailer_ledger_report.php';
           $page_title = 'Retailer Ledger :: '.GEN_TITLE;
           break;
        }
	...
	case 'make-challan-damage': //for addition of new users
	{
	   $page = 'challan/make-challan-damage.inc.php';
	   $page_title = 'Damage Challan :: '.GEN_TITLE;
	   break;
	}

	case 'division-wise': //for addition of new users
	{
		$page = 'challan/division_wise_invoice_detail.php';
		$page_title = 'Division Wise Invoice Detials :: '.GEN_TITLE;
		break;
	}
	...
	case 'direct-challan-test': //for addition of new users
	{
	   $page = 'challan/direct-challan-test.php';
	   $page_title = 'Direct Challan :: '.GEN_TITLE;
	   break;
	}
	case 'direct-challan-retail': //for addition of new users
	{
	   $page = 'challan/direct-challan-pop-retail.php';
	   $page_title = 'Direct Challan Retail:: '.GEN_TITLE;
	   break;
	}
	case 'direct-challan-damage': //for addition of new users
	{
	   $page = 'challan/direct-challan-pop-damage.php';
	   $page_title = 'Damage Challan :: '.GEN_TITLE;
	   break;
	}
	/************************/
	case 'direct-challan-damage-depot': //for addition of new users
	{
	   $page = 'challan/direct-challan-pop-damage-depot.php';
	   $page_title = 'Depot Damage Challan :: '.GEN_TITLE;
	   break;
	}
	case 'make-challan-damage-depot': //for addition of new users
	{
	   $page = 'challan/make-challan-depot.inc.php';
	   $page_title = 'Depot Damage Challan :: '.GEN_TITLE;
	   break;
	}
	##########################
   ...
   default:
   {
	   ...
	   { 
                ...
                {
                  $connected = @fsockopen("http://162.222.39.114/msell-baidyanath/client/index.php", 80);
                }
                if ($connected){
                   fclose($connected);
                   $date=date('Y-m-d');
