...
$(function(){
    ...
    ********************************************************************/
     ...
     $('#mytable_purchase').on('change','.nkget_dealer_rate',function(){
    var ths = $(this);
    ...
    $.ajax({
        ...
        success: function (data) { /*alert(data);*/
          ...
          if(response.exception)
          {
            ...
            var gst = response.data.gst/2;  
            mrp.val(response.data.mrp);
            dealer_mrp.val(response.data.dealer_rate);

            row.find('.minlab').val(response.data.min_t);
            row.find('.sih').val(response.data.sih);
            row.find('.cgst_amt').val(gst.toFixed(2));
            row.find('.sgst_amt').val(gst.toFixed(2));
 ...
 $('#mytable').on('change','.item_details_retail',function(){
    var ths = $(this);
    var product_id = ths.val();
    ...
    $.ajax({
        type:'POST',
        url:'js/ajax_general/ajax_general_php.php',
        data:{pid:product_id,r_id:rid,wcase:'getItemDetailsRetail'},
        success: function (data) {
          var response = $.parseJSON(data);
          if(response.exception)
          {
  ...
  $('#mytable').on('change','.mrp_dd_retail',function(){
     ...
     $.ajax({
        type:'POST',
        url:'js/ajax_general/ajax_general_php.php',
        data:{pid:id,mrp:m,wcase:'rateNstockRetail'},
        success:function(data){
          var resp = $.parseJSON(data);
          qty.val('');
          avlb_quantity.val(resp.data.qty);
    ...
    $('#mytable').on('change','.item_details_damage',function(){
    var ths = $(this);
    var product_id = ths.val();
    ...
    $.ajax({
        type:'POST',
        url:'js/ajax_general/ajax_general_php.php',
        data:{pid:product_id,r_id:rid,wcase:'getItemDetailsDamage'},
        success: function (data) {
          var response = $.parseJSON(data);
          if(response.exception)
          {
...
//            }
  ...
  $('#mytable').on('change','.mrp_dd_damage',function(){
     var id = $(this).closest('tr').find('.item_details_damage').val();
     var avlb_quantity = $(this).closest('tr').find('.avlb_quantity');
     var qty = $(this).closest('tr').find('.quantitycl');
     var rate = $(this).closest('tr').find('.rate');
     var m  = $(this).val();
     ...
     $.ajax({
        type:'POST',
        url:'js/ajax_general/ajax_general_php.php',
        data:{pid:id,mrp:m,wcase:'rateNstockDamage'},
        success:function(data){
          var resp = $.parseJSON(data);
          qty.val('');
          avlb_quantity.val(resp.data.qty);
