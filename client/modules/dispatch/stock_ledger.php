...
<?php 
$forma = 'Product Wise Invoice'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch();
$objchallan = new dealer_sale();
$cls_func_str = 'stock_ledger'; //The name of the function in the class that will do the job
            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <span style="color:#fff;">Product Wise Invoice List</span>
