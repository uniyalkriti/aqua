...
$cls_func_str = 'stock_age'; //The name of the function in the class that will do the job
$myorderby = 'cp.id,stock.date DESC'; // The orderby clause for fetching of the data
		...
		if($checkpass)
		{
			...
			if(!empty($_POST['end'])){
				...
				$filterstr[] = '<b>End : </b>'.$_POST['end'];
                    ...
                    $filter[] = "stock.dealer_id = '{$_SESSION[SESS.'data']['dealer_id']}'";
                    //pre($filter);
