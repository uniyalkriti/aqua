...
<?php 
$forma = 'Document Details'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch_report();
$objchallan = new dealer_sale();
$cls_func_str = 'book_wise'; //The name of the function in the class that will do the job
            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <span style="color:#fff;">Document Details</span>
                   ...
                   <div id="divToPrint">
                    ...
                    <?php 
                      ...
                      $end1 = date("d/M/Y", strtotime($end));
                       if($status==1){
                       $pname="Bill Of Supply"; 
                       }elseif($status==2){
                       $pname="Generated Invoice";
                       }
                    ?>
                    <h2><strong><?=$pname;?> Summary-<?=$dname;?>  From <?=$start1?> To <?=$end1?></strong></h2>
                            <thead>          
                            <tr> 
