...
<?php 
$forma = 'Purchase Details'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch_report();
$objchallan = new dealer_sale();
$cls_func_str = 'purchase_detailed'; //The name of the function in the class that will do the job
                   ...
                   <div id="divToPrint">
                    ...
                    <?php 
                      ...
                      if($status==4){
                        ...
                        $name="Inward Supplies Excempted";
                      }elseif($status==6){
                        $name="Inward Supplies Total";
                      }
                    ?>
                    <h2><strong><?=$name?> From <?=$start1?> To <?=$end1?></strong></h2>
                        ...
                        <tbody>
                            ...
                            $uidname = $rows['dname'];
                            $cgst=$rows['cgst_amount'];
                            $sgst=$rows['sgst_amount'];;
                            $total_cgst+=$cgst;
                            $total_sgst+=$sgst;
                            $igst=$rows['igst_amount'];
                            $total_igst+=$igst;
                            $total_qty+=$rows['qty'];
                    ...
                    $deletelink = '<a href="javascript:void(0);" onclick="do_delete(\'Dispatch Delete\', \''.$uid.'\',\'Dispatch\',\''.addslashes($uidname).'\');"><img src="./images/b_drop.png"></a>';
                          ...
                          if($auth['del_opt'] !=1) $deletelink = '';
                            ...
                            <tr>
                                ...
                                <td>GST Purchase</td>
                            <td>    <?php  echo'
                        <a target="_blank" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid .'&actiontype=print">'; ?><?php echo $rows['challan_no'];?></a> 
                        </td>
                                <td>GOODS</td>
                                <td>PCS-PIECES</td>
                                <td><?=$rows['qty']?></td>
