...
<?php 
$forma = 'Retailer Wise Bill Summery'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch();
$objchallan = new dealer_sale();
$cls_func_str = 'retailer_summary'; //The name of the function in the class that will do the job
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr id="mysearchfilter">
            <td>
             ...
             <table>
               <tr>
                <td width="25%" style="padding-right: 20px;"><span class="star">*</span>Start<br />	
                    <input type="text" class="qdatepicker" name="start" value="<?php if(isset($_POST['start'])) echo $_POST['start']; else echo date('d/m/Y'); ?>"/>
                </td>
                <td width="25%" style="padding-right: 20px;"><span class="star">*</span>End<br />	
                ...
                <td width="18%">Retailer<br/>
                        <?php
                            $dealer_id = $_SESSION[SESS.'data']['dealer_id'];
                            $q = "SELECT retailer.id as id ,concat(retailer.name,' [',retailer.address,']') as `name` from location_5 INNER JOIN retailer ON retailer.location_id = location_5.id where dealer_id='$dealer_id' AND retailer_status='1' order by retailer.name asc";
            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <span style="color:#fff;">Retailer Wise Bill Summery</span>
    ...
    color:#000;
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            $gtotal+=$billed_amt;
                            if(!empty($rows['challan_count'])){
                            $count_sum=$rows['challan_count'];
                            }else{
                            $count_sum=0.00;    
                            }
                            $gtotalcount+=$count_sum;

                            $ch_no='<a target="_blank" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid .'&actiontype=print">'.$rows[invoice_no].'</a>'; 
...
<!--                                    <td class="options"><?= $printlink?></td>-->
                        ...
                        <td><strong><?=$gtotalcount?></strong></td>
