...
<?php 
$forma = 'GSTR-3B Report'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch();
$objchallan = new dealer_sale();
$cls_func_str = 'gstr'; //The name of the function in the class that will do the job
    ...
    <div id="workarea">
	  ...
	  if(isset($_GET['actiontype'])){
		switch($_GET['actiontype']){
			case'print':
				require_once('challan-gst3-print.inc.php');
				exit();
				break;	
                                default:
            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <span style="color:#fff;">GSTR3B Report</span>
                   <?php echo '<a target="_blank" href="http://162.222.39.114/msell-baidyanath/webservices/dealer_challan_report_json_3B.php?dealer_id='.$dealer_id.'&from_date='.$start.'&to_date='.$end.'">'; 
                    ...
                    $deletelink = '<a href="javascript:void(0);" onclick="do_delete(\'Dispatch Delete\', \''.$uid.'\',\'Dispatch\',\''.addslashes($uidname).'\');"><img src="./images/b_drop.png"></a>';
                          ...
                          if($auth['del_opt'] !=1) $deletelink = '';
                            ...
                            <tr>
                                ...
                                <td>
                               <?php  if($inc==1 || $inc==2 || $inc==3){ ?>
                                    <?php echo '<a target="_blank" href="index.php?option=bill-detailed&start='.$start.'&end='.$end.'&status='.$inc.'">'; ?><?php echo $rows['per'];?></a>
                               <?php     }elseif($inc==4 || $inc==5 || $inc==6){  ?>
                                    <?php echo '<a target="_blank" href="index.php?option=purchase-detailed&start='.$start.'&end='.$end.'&status='.$inc.'">'; ?><?php echo $rows['per'];?></a>
                              <?php      } ?>
                                    </td>
                                <td>
                                    <?=my2digit($billed_amt)?>
                                ...
                                <td>
                                    <?php echo my2digit($rows['tax']);?>
                                </td>
                                <!-- <td class="options"><?= $printlink?> -->
