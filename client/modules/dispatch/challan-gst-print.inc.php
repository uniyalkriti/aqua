...
$phone = " +91 $dealer_data[other_numbers],</br> E-MAIL : $dealer_data[email]";

$looper = $myobjd->print_looper_challan_gst($_GET['start'],$_GET['end'],$_GET['status']);
$start1 = date("d/M/Y", strtotime($_GET['start']));
$end1 = date("d/M/Y", strtotime($_GET['end']));
if($_GET['status']==1){
$pname="B2B";
...
<div id="certificate_container" style="padding:0px; font-size:62.5%; font-family:'Times New Roman', Times, serif; page-break-after:auto; margin:0 auto; width:595pt;">
  <div id="pritn_what">
    <div class="mytitle" style="font-size:14pt;text-align:center; font-weight:bold; margin-top:0;">
      <span style="text-decoration:underlinel;">GST RETURN SUMMARY(<?=$pname?>) From <?=$start1?> To <?=$end1?></span><br />
  ...
  <div id="certificate_header">
    <table id="searchdata" width="100%" class="header_table" style="margin-top:0pt; border:1pt solid #000; border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="1">
      ...
      <tr style="font-weight:bold;">  
        ...
        <td style="width:15%" align="center">GSTINO</td> 
        <td style="width:15%" align="center">Retailer Name</td> 
        <td style="width:25%" align="center">Invoice No</td>
        <td style="width:10%" align="center">Invoice Date</td>  
        <td style="width:10%" align="center">Taxable Amt</td>  
        <td style="width:7%" align="center">Rate %</td>
        <td style="width:8%" align="center">CGST</td> 
        <td style="width:8%" align="center">SGST</td> 
        <td style="width:8%" align="center">IGST</td> 
        <td style="width:8%" align="center">Tax Amount</td>          
        <td style="width:8%" align="center">Total Amount</td>          
      </tr>
<?php  $ctr = 1;
$total_tax=0;
$total_taxb=0;
...
$total_taxb+=round($value['txbl'],2);
$total_amtt+=$value['taxable_amt'];
  ?>
      
        <tr>             
            <td align="right" style="border-left:none;">
            <?php if($_GET['status'] == 1){ echo $value['gstino']; } ?>
            </td> 
            <td align="right" style="border-left:none;"><?php echo $value['retailer_name'];?></td> 
            <td align="right" style="border-left:none;"><?php echo '<a target="_blank" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id='.$uid.'&actiontype=printbill">'; ?><?php echo $value['invoice_no'];?></a></td> 
            <td align="right" style="border-left:none;"><?php echo $value['invoice_date'];?></td> 
            <td align="right" style="border-left:none;"><?php echo round($value['txbl'],2)?></td> 
            <td align="right" style="border-left:none;"><?php echo $value['rate'];?></td>
            <td align="right" style="border-left:none;"><?php echo round($cgst,2);?></td> 
            <td align="right" style="border-left:none;"><?php echo round($sgst,2);?></td> 
            <td align="right" style="border-left:none;"><?php echo round($igst,2);?></td>  
            <td align="right" style="border-left:none;"><?php echo $value['tax_amount'];?></td> 
            <td align="right" style="border-left:none;"><?php echo $value['taxable_amt'];?></td> 
        </tr>

        </tr>
      <?php  /*<tr style="font-size:11pt;">
   ...
   <?php /*<table class="header_table" width="100%" border="0" style="font-family:'Times New Roman', Times, serif; font-size:10pt;border:1pt solid #000;">
      <tr>
         <td valign="top" style="border:none;"><span style="font-size:9pt;"><?php if(!empty($dealer_data['terms'])) echo "<pre>".$dealer_data[terms]."</pre>"; else echo "E & O E Please Check the stock at delivery All disputes are subject to Jursdiction only. It is computer generated invoice does not need signature.";?></span></td>
      <td  align="right" style="border-left:none;"><b>For : <?php echo $dealer_data['name']; ?></b><br /><br /><br />Authorised Signatory</td>
      </tr>
<!--       <tr>
...
<?php $ctr++;
 }// foreach($looper as $key=>$value){ ends?>
         <tr>
        <td colspan="4" style="text-align: center;"><b>Grand Total</b></td>
        <td align="right"><b><?php echo $total_taxb;?></b</td>
        <td></td>
        <td align="right"><b><?php echo round($cgst_total,2);?></b></td>
        <td align="right"><b><?php echo round($sgst_total,2);?></b></td>
        <td align="right"><b><?php echo round($igst_total,2);?></b></td>
        <td align="right"><b><?php echo $total_tax;?></b></td>
        <td align="right"><b><?php echo $total_amtt;?></b></td>
...
<?php }// foreach($looper as $key=>$value){ ends?>
    ...
    <script type="text/javascript">     
    function PrintDiv() {    
       var divToPrint = document.getElementById('searchlistdiv');
