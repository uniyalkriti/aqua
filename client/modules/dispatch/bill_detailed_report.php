...
<?php 
$forma = 'Bill Details'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch_report();
$objchallan = new dealer_sale();
$cls_func_str = 'bill_detailed'; //The name of the function in the class that will do the job
...
if(isset($_POST['filter']) && $_POST['filter'] == 'Filter')
{
  ...
  $rs = $mycurobj->$funcname($filter="$myfilter'$ajaxshowid'",  $records = '', $orderby='');
     ...
     //echo $funcname;die;
      ...
      $end=$_GET['end'];
       $status=$_GET['status'];
    $rs = $myobj->$funcname($start,$end,$status,$filter,  $records = '', $orderby='');
}
$rs1 = array();
                   ...
                   <div id="divToPrint">
                    ...
                    <?php 
                      ...
                      if($status==1){
                        ...
                        $name="Outward Supplies Excempted";
                      }elseif($status==3){
                        $name="   Outward Supplies Total";
                      }
                    ?>

                    <h2><strong><?=$name?> From <?=$start1?> To <?=$end1?></strong></h2>
                            <thead>          
                            <tr> 
                        ...
                        <td><b>Grand Total</b></td>
                         <td><?=$total_qty?></td>
                           <td><b><?=my2digit($total_taxable)?></b></td>
                            ...
                            <td><b><?=my2digit($total_value)?></b></td>
                        </tr>
                        <!-- </tfoot> -->
                    </table>
                </div>
                                ...
                                new $.fn.dataTable.Buttons(myTable, {
                                    buttons: [
                                        ...
                                        },
                                        {
                                            ...
                                            "className": "btn btn-white btn-primary btn-bold",
                                            title: "<?=$name?> FROM <?=$start1?> TO <?=$end1?>",
                                            footer: true,
                                            autoPrint: true,
