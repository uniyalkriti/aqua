...
$cls_func_str = 'book_wise_doc'; //The name of the function in the class that will do the job
                ...
                <!-- div.table-responsive -->
                  ...
                  <!-- div.dataTables_borderWrap -->
                   <div>
                    ...
                    ?>
                    <h2><strong>Summary of documents issued during the tax period (13)</strong></h2>
                            <thead>          
                            <tr> 
                    ...
                    $deletelink = '<a href="javascript:void(0);" onclick="do_delete(\'Dispatch Delete\', \''.$uid.'\',\'Dispatch\',\''.addslashes($uidname).'\');"><img src="./images/b_drop.png"></a>';
                          ...
                          if($auth['del_opt'] !=1) $deletelink = '';
                            ...
                            ?>
                            <tr>
                               <?php if($rows['pert']=='Bill of Supply'){?> 
                                <td>    <?php echo '<a target="_blank" href="index.php?option=book-details&start='.$start.'&end='.$end.'&status=1">'; ?><?php echo $rows['pert'];?></a> 
                                 </td>
                                  <?php }else{?>
                                   <td>    <?php echo '<a target="_blank" href="index.php?option=book-details&start='.$start.'&end='.$end.'&status=2">'; ?><?php echo $rows['pert'];?></a> 
                                 </td>
                                  <?php }?>  
                               <td><?=$rows['bfrom']?></td>
                                <td><?=$rows['bto']?></td>
...
<!--       <script src="assets/js/jquery-2.1.4.min.js"></script>-->
 <script src="assets/js/jquery.dataTables.min.js"></script>
        ...
        <?php 
                      $start1 = date("d/M/Y", strtotime($start));
                      $end1 = date("d/M/Y", strtotime($end));
                      $formas="Summary of documents issued during the tax period (13)";
                    ?>
                            jQuery(function ($) {
                                ...
                                new $.fn.dataTable.Buttons(myTable, {
                                    buttons: [
                                        ...
                                        },
                                        {
                                            ...
                                            "className": "btn btn-white btn-primary btn-bold",
                                            title: "<?=$formas?> FROM <?=$start1?> TO <?=$end1?>",
                                            //footer: true,
                                            autoPrint: true,
