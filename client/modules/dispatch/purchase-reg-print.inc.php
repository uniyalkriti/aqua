...
$phone = "Contact : ".$dealer_data[$dealer_id][other_numbers]."</br> E-MAIL : ". $dealer_data[$dealer_id][email];
$myobjd = new dealer_sale();
$looper = $myobjd->print_purchase_gst($_GET['start'],$_GET['end'],$_GET['did'],$_GET['status']);
...
<table width="100%">
  <tr>
    <td>
      ...
      <input type="button" onclick="tableToExcel('searchdata', 'W3C Example Table')" value="Export to Excel">
...
<div id="certificate_container" style="padding:0px; font-size:50%; font-family:'Times New Roman', Times, serif; page-break-after:auto; margin:0 auto; width:595pt;">
  <div id="pritn_what">
    <div  style="font-size:12pt;text-align:center;  margin-top:0;">
  <?=$dealer_data[$dealer_id]['name']?><br/>
  
  <?=$dealer_data[$dealer_id]['address']?><br/>
       <?=$phone?><br/>
GSTIN No : <?php if(!empty($dealer_data[$dealer_id]['tin_no'])) echo $dealer_data[$dealer_id]['tin_no'];
                else echo"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; ?><br/>
</div>
 <div class="mytitle" style="font-size:14pt;text-align:center; font-weight:bold; margin-top:0;">
      <span style="text-decoration:underlinel;">PURCHASE PRINT REPORT</span><br />
<!--      <span style="font-size:9pt; font-weight:normal; letter-spacing:-0.5pt;">Invoice for removal of Excisable Goods from a factory or warehouse on payment of Duty (Rule-11)</span>      -->
  ...
  <div id="certificate_header">
    <table id="searchdata" width="100%" class="header_table" style="margin-top:0pt; border:1pt solid #000; border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="1">
     
      <tr style="font-weight:bold;">
        <td style="width:18%" align="center">Vendor Name</td> 
        <td style="width:12%" align="center">GSTIN</td> 
        <td style="width:12%" align="center">Bill Number</td>
  <td style="width:8%" align="center">Date</td>
        <td style="width:10%" align="center">Taxable Amt.</td>  
        <!-- <td style="width:5%" align="center">CGST %</td> -->
        <td style="width:10%" align="center">CGST Amt.</td>
  <!-- <td style="width:5%" align="center">SGST %</td> -->
        <td style="width:10%" align="center">SGST Amt.</td>
        <td style="width:10%" align="center">IGST Amt.</td>            
        <td style="width:30%" align="center">Total Amount</td>          
      </tr>
...
$uid=$value['id'];
$cgst = $value['gst']/2;
//$cgstamt = $value['total_amount']*$cgst/100;
$cgstamt = $value['cgst_amount'];
$sgst = $value['gst']/2;
//$sgstamt = $value['total_amount']*$sgst/100;
$sgstamt =$value['sgst_amount'];
$igstamt =$value['igst_amount'];
//$amt = $value['total_amount']+$cgstamt+$sgstamt;
$amt = $value['total_amount'];
$totaltaxable[] = $value['gross_amt'];
$totalcgst[] = $cgstamt;
$totalsgst[] = $sgstamt;
$totaligst[] = $igstamt;
$total[] = $amt;
  ...
  <tr>
    ...
    <td align="right" style="border-left:none;"><?php echo $value['csa_name'];?></td> 
    <td align="right" style="border-left:none;"><?php echo $value['gst_no'];?></td> 
    <td align="right" style="border-left:none;"><?php echo '<a target="_blank" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id='.$uid.'&actiontype=printbill">'; ?><?php echo $value['challan_no'];?></a></td>
  <td align="right" style="border-left:none;"><?php echo $value['receive_date'];?></td> 
    <td align="right" style="border-left:none;"><?php echo my2digit($value['gross_amt']);?></td> 
    <!-- <td align="right" style="border-left:none;"><?php echo $cgst."%";?></td>  -->
    <td align="right" style="border-left:none;"><?php echo my2digit(round($cgstamt,2));?></td> 
<!-- <td align="right" style="border-left:none;"><?php echo $sgst."%";?></td> 
 -->    <td align="right" style="border-left:none;"><?php echo my2digit(round($sgstamt,2));?></td>
 <td align="right" style="border-left:none;"><?php echo my2digit(round($igstamt,2));?></td> 
<td align="right" style="border-left:none;"><?php echo my2digit(round($amt,2));?></td> 
  </tr>
...
<tr>
    ...
    <th align="right"  colspan="10" style="border-left:none;"></th> 
  </tr>
<?php
//$totalreport =$myobjd->print_purchase_gst_wise_report($_GET['start'],$_GET['end'],$_GET['did']);
//pre($totalreport);
$countt = 0;
foreach($totalreport as $totalkey=>$totalvalue)
{
$countt++;
$cgst1 = $totalvalue['gst']/2;
$cgstamt1 = $totalvalue['total_amount']*$cgst1/100;
$sgst1 = $totalvalue['gst']/2;
$sgstamt1 = $totalvalue['total_amount']*$sgst1/100;
$amt1 = $totalvalue['total_amount']+$cgstamt1+$sgstamt1;
?>

<tr>
   
    <th align="right"  colspan="4" style="border-left:none;"><?php echo $countt.".)";?></th> 
    
    <th align="right" style="border-left:none;"><?php echo $totalvalue['total_amount'];?></th> 
    <th align="right" style="border-left:none;"><?php echo $cgst1."%";?></th> 
    <th align="right" style="border-left:none;"><?php echo round($cgstamt1,2);?></th> 
<th align="right" style="border-left:none;"><?php echo $sgst1."%";?></th> 
    <th align="right" style="border-left:none;"><?php echo round($sgstamt1,2);?></th> 
<th align="right" style="border-left:none;"><?php echo round($amt1,2);?></th> 
  </tr>
<?php 
}
?>
...
<tr>
    ...
    <th align="right" colspan="4" style="border-left:none;"><?php echo "TOTAL";?></th> 
   
    <th align="right" style="border-left:none;"><?php echo array_sum($totaltaxable);?></th> 
    <!-- <th align="right" style="border-left:none;"><?php echo " "?></th>  -->
    <th align="right" style="border-left:none;"><?php echo round(array_sum($totalcgst),2);?></th> 
<!-- <th align="right" style="border-left:none;"><?php echo " ";?></th>  -->
    <th align="right" style="border-left:none;"><?php echo round(array_sum($totalsgst),2);?></th> 
    <th align="right" style="border-left:none;"><?php echo round(array_sum($totaligst),2);?></th>
<th align="right" style="border-left:none;"><?php echo round(array_sum($total),2);?></th> 
  </tr>
...
</div> <?php /* div searchlistdiv ends*/ ?>
</div>  
