                ...
                <!-- div.table-responsive -->
                  ...
                  <!-- div.dataTables_borderWrap -->
                   <div id="divToPrint">
                    ...
                    ?>
                    <caption>
                    <h2><strong>HSN/SAC Summary-<?=$dname?>  From <?=$start1?> To <?=$end1?></strong></h2>
                    </caption>
                            <thead>          
                            <tr> 
                    ...
                    $deletelink = '<a href="javascript:void(0);" onclick="do_delete(\'Dispatch Delete\', \''.$uid.'\',\'Dispatch\',\''.addslashes($uidname).'\');"><img src="./images/b_drop.png"></a>';
                          ...
                          if($auth['del_opt'] !=1) $deletelink = '';
                            ...
                            <tr>
                                <td><?=$inc?></td>  
                            <td>    <?php  echo'
                        <a target="_blank" href="index.php?option=hsn-detailed&hsn_code='.$uid.'&start='.$start.'&end='.$end.'&status=1">'; ?><?php echo $rows['hsn_code'];?></a> 
                        </td>
                        <td><?=$cat?></td>
                                <td>GOODS</td>
                                <td>PCS-PIECES</td>
