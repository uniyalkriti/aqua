...
<?php 
$forma = 'HSN/SAC Summary'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch_report();
$objchallan = new dealer_sale();
$cls_func_str = 'hsn_wise'; //The name of the function in the class that will do the job
                ...
                <!-- div.table-responsive -->
                  ...
                  <!-- div.dataTables_borderWrap -->
                   <div>
                    ...
                    ?>
                    <h2><strong>HSN/SAC Summary  From <?=$start1?> To <?=$end1?></strong></h2>
                            <thead>          
                            <tr> 
                        ...
                        <tbody>
                            ...
                            $uid = $rows['hsn_code'];
                            $cat=myrowval('_gst','name',"hsn_code=".$uid);
                            $uidname = $rows['dname'];
                    ...
                    $deletelink = '<a href="javascript:void(0);" onclick="do_delete(\'Dispatch Delete\', \''.$uid.'\',\'Dispatch\',\''.addslashes($uidname).'\');"><img src="./images/b_drop.png"></a>';
                          ...
                          if($auth['del_opt'] !=1) $deletelink = '';
                            ...
                            <tr>
                                <td><?=$inc?></td>  
                            <td>    <?php  echo'
                        <a target="_blank" href="index.php?option=hsn-purchase-detailed&hsn_code='.$uid.'&start='.$start.'&end='.$end.'&status=2">'; ?><?php echo $rows['hsn_code'];?></a> 
                        </td>
