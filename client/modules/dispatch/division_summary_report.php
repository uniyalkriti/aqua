...
<?php 
$forma = 'Division Wise Sale Report'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch();
$objchallan = new dealer_sale();
$cls_func_str = 'division_summary'; //The name of the function in the class that will do the job
            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <span style="color:#fff;">Division Wise Sale Report</span>
    ...
    color:#000;
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if(!empty($rows['taxable_amt'])){
                            $taxable_amt=$rows['taxable_amt'];
                            }else{
                            $taxable_amt=0.00;    
                            }
                            if(!empty($rows['vat_amt'])){
                            $tax_amt=$rows['vat_amt'];
                            }else{
                            $tax_amt=0.00;    
                            }
                            $total_value=$total_value+$billed_amt;
                    ...
                    $deletelink = '<a href="javascript:void(0);" onclick="do_delete(\'Dispatch Delete\', \''.$uid.'\',\'Dispatch\',\''.addslashes($uidname).'\');"><img src="./images/b_drop.png"></a>';
                          ...
                          if($auth['del_opt'] !=1) $deletelink = '';
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php  echo'
                        <a target="_blank" href="index.php?option=stock-details-new&c2_id='.$uid.'&start='.$start.'&end='.$end.'">'; ?><?php echo $rows['type'];?></a> 
                                </td>
                                
                                <td>
                                    <?=my2digit($taxable_amt)?>
                                </td>
                                <td>
                                    <?=my2digit($tax_amt)?>
                                </td>
                                <td>
                                    <?=my2digit(round($billed_amt))?>
                                </td>
                            </tr>                            
                            <?php
                            $inc++;
                          ...
                          <td></td>
                            ...
                            <td><b><?=my2digit(round($total_value)) ?></b></td>
                            </tr> 
                        </tfoot>
                    </table>
                </div>
