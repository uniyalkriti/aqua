...
<?php 
$forma = 'HSN Details'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dispatch_report();
$objchallan = new dealer_sale();
$cls_func_str = 'hsn_detailed'; //The name of the function in the class that will do the job
...
if(isset($_POST['filter']) && $_POST['filter'] == 'Filter')
{
  ...
  $rs = $mycurobj->$funcname($filter="$myfilter'$ajaxshowid'",  $records = '', $orderby='');
     ...
     //echo $funcname;die;
      ...
      $status=$_GET['status'];
    $rs = $myobj->$funcname($start,$end,$hsn_code,$status,$filter,  $records = '', $orderby='');
}
$rs1 = array();
            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <span style="color:#fff;">HSN/SAC Summary</span>
                ...
                <!-- div.table-responsive -->
                  ...
                  <!-- div.dataTables_borderWrap -->
                   <div id="divToPrint">
                    ...
                    ?>
                    <h2><strong>HSN/SAC Summary of HSN Code:<?= $hsn_code?> From <?=$start1?> To <?=$end1?></strong></h2>
                            <thead>          
                            <tr> 
