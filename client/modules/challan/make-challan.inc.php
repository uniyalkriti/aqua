...
if (isset($_GET['actiontype'])) {
    switch ($_GET['actiontype']) {
        case'print':
            ...
            break;
        case'printbook':
            require_once('challan-print-book.inc.php');
            exit();
            break;    
        default:
                    ...
                    <td width="10%">Retailer<br/>
                        <?php
                         ...
                         $dealer_id = $_SESSION[SESS.'data']['dealer_id'];
                            ...
                            db_pulldown($dbc, 'retailer_id', $q, true, true, 'id="retailer_id" class="chosen-select less"','==Please Select==',$_POST['retailer_id']);
                        ?>
                    </td>
                         ...
                         <tbody>
                            ...
                            foreach ($rs as $key => $rows) {
                                ...
                                //  $frz_date = date("d-m-Y", strtotime($rows['ch_date'].'+2 days'));
                                 $frz_date = date("d-m-Y", strtotime($rows['ch_date'].'+30 days'));
...
if($rows['book_status']==1){
$printlink = '<span class="seperator">|</span> <a class="iframef" title="print Invoice ' . $uidname . '" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid . '&actiontype=printbook"><img src="../icon-system/i16X16/print.png"></a>';
}else{
...
//$rows['postat'] == 1 ? '<span class="seperator">|</span> <a class="iframef" title="print PO '.$uidname.'" href="index.php?option='.$formaction.'&showmode=1&mode=1&id='.$uid.'&actiontype=print"><img src="../icon-system/i16X16/print.png"></a>' : '';
                            ...
                            ?>
                                ...
                                <td style="width:15%">   
                                 <?php if($rows['book_status']==1){ 
  						echo'
                        <a target="_blank" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid .'&actiontype=printbook">'; ?><?php echo $uidname;?></a> 
                        <?php }else{
                        echo'
                        <a target="_blank" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid .'&actiontype=print">'; ?><?php echo $uidname;?></a> 
                        <?php }?>
                        </td>
                                <td>
                                    <?=$rows['retailer_id']?>
