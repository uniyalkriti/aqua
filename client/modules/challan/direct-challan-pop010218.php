            ...
            <table width="100%" id="mytable" class="">
                <tr class="thead" style="font-weight:bold;">
                   ...
                   <!--  <th style="background-color:#C7CDC8; color:#000;border:1px solid black;">Bill of Supply</th> -->
                    ...
                    <th style="background-color:#C7CDC8; color:#000;border:1px solid black;">Avlb. Stock</th>
...
<!--                    <th style="background-color:#C7CDC8; color:#000;">Sch. Quantity</th>-->
                    ...
                    <th style="background-color:#C7CDC8; color:#000;border:1px solid black;">C.D Type</th>
                    <th style="background-color:#C7CDC8; color:#000;border:1px solid black;">C.D.</th>                                                
