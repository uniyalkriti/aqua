...
<table width="100%" >
    ...
    <tr>
        <td colspan="4" style="width: 910px"></td>
        <td colspan="1">
             <strong>Amount</strong><br/>
             <strong><input type="text" name="" id="total_disc2" class="" value="<?php echo $amount1 ?>" readonly=""></strong> 
                  <br><br/> 
            ...
            <select name="dis" id="dis" onchange="getTotal(this.value);">
             ...
             <strong>
                 ...
                 <input type="text" readonly="" class="totamt" name="totamt" placeholder="<?php echo round($final_amt,2) ?>"></strong>
        </td>
    </tr>
                            </table>
                        </div>
