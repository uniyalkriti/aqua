...
?>
 <input type="hidden" name="location_id" id="location_id" value="<?php if (isset($_POST['location_id'])) echo $_POST['location_id']; ?>">
                    ...
                    <td>
                      ...
                      $u_q = "SELECT d.user_id,CONCAT_WS(' ',p.first_name,p.last_name, '[',r.rolename,']') FROM `user_dealer_retailer` d INNER JOIN person p ON d.user_id=p.id INNER JOIN _role r ON p.role_id=r.role_id  WHERE d.dealer_id = '" . $_SESSION[SESS . 'data']['dealer_id'] . "' ORDER BY p.first_name";
...
<!--                    <th style="background-color:#C7CDC8; color:#000;">Sch. Quantity</th>-->
                ...
                <td width="10%">
                 ...
                 <td>                     
                     <select  style="width:60px" name="mrp[]" class="mrp mrp_dd" id="mrp<?=$z?>" placeholder="MRP">
...
<!--                 <td>                    
                   ...
                   <option value="<?=$_POST['challan_item'][$keys[$z-1]]['hsn_code']?>" selected="selected"><?=$_POST['challan_item'][$keys[$z-1]]['hsn_code']?></option>
                    ...
                    <td><input style="width:98%" placeholder="Quantity" onkeypress="javascript:return isNumber(event)" type="text"  name="quantity[]" id="quantity" onblur="product_calculate();"  value="<?=$_POST['challan_item'][$keys[$z-1]]['qty']?>" class="quantitycl"/>
                    </td>
<!--                    <td>
                    ...
                    <td>
                     <input style="width:90%" placeholder="Rate" type="text" name="rate[]" id="rate" class="rate" onblur="product_calculate();" value="<?=$_POST['challan_item'][$keys[$z-1]]['product_rate']?>" readonly/>
                    </td>
                    <td>
                    ...
                    <td>
                        <input style="width:98%" placeholder="Trade" type="text" name="trade_disc_val[]" value="<?=$_POST['challan_item'][$keys[$z-1]]['dis_percent']?>"  onblur="trade_disc_calculate();product_calculate();"  />
                    </td>   

                    <td>
                        <input style="width:90%" placeholder="Trade Amt." type="text" name="trade_disc_amt[]" value="<?=$_POST['challan_item'][$keys[$z-1]]['dis_amt']?>" onblur="total_amount_invoice();" readonly />
...
<!--                            <option value="3"> Kg </option>-->
                    ...
                    <td>
                        <input type="text" style="width:98%" placeholder="CD" name="cd[]" value="<?=$_POST['challan_item'][$keys[$z-1]]['cd']?>"  onblur="product_calculate();" />
                    </td>

                    <td>
                        <input type="text" style="width:90%" placeholder="cd amt" name="cd_amt[]" onblur="product_calculate();" value="<?=$_POST['challan_item'][$keys[$z-1]]['cd_amt']?>" readonly/>
                    </td>
                    <td>
                        <input type="text"  style="width:98%" placeholder="Taxable" name="taxable_amt[]"  value="<?=$_POST['challan_item'][$keys[$z-1]]['taxable_amt']?>" onblur="total_amount_invoice();" readonly />
                    </td>
                    <td>
                   ...
                   <input   type="text"  style="width:98%" placeholder="GST" name="vat[]" class="vat" id="vat<?=$z?>" onblur="total_amount_invoice();"  value="" readonly/>
                    <td>
                        <input type="text" name="vat_amt[]"  style="width:98%" placeholder="Vat"  id="vat_amt" value="<?=$vat_amt?>"  onblur="total_amount_invoice();" readonly/>
                        <input type="hidden" name="surcharge[]" id="surcharge"  value="<?php echo $surcharge;?>" readonly/>
                    </td>
                    <td>
                        <input type="text" style="width:98%" <?php if($z-1>=7){?>class="addbutton" <?php } ?> placeholder="Amount" name="amount[]" id="amount" onblur="total_amount_invoice();" value="<?=number_format($amount,2,'.',','); ?>"  readonly/>
                    </td>
                    <td>
...
<!--                    <td></td>-->
                ...
                <tr>
                     ...
                     <td colspan="2">
                       <strong> Enter Discount %</strong><br/>
                        ...
                        <input type="text" name="dis" id="dis" onkeyup="total_amount_with_discount(this.value)"/> 
                     </td>
                ...
                <tr>
                     ...
                     <td colspan="2">
                       ...
                       <strong>
                        <input  style="width:98%" type="text" name="total_amount_a" id="total_amount_a" value="0" readonly>    </strong>                
                    </td>                     
                </tr>               
            </table>   
