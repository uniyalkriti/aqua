...
$myobjd = new dealer_sale_damage_depot();
...
<!--      <span style="font-size:9pt; font-weight:normal; letter-spacing:-0.5pt;">Invoice for removal of Excisable Goods from a factory or warehouse on payment of Duty (Rule-11)</span>      -->
  ...
  <table width="100%" class="header_table" style="margin-top:0pt;border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="0">
      <tr>
        <td style="width:194px" colspan="8"></td>
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
			...
			<tr>
              <td colspan="8"><strong>E-WAY Bill No.: </strong><br> <strong>Date : </strong>
             </td>
              <td></td>
            </tr>
            <tr>
                <td colspan="2"><strong> Depot: <?php echo $value['adr']['csa_name']; ?></strong>
                <br/>
                <strong>Address: </strong>
                <?php echo $value['adr']['adress']; ?>
                </td>
            </tr>
            
            <tr>
                <td colspan="2"><strong> PH No: </strong><?php echo $value['adr']['mobile'];?> / <?php echo $value['adr']['other_numbers'];?>
                </td>
            </tr>
             <tr>
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
            ...
            <tr>
                <td colspan="2"><strong> Depot: <?php echo $value['adr']['csa_name']; ?></strong><br/><strong>Address: </strong>
                <?php echo $value['adr']['adress']; ?>
                </td>
            </tr>
      ...
      <tr style="font-weight:bold;">
        ...
        <td rowspan="2" style="width:7%" align="center">Mfg.Date</td>
        ...
        <td rowspan="2" style="width:4%" align="center">Special Disc.%</td>
...
<!--        <td style="border-bottom:none;border-top:none;height:35px;"> <?php echo $value1['comunity_code'];?></td>-->
        ...
        <td style="border-bottom:none;border-top:none;height:35px;"><?php echo $value1['mfgdate'] ?></td>
        <td style="border-bottom:none;border-top:none;height:35px;" align="right"> <?php echo $value1['qty'];?></td>
       <td style="border-bottom:none;border-top:none;height:35px;" align="right"> <?php echo $value1['free_qty'];?></td>
...
<!--        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($surcharge);?></td>
  ...
  <?php $net_amt = $value1['taxable_amt']; ?>
    ...
    <?php
       ...
       <?php if($dealer_state_id == $retailer_state_id){ $col = '2'; $col1 = '2'; $col2 = '18'; $col3 = '3'; }else{
          $col = '1'; $col1 = '1'; $col2 = '14'; $col3 = '3'; 
      } ?>
      ...
      <tr style="border-left:0px;">
          <td colspan="15" align="Left" style="border-right:0px;">
...
<!--           <td colspan="5">
       ...
       <tr>
         <td valign="top" colspan="12" style="border:none;">
