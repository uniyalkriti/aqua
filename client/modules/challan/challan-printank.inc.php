...
<!--        <td style="width:40%">Com Code</td>-->
        ...
        <td style="width:4%" align="right">Sch. Qty</td>
        <td style="width:7%">M.R.P</td>
        <td style="width:8%">Rate</td>
        <td style="width:4%">Trade/ Sch. Disc.%</td>
        <td style="width:4%">Trade/ Sch. Disc. Amt.</td>
        <td style="width:8%">Other Disc. %</td>
        <td style="width:8%">Other Disc. Amt.</td>
        <td style="width:5%" align="right">Tax - able Amt.</td>
        <td style="width:5%" align="right">VAT%</td>
        <td style="width:8%" align="right">VAT Amt</td>
        <td style="width:6%">Sur - charge %</td>
        <td style="width:6%">Sur - charge Amt</td>
        <td style="width:15%" align="right">Total Amt.</td>
      </tr>
      <?php 
	  $inc =1; 
          $i=1;
...
<!--        <td style="border-bottom:none;border-top:none;height:36px;"> <?php echo $value1['comunity_code'];?></td>-->
	...
	<?php  
            ...
            $net_amt = ($taxable+$vat_amt+$surcharge_amt);
        ?>
   ...
   ?>
      ...
      <tr style="font-size:11pt;">
        ...
        <td colspan="1" align="right"><strong><?php echo my2digit($dis_amt); ?><!--106425.00--></strong></td>
        <td colspan="2" align="right"><strong><?php echo my2digit($cd_amt); ?><!--106425.00--></strong></td>
        <td colspan="1" align="right"><strong><?php echo my2digit($taxable_amt); ?><!--106425.00--></strong></td>
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_vat_amt); ?><!--106425.00--></strong></td>
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_surcharge_amt); ?><!--106425.00--></strong></td>
        <td colspan="1" align="right"><strong><?php echo price_to_words(round($grandtotal)); ?><!--106425.00--></strong></td>
      </tr> 
      
      <tr style="font-size:11pt;">
         <td colspan="17">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($grandtotal,2));?></b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
        </tr>
        ...
        <tr>
           ...
           <td colspan="7" align="right" style="border-left:none;"><b>For : <?php echo $dealer_data['name']; ?></b><br /><br /><br />Authorised Signatory</td>
        </tr>
    </table>
...
elseif ($value1['cd_type']==2) {
 $cd1 = ($value1['cd']);        
	...
	<?php  
            ...
            $net_amt1 = ($taxable1+$vat_amt1+$surcharge_amt1);
        ?>
	  ...
	  <?php
        ...
        //  $summary_vat[$value1['tax']]['total']+=$summary_vat[$value1['tax']]['amount']+$summary_vat[$value1['tax']]['tax']+$summary_vat[$value1['tax']]['surcharge'];
          ...
          $taxable_amt1 +=$taxable1;
          $ttl_surcharge_amt1 += $surcharge_amt1;
          $ttl_vat_amt1 +=$vat_amt1;
          //$grandcd += $cd;
          $grandtotal1 += $net_amt1 -$value1['cd_amt'];
          //$grandvat += $vat_amt ;
         // h1($grandtotal);
          $inc1++; 
          $i1++;
 ...
 echo'<tr style="font-size:11pt;">
         <td colspan="17" align="right"><b>TO BE CONTINUED</b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
        </tr>';
              $inc1=1;
              echo '</table>
                  <div style="page-break-after:always;page-break-inside:avoid;width: 90%;">
                    </div>
                     
  <div id="pritn_what">
    <div class="mytitle" style="font-size:14pt;text-align:center; font-weight:bold; margin-top:0;">
      <span style="text-decoration:underlinel;">';
              if($value['adr']['tin_no']!='') echo"TAX "; else echo "RETAIL ";echo'
              INVOICE</span><br />
<!--      <span style="font-size:9pt; font-weight:normal; letter-spacing:-0.5pt;">Invoice for removal of Excisable Goods from a factory or warehouse on payment of Duty (Rule-11)</span>      -->
    </div> 
  </div>
        ...
        <td valign="top" colspan="8" style="width:50%;">
          ...
          <table border="0" style="font-family:"Times New Roman", Times, serif; font-size:10pt;">
            <tr>
                <td colspan="3"><strong>'.$companyname1.'</strong></td>
            </tr>
            <tr>
                <td colspan="3">(AUTH. DIST. OF '.$company_data['name'].')</td>
            </tr>
            <tr>
                <td colspan="3" style="">
                   <?php echo $company_adr; ?> <br>
            ...
            <tr>
              <td>TIN. No.: '.$dealer_data['tin_no'].'</td>
              <td>PH NO.:- '.$dealer_data['landline'].'</td>
            </tr>
          </table>
          <!-- table to tin no detail ends here -->
        </td>
        <td valign="top" colspan="9">
	      ...
	      <td align="right"><strong>Authorised Signatory</strong> </td>
            ...
            <tr>
              <td colspan="8"><strong>INV. No.: </strong'.$value['ch_no'].'<br> Date : '.$value['ch_date'].' </td>
              <td></td>
            </tr>
            <tr>
                <td colspan="2"><strong> Retailer: </strong>'.$value['retailer_name'].'<br/><strong>Address: </strong>
                '.$value['adr']['address'].'
                </td>
            </tr>
             <tr>
                 <td colspan="2"><strong>TIN.-:</strong>'.$value['adr']['tin_no'].'</td>	
            </tr>
          </table>
          <!-- table to Tarrif heading detail ends here -->
        </td>  
...
echo'<tr style="font-weight:bold;">
   ...
   ?>
      ...
      <tr style="font-size:11pt;">
        ...
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_vat_amt1); ?><!--106425.00--></strong></td>
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_surcharge_amt1); ?><!--106425.00--></strong></td>
        <td colspan="1" align="right"><strong><?php echo price_to_words(round($grandtotal1)); ?><!--106425.00--></strong></td>
      </tr> 
      <tr style="font-size:11pt;">
         <td colspan="17">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($grandtotal1,2));?></b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
        </tr>
        ...
        <tr>
           <td colspan="10" style="border-right:none;">
               ...
               <?php
             //  pre($summary_vat);
               foreach($summary_vat1 as $key => $val){
                   //pre($summary_vat);
                echo "<tr>";
                echo "<td>".$key."%</td>";
                echo "<td>".$val['amount']."</td>";
                ...
                echo "<td>".$amt11."</td>";
                echo "<td>".$tax11."</td>";
                echo "<td>".$surcharge11."</td>";
                echo "<td>".$total11."</td>";
                echo "</tr>";
           ?>
               </table>
           </td>
           <td colspan="7" align="right" style="border-left:none;"><strong>For <?php echo $dealer_data['name']; ?></strong><br /><br /><br />Authorised Signatory</td>
        </tr>
    </table>
    <table width="100%" border="0" style="font-family:'Times New Roman', Times, serif; font-size:10pt;">
      <tr>
...
elseif ($value1['cd_type']==2) {
 $cd2 = ($value1['cd']);        
	...
	<?php  
            ...
            $net_amt2 = ($taxable2+$vat_amt2+$surcharge_amt2);
        ?>
	  ...
	  <?php
        ...
        //  $summary_vat[$value1['tax']]['total']+=$summary_vat[$value1['tax']]['amount']+$summary_vat[$value1['tax']]['tax']+$summary_vat[$value1['tax']]['surcharge'];
          ...
          $taxable_amt2+=$taxable2;
          $ttl_surcharge_amt2 += $surcharge_amt2;
          $ttl_vat_amt2 +=$vat_amt2;
          //$grandcd += $cd;
          $grandtotal2 += $net_amt2-$value1['cd_amt'];
          //$grandvat += $vat_amt ;
         // h1($grandtotal);
          $inc2++; 
          $i2++;
...
<!--      <span style="font-size:9pt; font-weight:normal; letter-spacing:-0.5pt;">Invoice for removal of Excisable Goods from a factory or warehouse on payment of Duty (Rule-11)</span>      -->
        ...
        <td valign="top" colspan="8" style="width:50%;">
          ...
          <table border="0" style="font-family:"Times New Roman", Times, serif; font-size:10pt;">
            <tr>
                <td colspan="3"><strong>'.$companyname.'</strong></td>
            </tr>
            <tr>
                <td colspan="3">(AUTH. DIST. OF '.$company_data['name'].')</td>
            </tr>
...
echo'<tr style="font-weight:bold;">
   ...
   ?>
      ...
      <tr style="font-size:11pt;">
        ...
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_vat_amt2); ?><!--106425.00--></strong></td>
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_surcharge_amt2); ?><!--106425.00--></strong></td>
        <td colspan="1" align="right"><strong><?php echo price_to_words(round($grandtotal2)); ?><!--106425.00--></strong></td>
      </tr> 
      <tr style="font-size:11pt;">
         <td colspan="17">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($grandtotal2,2));?></b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
        </tr>
        ...
        <tr>
           <td colspan="10" style="border-right:none;">
               ...
               <?php
             //  pre($summary_vat);
               foreach($summary_vat2 as $key => $val){
                   //pre($summary_vat);
                echo "<tr>";
                echo "<td>".$key."%</td>";
                echo "<td>".$val['amount']."</td>";
                echo "<td>".$val['tax']."</td>";
                echo "<td>".$val['surcharge']."</td>";
                $ttl12[$key] =  $val['amount']+$val['tax']+$val['surcharge']-$val['cd_amt'];
                echo "<td>".$ttl12[$key]."</td>";
                echo "</tr>";
                
                $amt12+=$val['amount'];
                $tax12+=$val['tax'];
                $surcharge12+=$val['surcharge'];
                $total12+=$ttl12[$key];
           }
                echo "<tr>";
                echo "<td>Total</td>";
 ...
 $cd3 = ($value1['cd']);        
	  ...
	  ?>
       <tr>
        ...
        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($value1['product_rate']*$value1['qty']);?></td>
        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($value1['tax']).'';?></td>
        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($vat_amt3) ;?></td>
	...
	<?php  
            ...
            $net_amt3 = ($taxable3+$vat_amt3+$surcharge_amt3);
        ?>
	  ...
	  <?php
        ...
        //  $summary_vat[$value1['tax']]['total']+=$summary_vat[$value1['tax']]['amount']+$summary_vat[$value1['tax']]['tax']+$summary_vat[$value1['tax']]['surcharge'];
          ...
          $taxable_amt3 +=$taxable3;
          $ttl_surcharge_amt3 += $surcharge_amt3;
          $ttl_vat_amt3 +=$vat_amt3;
          //$grandcd += $cd;
          $grandtotal3 += $net_amt3-$value1['cd_amt'];
          //$grandvat += $vat_amt ;
         // h1($grandtotal);
          $inc3++; 
          $i3++;
...
echo'<tr style="font-weight:bold;">
   ...
   ?>
      ...
      <tr style="font-size:11pt;">
        ...
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_vat_amt3); ?><!--106425.00--></strong></td>
        <td colspan="2" align="right"><strong><?php echo my2digit($ttl_surcharge_amt3); ?><!--106425.00--></strong></td>
        <td colspan="1" align="right"><strong><?php echo price_to_words(round($grandtotal3)); ?><!--106425.00--></strong></td>
      </tr> 
      <tr style="font-size:11pt;">
         <td colspan="17">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($grandtotal3,2));?></b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
        </tr>
        ...
        <tr>
           <td colspan="10" style="border-right:none;">
               ...
               <?php
             //  pre($summary_vat);
               foreach($summary_vat3 as $key => $val){
                   //pre($summary_vat);
                echo "<tr>";
                echo "<td>".$key."%</td>";
                echo "<td>".$val['amount']."</td>";
                echo "<td>".$val['tax']."</td>";
                echo "<td>".$val['surcharge']."</td>";
                $ttl13[$key] =  $val['amount']+$val['tax']+$val['surcharge']-$val['cd_amt'];
                echo "<td>".$ttl13[$key]."</td>";
                echo "</tr>";
                
                $amt13 +=$val['amount'];
                $tax13 +=$val['tax'];
                $surcharge13 +=$val['surcharge'];
                $total13 +=$ttl13[$key];
           }
                echo "<tr>";
                echo "<td>Total</td>";
