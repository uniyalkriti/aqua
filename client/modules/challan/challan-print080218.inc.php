...
<!--      <span style="font-size:9pt; font-weight:normal; letter-spacing:-0.5pt;">Invoice for removal of Excisable Goods from a factory or warehouse on payment of Duty (Rule-11)</span>      -->
  ...
  <table width="100%" class="header_table" style="margin-top:0pt;border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="0">
    ...
    <table width="100%" class="header_table" style="margin-top:0pt; border:1pt solid #000; border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="1">
      <tr>
        <td valign="top" colspan="10" style="width:50%;">
...
<!--        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($surcharge);?></td>
  ...
  <?php $net_amt = $value1['taxable_amt']; ?>
    ...
    <?php
       ...
       <?php if($dealer_state_id == $retailer_state_id){ $col = '2'; $col1 = '2'; $col2 = '17'; $col3 = '2'; }else{
      ...
      <tr style="border-left:0px;">
          <td colspan="14" align="Left" style="border-right:0px;">
...
<!--           <td colspan="5">
        ...
        <tr style="font-size:11pt;">
         ...
         <td colspan="<?php echo $col3; ?>" style="border-left:0px;"> <span style="float:right"><b><?php echo round($value['amount']);?></b></span></td>

       </tr>  
        
        <tr style="font-size:11pt;">
         <td colspan="19">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($value['amount'],2));?></b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
       </tr>   
    </table>
    <table class="header_table" width="100%" border="0" style="font-family:'Times New Roman', Times, serif; font-size:10pt;border:1pt solid #000;">
      <tr>
         <td valign="top" style="border:none;"><span style="font-size:9pt;">
         		<strong>Terms & Conditions:</strong><br>
         <?php if(!empty($dealer_data['terms'])) echo "<pre>".$dealer_data[terms]."</pre>"; else echo "";?></span></td>
