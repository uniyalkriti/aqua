...
if (!empty($rs)) {
  ...
  foreach ($rs as $key => $value) { 
   ...
   <!--  <input type="hidden" id="p<?php echo $i; ?>" name="product_id[<?=$o_id;?>][]" value="<?php echo $prod_id; ?>" class="item_details"> -->
    ...
    <td>
      <input type="text" id="trade_disc_amt<?php echo $i; ?>" class="tdamt<?php echo $key?>" name="trade_disc_amt[<?=$value['order_id'];?>][]" value="<?php if(!empty($trade)){ echo $tda;   }  ?>" readonly/>
    ...
    <td><input type="text" id="cd_amt<?php echo $i; ?>" class="cd_amt<?php echo $key; ?>" name="cd_amt[<?=$value['order_id'];?>][]" value="<?php if(!empty($cd)){ echo $cda;   }  ?>" onblur="total_amount_invoice('<?=$value['order_id'];?>',<?=$i;?>);calc_total_amount('amountpk<?php echo $key?>','<?php echo $key?>')" readonly></td>
    <?php
    $amt = $amount-$cda-$tda;
    $famt = $f_amt-$cda-$tda;
    ?>
