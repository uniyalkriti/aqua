    ...
    <tr>
        <td colspan="5">
            <table width="100%" id="mytable" class="">
				...
				<td>
                    <select name="spl_disc_type[]" lang="spl_disc" onchange="product_calculate()" style="width:98%"> 
                ...
                <td>
                    <input type="text" style="width:98%" placeholder="Spl" name="spl_disc_val[]" value="<?=$_POST['challan_item'][$keys[$z-1]]['spl_disc_val']?>"  onblur="product_calculate();calc_total_amount();" />
                </td>

                <td>
                    <input type="text" style="width:90%" placeholder="spl_disc_amt" name="spl_disc_amt[]" onblur="product_calculate();calc_total_amount();" value="<?=$_POST['challan_item'][$keys[$z-1]]['spl_disc_amt']?>" class="spl_disc_amt" />
                </td>
                <td>
                ...
                <td>
                    <input type="text" style="width:90%" placeholder="cd amt" name="cd_amt[]" onblur="product_calculate();calc_total_amount();" value="<?=$_POST['challan_item'][$keys[$z-1]]['cd_amt']?>" class="cd_amt" />
                </td>
                <td>
                ...
                <td>
                   ...
                   <!-- <input   type="text"  style="width:98%" placeholder="GST" name="vat[]" id="vat<?=$z?>" value="<?=number_format($_POST['challan_item'][$keys[$z-1]]['tax'],2)?>" class="vat"/>-->
					<input type="text" style="width:100%" placeholder="CGST" name="cgst[]" class="cgst" id="cgst<?=$z?>" value="<?=number_format((($_POST['challan_item'][$keys[$z-1]]['tax'])/2),2)?>" readonly/>
                    </td>
					<td>
					<input type="text" style="width:100%" placeholder="AMT" name="cgst_amt[]" class="cgst_amt" id="cgst_amt" value="<?=$vat_amt1/2?>" readonly/>
					</td>
					<td>
					<input type="text" style="width:100%" placeholder="SGST" name="sgst[]" class="sgst" id="sgst<?=$z?>" value="<?=number_format((($_POST['challan_item'][$keys[$z-1]]['tax'])/2),2)?>" readonly/>
					</td>
					<td>
                   <input type="text" style="width:100%" placeholder="AMT" name="sgst_amt[]" class="sgst_amt" id="sgst_amt" value="<?=$vat_amt1/2?>" readonly/>
                 </td>
				 <td>
                   <input type="text" style="width:100%" placeholder="IGST" name="vat[]" class="vat" id="vat<?=$z?>" value="<?=number_format($_POST['challan_item'][$keys[$z-1]]['tax'],2)?>" readonly/>
                 </td>
					<td>
