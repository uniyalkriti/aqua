                    ...
                    <td width="50%">
                        <div>
                            <div>
                                ...
                                <select name="dis" id="dis" onchange="getTotal(this.value);">
                            ...
                            <div style="float: right;margin: -31px 60px 0 0;">
                                <strong>Total Amount</strong><br/>
                                <input type="text" readonly="" style="font-size: 14px;border: 1px solid;width: 112px;" name="totamt" placeholder="<?php echo $amount ?>" value="<?php echo $amount ?>">
                            </div>
                        </div>
            ...
            <table width="100%" id="mytable">
                ...
                <!-- onblur="get_available_stock(this.id,this.value,event);" -->
                   ...
                   <select style="width:80px" name="mrp[]" id="mrp<?=$z?>" placeholder="MRP" class="mrp mrp_dd" >
                    ...
                    <td><input style="width:98%" placeholder="Quantity" type="text"  name="quantity[]" id="quantity" onchange="updateInput(<?=$z?>)" onblur="product_calculate();" value="<?=$_POST['challan_item'][$keys[$z-1]]['qty']?>"  class="quantitycl"/>
                    ...
                    <td>
                     <input style="width:90%" placeholder="Rate" type="text" name="rate[]" id="rate" onblur="product_calculate();" value="<?=$_POST['challan_item'][$keys[$z-1]]['product_rate']?>" class="rate"/>
                    </td>
                    <td>
...
<!--                            <option value="3"> Kg </option>-->
                   ...
                   <input   type="text"  style="width:98%" placeholder="GST" name="vat[]" id="vat<?=$z?>" value="<?=number_format($_POST['challan_item'][$keys[$z-1]]['tax'],2)?>" class="vat"/>
                    ...
                    <td><input type="text" style="width:98%" placeholder="Amount" name="amount[]" id="amount" value="<?=$_POST['challan_item'][$keys[$z-1]]['taxable_amt']?>"  /></td>
