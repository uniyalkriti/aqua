...
if (!empty($rs)) {
  ...
  foreach ($rs as $key => $value) {  
    ...
    {
       die('<div class="alert alert-danger">Please updated your stock first.</div>');
    }
    ?>
    <div id="workarea">
    ...
    <td>
      ...
      <?php /*pre($invalue);*/ $mrp_list = get_product_mrp($dbc,$product_id,$value['dealer_id']); ?>
    ...
    <td>
     <input readonly id="aval_stock<?php echo $i; ?>" class="aval_stock avlb_quantity" type="text" name="aval_stock[<?=$value['order_id'];?>][]" value="<?php echo $myobj->calculate_available_stock($invalue['product_id']); ?>"  />
    </td>
    ...
    $rates = $row['rate'];
    $mrp_calc = new_rate_calc($igst,$product_id,$row['mrp']);
    $rates = $mrp_calc['rate'];
    /*if($igst>0)
    {
    ...
    <td><input readonly id="r<?php echo $i; ?>" onblur="cd_product_calculate(<?=$i;?>);" type="text" class="rate" name="rate[<?=$value['order_id'];?>][]" value="<?php echo $invalue['rate']; ?>"></td>
    ...
    <td><input readonly type="text" id="amount<?php echo $i; ?>" name="amount[<?=$value['order_id'];?>][]" value="<?php if(!empty($tda) || !empty($cda)) echo $famt; else echo $f_amt;?>"></td>
      ...
      <!--<td style="width:10px"><?php //echo $deletelink1; ?></td>-->
            ...
            <tr>
              ...
              <td style="width:100px"><input type="text" id="total<?php echo $i?>" name="total" value="<?=$total?>"></td>
            ...
            <tr>
             ...
             <td colspan="2">
               ...
               <select name="dis[<?=$value['order_id'];?>]" id="dis" class="dis" onchange="total_amount_with_discount(this.value,'total_disc<?php echo $i?>','total_amount_a<?php echo $i?>','total<?php echo $i?>')">
              ...
              <strong>Discount Amount</strong>
               <strong>
                <input  style="width:98%" type="text" name="total_disc[<?=$value['order_id'];?>]" id="total_disc<?php echo $i?>" value="0" readonly>    </strong> 
                <br/>
                <strong>Total Amount</strong>
               <strong>
                <input  style="width:98%" type="text" name="total_amount_a[<?=$value['order_id'];?>]" id="total_amount_a<?php echo $i?>" value="<?=$total?>" readonly>    </strong> 
            </td>
