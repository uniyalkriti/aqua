...
?>
<div id="breadcumb"><a href="#">Sales</a> &$incraquo; <a href="index.php?option=<?php echo $formaction; ?>" style="color:#2dcf5f;"><?php echo $forma; ?></a> <span id="ajaxloader"><img src="images/ajaxloader.gif" /> Loading...</span>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="table-header">
                    <!--<a class="iframef" title="print All Selected Invoice" id="print_all" href="index.php?option=make-challan&showmode=1&mode=1&actiontype=print&id="><i class="fa fa-print" style="color:#fff;"></i></a>-->
                        ...
                        <thead>                           
                         ...
                         <tbody>
                            ...
                            foreach ($rs as $key => $rows) {
                                ...
                                $uid = $rows['id'];                
                                $uidname = $rows['ch_no'];                              
                                 $frz_date = date("Y-m-d", strtotime($rows['ch_date'].'+30 days'));
                                 if($frz_date>=date('Y-m-d')){
                                $editlink = '<a target="_blank" title="RETURN/CHANGE" class="iframef" href="index.php?option=challan-edit&showmode=1&mode=1&page=Return Invoice/Challan&id='. $uid . '"><i class="fa fa-reply fa-2x"></i></a>';
                                 }  else {
                                 $editlink = '';    
                                 }
                                ...
                                <td>
                                  ...
                                  <style>tr.bordered {border-bottom: 1px solid #000;}</style>
                                    <tr class="bordered">
                                     ...
                                     <td style="border:1px;"><?=$invalue['product_rate']?></td>  
                                    <td style="border:1px;"><?=$invalue['qty']?></td>  
                                     <td style="border:1px;"><?=$invalue['free_qty']?></td>  
                                     <td style="border:1px;"><?=my2digit($invalue['dis_amt'])?></td> 
                                     <td style="border:1px;"><?=my2digit($invalue['cd_amt'])?></td> 
                                     <td style="border:1px;"><?=my2digit($invalue['vat_amt'])?></td>  
                                     <td style="border:1px;"><?=my2digit($invalue['taxable_amt'])?></td>  
