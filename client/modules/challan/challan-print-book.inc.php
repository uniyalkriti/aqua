  ...
  <tr>
    <td>
      <div class="subhead1"><!-- this portion indicate the print options -->
        ...
        <a href="" title="take a printout" style="margin:0 10px;" onclick="PrintDiv();"><img src="./icons/print.png" /></a>
        Print Invoice
      </div>
    </td>
  </tr> 
...
<div id="certificate_container" style="padding:0px; font-size:62.5%; font-family:'Times New Roman', Times, serif; page-break-after:auto; margin:0 auto; width:970pt;">
  <div id="pritn_what">
    <div class="mytitle" style="font-size:14pt;text-align:center; font-weight:bold; margin-top:0;">
      ...
      <!-- <?php echo ($value['adr']['tin_no']!='') ? "TAX ":"TAX "?>INVOICE -->
      BILL OF SUPPLY</span><br />
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
      ...
      <tr style="font-weight:bold;">
        <td rowspan="1" style="width:3%" align="center">S No.</td>
        <td rowspan="1" style="width:15%" align="center">Item Name</td>
        <td rowspan="1" style="width:5%" align="center">HSN Code</td>
        <td rowspan="1" style="width:5%" align="center">Batch No.</td>
        <td rowspan="1" style="width:5%" align="center">Mfg.Date</td>
        <td rowspan="1" style="width:4%" align="center">Qty</td>
		<td rowspan="1" style="width:4%" align="center">Free</td>
        <td rowspan="1" style="width:5%" align="center">M.R.P</td>
        <td rowspan="1" style="width:5%" align="center">Rate</td>
        <td rowspan="1" style="width:4%" align="center">Trade/ Sch. Disc.%</td>
        <td rowspan="1" style="width:4%" align="center">Trade/ Sch. Disc. Amt.</td>

        <td rowspan="1" style="width:4%" align="center">Special Disc.%</td>
        <td rowspan="1" style="width:4%" align="center">Special Disc. Amt.</td>

        <td rowspan="1" style="width:4%" align="center">ATD Disc. %</td>
        <td rowspan="1" style="width:4%" align="center">ATD Disc. Amt.</td>
        <td rowspan="1" style="width:5%" align="center">Tax - able Amt.</td>
        <!-- <td rowspan="1" style="width:7%" align="center">GST %</td>
       ...
       <?php } ?> -->
        ...
        <td rowspan="1" style="width:11%" align="center">Total Amt.</td>
      </tr>      
      <!-- <tr style="font-weight:bold;">   
    ...
    foreach($value['challan_item'] as $key1=>$value1){ 
      ...
      if($value1['cd_type']==1){
       ...
       <?php 
              ...
              <tr style="font-weight:bold;">
                <td rowspan="1" style="width:3%" align="center">S No.</td>
                <td rowspan="1" style="width:40%" align="center">Item Name</td>
                <td rowspan="1" style="width:5%" align="center">HSN Code</td>
				<td rowspan="1" style="width:5%" align="center">Batch No.</td>
        <td rowspan="1" style="width:5%" align="center">Mfg.Date</td>
                <td rowspan="1" style="width:5%" align="center">Qty</td>
				<td rowspan="1" style="width:5%" align="center">Free</td>
                <td rowspan="1" style="width:7%" align="center">M.R.P</td>
                <td rowspan="1" style="width:8%" align="center">Rate</td>
                <td rowspan="1" style="width:4%" align="center">Trade/ Sch. Disc.%</td>
                <td rowspan="1" style="width:4%" align="center">Trade/ Sch. Disc. Amt.</td>
                <td rowspan="1" style="width:4%" align="center">Special Disc.%</td>
        <td rowspan="1" style="width:4%" align="center">Special Disc. Amt.</td>
...
<!--        <td style="border-bottom:none;border-top:none;height:36px;" align="right"> <?php echo my2digit($surcharge);?></td>
  ...
  <?php $net_amt = $value1['taxable_amt']; ?>
    ...
    <?php
       ...
       <?php if($dealer_state_id == $retailer_state_id){ $col = '2'; $col1 = '2'; $col2 = '15'; $col3 = '3'; }else{
          $col = '1'; $col1 = '1'; $col2 = '9'; $col3 = '3'; 
      } ?>
      ...
      <tr style="border-left:0px;">
          <td colspan="12" align="Left" style="border-right:0px;">
		  ...
		  <?php 
		  $tgst=0;
			  $gstq0="SELECT sum(vat_amt) AS tax_sum FROM challan_order_details WHERE ch_id='$_GET[id]' AND tax=0.00";
				...
				?>
				<td><?=number_format($gst_amt_sum0,2);?></td>
				<?php 
			  $gstq5="SELECT sum(vat_amt) AS tax_sum FROM challan_order_details  WHERE ch_id='$_GET[id]' AND tax=5.00";
				...
				?>
				<td><?=number_format($gst_amt_sum5,2);?></td>
				<?php 
			  $gstq12="SELECT sum(vat_amt) AS tax_sum FROM challan_order_details  WHERE ch_id='$_GET[id]' AND tax=12.00";
				...
				?>
				<td><?=number_format($gst_amt_sum12,2);?></td>
				<?php 
			  $gstq18="SELECT sum(vat_amt) AS tax_sum FROM challan_order_details  WHERE ch_id='$_GET[id]' AND tax=18.00";
				...
				?>
				<td><?=number_format($gst_amt_sum18,2);?></td>
				<?php 
			  $gstq28="SELECT sum(vat_amt) AS tax_sum FROM challan_order_details  WHERE ch_id='$_GET[id]' AND tax=28.00";
				...
				?>
				<td><?=number_format($gst_amt_sum28,2);?></td>
				<td><?=number_format($tgst,2);?></td>
		  </tr>
		  </td>
		  </tr>   
		</table>		  
...
<!--           <td colspan="5">
        ...
        <tr style="font-size:11pt;">
         <td colspan="22">Amount of Invoice (in Words) Rupees. <b><?php echo strtoupper(price_to_words($value['amount'],2));?></b><!--ONE LAC SIX THOUSAND FOUR HUNDRED TWENTY FIVE ONLY.--></td>
       </tr>
       <tr>
         <td valign="top" colspan="10" style="border:none;">
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
       ...
       <tr style="font-weight:bold;">
        ...
        <td rowspan="1" style="width:4%" align="center">Trade/ Sch. Disc.%</td>
        <td rowspan="1" style="width:4%" align="center">Trade/ Sch. Disc. Amt.</td>
        <td rowspan="1" style="width:8%" align="center">Other Disc. %</td>
        <td rowspan="1" style="width:8%" align="center">Other Disc. Amt.</td>
        <td rowspan="1" style="width:5%" align="center">Tax - able Amt.</td>
        <td rowspan="1" style="width:7%" align="center">GST %</td>
        <td colspan="2" style="width:5%" align="center"><?php echo $gst; ?></td>       
       <?php  if($dealer_state_id == $retailer_state_id){ ?>
        <td colspan="2" style="width:5%" align="center"><?php echo $gst1; ?></td>      
       <?php } ?>
        <td rowspan="1" style="width:15%" align="center">Total Amt.</td>
      </tr>
