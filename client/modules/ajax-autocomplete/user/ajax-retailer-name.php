...
$qq = "SELECT retailer.id,retailer.name AS imatch FROM challan_order INNER JOIN retailer ON challan_order.ch_retailer_id = retailer.id WHERE retailer.name LIKE '$q%' AND ch_dealer_id = '{$_SESSION[SESS.'data']['dealer_id']}'";
