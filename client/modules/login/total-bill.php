...
$forma = 'Total Bill'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dashboard();
$cls_func_str = 'total_bill'; //The name of the function in the class that will do the job
...
if (isset($_POST['filter']) && $_POST['filter'] == 'Filter') {
    ...
    $rs1 = $myobj->get_pre_total_bill_list($filter, $records = '', $orderby = "ORDER BY $myorderby",$month);
}
                ...
                <div>
                    ...
                    <style> th { background-color: #C7CDC8;color:#000; }</style>
                     <table id="dynamic-table" border="2"  width='100%' class="table table-striped table-bordered table-hover">
                        ...
                        <thead>
                             <tr><th colspan="8" style="background-color:#307ECC;color:#fff;height:35px;font-size: 20px" width="100%">Total Bill </th></tr>
                             
                            <tr>      
                         
                         <th colspan="2" style="text-align:center; ">Total Bill of <?php if(isset($month)){echo date("F-Y", strtotime($month));}?>(<?=$curm?>)</th>
                           <th colspan="2" style="text-align:center; ">Total Bill of <?php if(isset($pmonth)){echo date("F-Y", strtotime($pmonth));}?>(<?=$prem?>)</th>       
                            </tr>
                            <tr valign="top" class="search1tr">
                                
                                <th width="313px">Invoice No.</th>
                                <th>Amount</th>
                        ...
                        <tbody>
                            ...
                            // pre($rs);
                             ...
                             ?>
                                       ...
                                       <tr><td>
                                     <td width="100%" style="background-color:<?php echo $col; ?> ">
                                    <?=$rows['ch_no']?>
                                </td>
                                  <td width="100%" style="text-align:center;background-color:<?php echo $col; ?>;">
                                    &#8377;<?=$rows['amount']?>
                                </td>
