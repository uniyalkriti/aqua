    ...
    <div class="col-xs-6 col-sm-3 pricing-box">
            <div class="widget-box widget-color-red">
                <div class="widget-header">
                    ...
                    echo'
                        <h5 class="widget-title bigger lighter"><strong> <a style="color:#fff;"class="iframef" href="index.php?option=total-bill&showmode=1&mode=1&date=' . $date1 . '">';
                    ?>Total Billing Value of
                    <?php if (isset($_POST['date'])) {
                        echo date("F-Y", strtotime($_POST['date']));
                    } else {
                        echo date("F-Y");
                    } ?> </a></strong></h5>
                </div>
            ...
            <div class="widget-box widget-color-orange">
                <div class="widget-header">
                    <h5 class="widget-title bigger lighter"><strong><?php
                            ...
                            echo'
                        <a style="color:#fff;"class="iframef" href="index.php?option=retailer-reach&showmode=1&mode=1&date=' . $date1 . '">';
                            ?>Retailers Reach of <?php if (isset($_POST['date'])) {
                            echo date("F-Y", strtotime($_POST['date']));
                        } else {
                            echo date("F-Y");
                        } ?></a> </strong></h5>
