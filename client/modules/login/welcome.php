...
?>
   ...
   <!--  <a class="iframef" href="index.php?option=pie-achieved&showmode=1&mode=1&date=<?=$date?>&month=<?=$month?>"> -->
    <div id="chart_div"></div>
   <!--  </a> -->
...
<div class="col-xs-6 col-sm-6 widget-container-col ui-sortable" id="widget-container-col-6" style="min-height: 100px;">
  <div class="panel-group">
   <div class="panel panel-primary">
     ...
     <div class="panel-body">
       <div class="ui-sortable-handle" id="widget-box-5">
         <span style="float:left">
          <i class="ace-icon fa fa-bookmark" style="color:#ad0606"></i><strong> GLD : &#8377; <?=number_format($value_sale1['4'], 2, '.', ',');?></strong><br/>
          <i class="ace-icon fa fa-bookmark" style="color:#f67c0f"></i><strong> ASV : &#8377; <?=number_format($value_sale1['2'], 2, '.', ',');?></strong><br/>                                               
          <i class="ace-icon fa fa-bookmark" style="color:#43114a"></i><strong> CLA : &#8377; <?=number_format($value_sale1['1'], 2, '.', ',');?></strong><br/>                                               
          <i class="ace-icon fa fa-bookmark" style="color:#0a87b2"></i><strong> GEN : &#8377; <?=number_format($value_sale1['3'], 2, '.', ',');?></strong><br/>                                               
          <i class="ace-icon fa fa-bookmark" style="color:#d5e007"></i><strong> JPS : &#8377; <?=number_format($value_sale1['5'], 2, '.', ',');?></strong><br/>                                               
          <i class="ace-icon fa fa-bookmark" style="color:#4d59f0"></i><strong> OTC : &#8377; <?=number_format($value_sale1['6'], 2, '.', ',');?></strong><br/>  
          <i class="ace-icon fa fa-bookmark" style="color:#4d051d"></i><strong> FMCG : &#8377; <?=number_format($value_sale1['9'], 2, '.', ',');?></strong><br/>                                             
    ...
    var GLD = "<?=$value_sale1['4']?>";
    var ASV = "<?=$value_sale1['2']?>";
    var CLA = "<?=$value_sale1['1']?>";
    var GEN = "<?=$value_sale1['3']?>";
    var JPS = "<?=$value_sale1['5']?>";
    var OTC = "<?=$value_sale1['6']?>";
