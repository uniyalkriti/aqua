...
<?php if (isset($_GET['showmode']) && $_GET['showmode'] == 1) { // to show the form when and only when needed?>
        <form method="post" action="<?php if (isset($eformaction)) echo $eformaction; ?>" name="genform" onsubmit="return checkForm('genform');">
            <fieldset>
                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="5">
                    <tr>
                        <td colspan="4"><div class="subhead1">DSP Details</div></td>
                    </tr>
                    <tr>
    ...
    if (!isset($_POST['company_id'])) {
        ...
        ?>
                    ...
                    <tr>
                        <td colspan="4"><div class="subhead1">DSP Address Details</div></td>
                    </tr>
                    <tr>
                    <td>
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="4">
                            ...
                            if (isset($heid)) {
                                ...
                                ?>
                            <a href="index.php?option=add-user"><input type="button" value="Exit" /></a><br />  
<!--                                <input onclick="parent.$.fn.colorbox.close();" type="button" value="Exit" /> <br />-->
                                <?php edit_links_via_js($id, $jsclose = true, $options = array()); ?>            
                            <?php } else { ?>
                            <a href="index.php?option=add-user">  <input onclick="parent.$.fn.colorbox.close();" type="button" value="Close" /></a>
                            <?php } ?>
                        </td>
