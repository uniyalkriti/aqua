...
<script type="text/javascript">    
    ...
    function FormSubmit()
    {
        ...
        if (str != '') {
            $.colorbox({href: 'index.php?option=dsp-wise-challan&showmode=1&mode=1&order_id=' +str+'&fd='+fd+'&td='+td, iframe: true, width: '95%', height: '95%'});
                return true;
        }
        else
            return false;
...
<input type="radio" name="bedStatus" class="reloaded" id="direct"  value="direct">Generate Invoice
            ...
            <input type="radio" name="bedStatus" id="sfa" class="reloaded" checked="checked" value="sfa">Billing Through SFA
