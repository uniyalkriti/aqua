...
$formaction = $p;
$myobj = new report();
$cls_func_str = 'product_sale'; //The name of the function in the class that will do the job
...
$rs = array();
$filterused = '';
$funcname = 'get_product_sale_list';
...
if ($checkpass) {
    ...
    if(!empty($_POST['from_date'])){
      ...
      $filter[] = "cv.c3_id=".$_POST['division'];
            }
     ...
     $filter[] = "ch_dealer_id = '{$_SESSION[SESS.'data']['dealer_id']}'";
            ...
            $myresult = $myobj->$funcname($filter, $records = '', $orderby = ""); // $myobj->get_item_category_list()
            //pre($myresult);
            if (empty($myresult))
             ...
             <table>
               ...
               <div class="col-xs-2">To Date<br />
                     <input type="text" id="tdate" name="to_date" class="datepicker" value="<?php if(isset($_POST['to_date'])) echo $_POST['to_date']; else echo date('d/M/Y');?>" />
                                    ...
                                    <div class="col-xs-2">Retailer<br/>
                        <?php
                ...
                <div class="col-xs-2">Category<br />
                ...
                <div class="col-xs-2">Item Name<br />
                <?php db_pulldown($dbc, 'product_id', "SELECT id, name FROM `catalog_product` ORDER BY name", true, true, 'class="chosen-select form-control"'); ?>   </div>             
                 <div class="col-xs-2">
                     <br/>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div id="divToPrint">
                    ...
                    ?><caption>
                    <h3><strong>Item Wise Retailer Sale Report-<?=$dname?> From <?=$start1?> To <?=$end1?></strong></h3></caption>
                        <thead>
                    ...
                    <td style="text-align: right;"><?=$rows['qty']?></td>
                     <td style="text-align: right;"><?=my2digit($rows['box'])?></td>
                    <td style="text-align: right;"><?=my2digit($rows['taxable_amt'])?></td>
                            </tr> 
                            <?php $inc++; } ?>                    
                         </tbody>
                         <tr>
                        <th><b>Grand Total</b></th>
                         ...
                         <td></td>
                         <td></td>
                          <td style="text-align: right;"><b><?=$tq?></b></td>
                          <td style="text-align: right;"><b><?=my2digit($tb)?></b></td>
                           <td style="text-align: right;"><b><?=my2digit($tv)?></b></td>
                         </tr>
                    </table>
                </div>
            </div>
