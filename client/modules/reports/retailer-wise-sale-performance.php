        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div id="divToPrint">
                    ...
                    ?>
                    <h3><strong>MKT Catg Wise Retailer Sale Report-<?=$dname?> From <?=$start1?> To <?=$end1?></strong></h3>
                        <thead>
                        ...
                        background-color: #C7CDC8;
                         color:#000;
                            ...
                            <?php 
                            $outr=array(); 
                            $qr="SELECT r.id,r.name FROM retailer AS r INNER JOIN challan_order AS co ON r.id=co.ch_retailer_id WHERE co.ch_dealer_id='$dea_id'";
                            ...
                            <tr>
                              ...
                              $asvc+=$asvctr;
                                ?>
                                 ...
                                 <?php $asvsale=$myobj->get_rbilled_stock('2',$k,$start,$end); 
                    ...
                    foreach ($myresult as $key => $rows) { 
                      ...
                      ?>  
                                ...
                                <?php $obsale=$myobj->get_rbilled_stock('8',$k,$start,$end); 
                                $obv+=$obsale;
                                  $total_sale=$total_sale_baid+$obsale;
                                  $gtotal_sale+=$total_sale;
                                ?>
                                 <td style="text-align: right;"><?=my2digit($obsale)?></td>
                                 <td style="text-align: right;"><?=my2digit(ROUND($total_sale))?></td>
                            </tr> 
                            <?php } ?>                    
                         </tbody>
                         <tr>
                        ...
                        <td style="text-align: right;"><b><?=my2digit(ROUND($asvv))?></b></td>
                        <td style="text-align: right;"><b><?=my2digit(ROUND($catv))?></b></td>
                        <td style="text-align: right;"><b><?=my2digit(ROUND($genv))?></b></td>
                        <td style="text-align: right;"><b><?=my2digit(ROUND($gldv))?></b></td>
                         <td style="text-align: right;"><b><?=my2digit(ROUND($otcv))?></b></td>
                         <td style="text-align: right;"><b><?=my2digit(ROUND($ot2v))?></b></td>
                        <td style="text-align: right;"><b><?=my2digit(ROUND($fmcgv))?></b></td>
                        <td style="text-align: right;"><b><?=my2digit(ROUND($othv))?></b></td>
                        <td style="text-align: right;"><b><?=my2digit(ROUND($jpsv))?></b></td> 
                      <td style="text-align: right;"><b><?=my2digit(ROUND($gtotal_sale_baid))?></b></td>
                      <td style="text-align: right;"><b><?=my2digit(ROUND($obv))?></b></td>
                       <td style="text-align: right;"><b><?=my2digit(ROUND($gtotal_sale))?></b></td>
                         </tr>
                    </table>
                </div>
            </div>
