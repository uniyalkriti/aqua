...
$forma = 'Sales Purchase Performance '; // to indicate what type of form this is
$formaction = $p;
$myobj = new report();
$cls_func_str = 'sales_purchase_performance'; //The name of the function in the class that will do the job
...
$rs = array();
$filterused = '';
$funcname = 'get_sales_purchase_performance_list';
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div id="divToPrint">
                    ...
                    ?>
                    <h2><strong>Sale VS Purchase Report-<?=$dname?> From <?=$start1?> To <?=$end1?></strong></h2>
                        <thead>
                        ...
                        background-color: #C7CDC8;
                         color:#000;
                            ...
                            <tr> 
                                ...
                                <th colspan='2' style="text-align: center;"><?=$rows[0]?></th> 
                                <?php } ?>
                            </tr>
                            <tr>
                            <?php foreach ($myresult as $key => $rows) {?>
                         ...
                         <tr>
                          ...
                          // pre($myresult);
                            ...
                            ?>  
                                <td>
                                <?php
                                // $wherec="DATE_FORMAT(`ch_date`,'%Y-%m')=".$key." AND ch_dealer_id=".$dea_id; 
                                // $sale=myrowval('challan_order','sum(amount)',$wherec);
                                ?>
                                   <?=my2digit($rows['sale'])?>
                                </td>
                                <td>
                                <?php
                                // $wherep="DATE_FORMAT(`ch_date`,'%Y-%m')=".$key." AND dealer_id=".$dea_id; 
