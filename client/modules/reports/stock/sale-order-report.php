...
if (isset($_POST['submit']) && $_POST['submit'] == 'Save') {
    if (valid_token($_dealdealer_saledealer_saleer_dealer_salesalePOST['hf'])) { // checking if post value is same as timestamp stored in session during form load
...
<!--                                         <th style="border:none;width: 80px;">Rate</th>-->
          ...
          //     $deletelink = '';
                ...
                echo'
              <tr>
    <td >' . $inc . ' <input type="checkbox" name="order_id[]" value="'.$uid.'" </td>
