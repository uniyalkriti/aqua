...
<style type="text/css">
  .tdclass1{border-bottom:none;border-top:none;height:10px;}
  .tdclass2{border-bottom:none;border-top:none;height:36px;}
</style>
...
<?php if($value['adr']['tin_no']!='') echo"TAX "; else echo "TAX "?>INVOICE</span><br />
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
      ...
      <?php 
          ...
          $mybarcode = '';
          $grandtotal = 0;
          $surcharge =  0;//myrowval('catalog_product_rate_list', 'surcharge', 'stateid='.$_SESSION[SESS.'data']['state_id']);
         // h1(count($value['challan_item']));
    foreach($value['challan_item'] as $key1=>$value1)
    {
      // pre($value1);
      if(!empty($value1['lineno'])) 
      {
        $mybarcode .= "\t".$value1['lineno']."\t".$value1['qty'];
      }
         
        $item['hsn_code'] = $value1['hsn_code'];
        $item['taxable_amt'] = ($value1['product_rate']*$value1['qty'])-($value1['dis_amt']+$value1['cd_amt']);
        $item['tax'] = ($value1['tax']/2);
        $item['tax_amt'] = my2digit($value1['vat_amt']/2);
    ...
    ?>
    <tr>
      <td class="tdclass2"> <?php echo $i;?></td>
      <!--<td class="tdclass2"> <?php echo $value1['comunity_code'];?></td>-->
      <td class="tdclass1"> <?php echo $value1['name'];?></td>
      <td class="tdclass1"> <?php echo $value1['hsn_code'];?></td>
      <td class="tdclass2" align="right"> <?php echo $value1['qty'];?></td>
      <!--<td class="tdclass2" align="right"> <?php echo $value1['free_qty'];?></td>-->
      <td class="tdclass2" align="right"><?php echo my2digit($value1['mrp']);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($value1['product_rate']);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($value1['dis_percent']);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($value1['dis_amt']);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($value1['cd']);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($value1['cd_amt']);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($amt);?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($value1['tax']).'%';?></td>        
      <?php  if($dealer_state_id == $retailer_state_id){  ?>
      <td class="tdclass2" align="right"> <?php echo ($value1['tax']/2).'%' ;?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($vat_amt/2) ;?></td>          
      <td class="tdclass2" align="right"> <?php echo ($value1['tax']/2).'%' ;?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($vat_amt/2) ;?></td>
      <?php }else{ ?>
      <td class="tdclass2" align="right"> <?php echo ($value1['tax']) ;?></td>
      <td class="tdclass2" align="right"> <?php echo my2digit($vat_amt) ;?></td>
      <?php } ?>
<!--        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge);?></td>
  <td class="tdclass2" align="right"> <?php echo my2digit($surcharge);?></td>-->
  <?php             

  $net_amt = $value1['taxable_amt'];
  ?>
  <td style="border-bottom:none;border-top:none;" align="right"> <?php echo " ".my2digit($net_amt) ;?></td>
    ...
    <?php
       ...
       if($dealer_state_id == $retailer_state_id){ $col = '2'; $col1 = '2'; $col2 = '15'; $col3 = '2'; }else{
      ...
      <tr style="font-size:11pt;">
        ...
        <td colspan="<?php echo $col; ?>" align="right"><strong><?php echo my2digit($ttl_vat_amt/2); ?><!--106425.00--></strong></td>
        <td colspan="<?php echo $col1; ?>" align="right"><strong><?php echo my2digit($ttl_vat_amt/2); ?><!--106425.00--></strong></td>
        
        

        <!--        <td colspan="1" align="right"><strong><?php echo my2digit($ttl_surcharge_amt); ?>106425.00</strong></td>-->
        <td colspan="1" align="right"><strong><?php echo my2digit($grandtotal); ?><!--106425.00--></strong></td>
      </tr> 
         ...
         <table width="100%" border="0">
           ...
           if(count($invoice_summary))
           {
            ...
            { 
              ...
              <?php } ?>
              <tr><td colspan="12" style="border-top: 1px solid;"></td></tr>
              <?php }  ?>
          ...
          <tr>                       
           ...
           <td colspan="2" align="center"><?php echo my2digit($total_tax_amt); ?></td> 
           <?php  if($dealer_state_id == $retailer_state_id){ ?>
           <td colspan="2" align="center"><?php echo $gstper; ?></td>
           <td colspan="2" align="center"><?php echo my2digit($total_tax_amt); ?></td> 
           <?php } ?>
...
elseif ($value1['cd_type']==2) {
 $cd1 = ($value1['cd']);        
    ...
    ?>
       <tr>
        <td class="tdclass2"><?php echo $i1;?></td>
        <!--<td class="tdclass2"> <?php echo $value1['comunity_code'];?></td>-->
        <td class="tdclass1"><?php echo $value1['name'];?></td>
         <td class="tdclass1"><?php echo $value1['hsn_code'];?></td>
        <td class="tdclass2" align="right"><?php echo $value1['qty'];?></td>
<!--        <td class="tdclass2" align="right"> <?php echo $value1['free_qty'];?></td>-->
        ...
        <td class="tdclass2" align="right"><?php echo my2digit($value1['cd']);?></td>
        <td class="tdclass2" align="right"><?php echo my2digit($value1['cd_amt']);?></td>
        <td class="tdclass2" align="right"><?php echo my2digit($amt1);?></td>
        <td class="tdclass2" align="right"><?php echo my2digit($value1['tax']).'';?></td>
        <?php  if($dealer_state_id == $retailer_state_id){ ?>
        <td class="tdclass2" align="right"><?php echo ($value1['tax']/2) ;?></td>
        <td class="tdclass2" align="right"><?php echo my2digit($vat_amt/2) ;?></td>
       ...
       <?php }else{ ?>
        ...
        <td class="tdclass2" align="right"><?php echo my2digit($vat_amt) ;?></td>
        <?php } ?>
<!--        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge1);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge_amt1);?></td>-->
  <?php  
...
elseif ($value1['cd_type']==2) {
 $cd2 = ($value1['cd']);        
    ...
    ?>
       <tr>
        <td class="tdclass2"> <?php echo $i2;?></td>
        <!--<td class="tdclass2"> <?php echo $value1['comunity_code'];?></td>-->
        <td class="tdclass1"> <?php echo $value1['name'];?></td>
         <td class="tdclass1"> <?php echo $value1['hsn_code'];?></td>
        <td class="tdclass2" align="right"> <?php echo $value1['qty'];?></td>
<!--        <td class="tdclass2" align="right"> <?php echo $value1['free_qty'];?></td>-->
        ...
        <td class="tdclass2" align="right"> <?php echo my2digit($value1['cd']);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($value1['cd_amt']);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($amt2);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($value1['tax']).'';?></td>
       <?php  if($dealer_state_id == $retailer_state_id){ ?>
        <td class="tdclass2" align="right"> <?php echo ($value1['tax']/2) ;?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($vat_amt/2) ;?></td>
        ...
        <?php } ?>
<!--        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge_amt);?></td>-->
  <?php  
...
<!--        <td align="right"><strong>Authorised Signatory</strong> </td>-->
    ...
    ?>
       <tr>
        <td class="tdclass2"> <?php echo $i3;?></td>
        <!--<td class="tdclass2"> <?php echo $value1['comunity_code'];?></td>-->
        <td class="tdclass1"> <?php echo $value1['name'];?></td>
         <td class="tdclass1"> <?php echo $value1['hsn_code'];?></td>
        <td class="tdclass2" align="right"> <?php echo $value1['qty'];?></td>
<!--        <td class="tdclass2" align="right"> <?php echo $value1['free_qty'];?></td>-->
        ...
        <td class="tdclass2" align="right"> <?php echo my2digit($value1['cd']);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($value1['cd_amt']);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($amt3);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($value1['tax']).'';?></td>
      <?php  if($dealer_state_id == $retailer_state_id){ ?>
        <td class="tdclass2" align="right"> <?php echo ($value1['tax']/2) ;?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($vat_amt/2) ;?></td>
        ...
        <td class="tdclass2" align="right"> <?php echo my2digit($vat_amt/2) ;?></td>
        <?php } ?>
<!--        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge3);?></td>
        <td class="tdclass2" align="right"> <?php echo my2digit($surcharge_amt3);?></td>-->
  <?php  
