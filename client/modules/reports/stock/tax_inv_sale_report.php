...
//                             $printlink = '<span class="seperator"></span> <a class="iframef" target="_blank" title="Edit Invoice ' . $uidname . '" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid . '&actiontype=print"><img src="./images/b_edit.png"></a>';
                            ...
                            ?>
                                ...
                                <td><?=date('d-m-Y',strtotime($rows['ch_date']))?></td>
                                <td><?=$rows['retailer_name']?></td>
                                <td style="text-transform: uppercase"><?=$rows['tin_no']?></td>
                                <?php $taxamount = 0.00;
                $total = 0;
                $amt='';
                ...
                foreach ($rows['challan_item'] as $inkey => $invalue) {
                 ...
                 $amt = $invalue['amt']; 
                   $vat_amt = $invalue['vat_amt']; 
                    ...
                    ?>
                                <td><?=my2digit($invalue['tax']/2)?></td>
                                <td><?=my2digit($vat_amt/2)?></td>
                                <td><?=my2digit($invalue['tax']/2)?></td>
                                <td><?=my2digit($vat_amt/2)?></td>       
                                <?php 
                                //$amt='';
                              ...
                              <td><?=0.00?></td>
                                ...
                                <td><?=0.00?></td>
                <?php } ?>
                               <td style="text-align:right"><img src="../icon-system/i16X16/rupee.png"><?=round($amt)?></td> 
        ...
        <td style="text-align:right"><img src="../icon-system/i16X16/rupee.png"><strong><?=round($grtotal)?></strong></td>
        <td></td>
                                </tr>                        
                    </table>
                </div>
