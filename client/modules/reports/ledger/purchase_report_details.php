...
$cls_func_str = 'purchase_order_details'; //The name of the function in the class that will do the job
$myorderby = 'created_date DESC'; // The orderby clause for fetching of the data
                ...
                <div>
                   ...
                   <tr>
                        ...
                        <th style="background-color:#C7CDC8; color:#000;" >Date</th>
                          <th style="background-color:#C7CDC8; color:#000;" >Order Id</th>
                        <th style="background-color:#C7CDC8; color:#000;" >Purchase Invoice No</th>
                        <th style="background-color:#C7CDC8; color:#000;" >CSA Name/SS Name</th>
                        <th style="background-color:#307ECC; width: 120px;color:#fff;">Product Name</th>
                        <th style="background-color:#307ECC; width: 120px;color:#fff;">Item Code</th>
...
$printlink = '<a class="iframef" title="print Invoice ' . $uidname . '" href="index.php?option=' . $formaction . '&showmode=1&mode=1&id=' . $uid . '&actiontype=print"><img src="../icon-system/i16X16/print.png"></a>'; //$rows['postat'] == 1 ? '<span class="seperator">|</span> <a class="iframef" title="print PO '.$uidname.'" href="index.php?option='.$formaction.'&showmode=1&mode=1&id='.$uid.'&actiontype=print"><img src="../icon-system/i16X16/print.png"></a>' : '';
                      ...
                      <tr  BGCOLOR="'.$bg.'" id="tr'.$uid.'" class="ihighlight">
                        <td>'.$inc.'</td>
                          <td >'.$rows['sale_date'].'</td>
                           <td>'.$rows['order_id'].'</td>
                          <td>'.$rows['purchase_inv'].'</td>
                          <td>'.$rows['csa_name'].'</td>
                          <td>'.$rows['product_name'].' '.$rows['batch_no'].'</td>
                          <td>'.$rows['item_code'].'</td>
                          <td>'.$rows['rate'].'</td>
                          <td>'.$rows['quantity'].'</td> 
                          <td>'.$rows['scheme_qty'].'</td>
                          <td>'.my2digit($total_sale_value).'</td></tr>'   ;
                    ...
                    //  {
                      ...
                      //  foreach($rows['order_item'] as $inkey=>$invalue){
                         //   pre($rows['order_item']);
                            ...
                            $total_sale_value=$rows['total_amount'];
                  ...
                  <tr>
                 <td colspan="10">Total Sale value:&nbsp;&nbsp;<strong style="color:green;"></td><td> <?php echo my2digit(array_sum($grand_total_value)) ;?></strong></td> 
                 </td>
               </tr>
                    </table>
                </div>
