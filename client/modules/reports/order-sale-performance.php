        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div id="divToPrint">
                    ...
                    ?>
                    <h3><strong>MKT Catg Wise Sale VS Order Report-<?=$dname?> From <?=$start1?> To <?=$end1?></strong></h3>
                        <thead>
                      ...
                      ?>  
                            ...
                            <tr>
                                <th>Order</th>
                                 ...
                                 $total_purchase=0; 
                                 $asvpctr=$myobj->get_order_stock_ctr('2',$start,$end); 
                                ?>
                                 <td style="text-align: right;"><?=$asvpctr?></td>
                                 <?php $asvpurchase=$myobj->get_order_stock('2',$start,$end); 
                                  $total_purchase_baid=$total_purchase_baid+$asvpurchase;
                                ?>
                                 <td style="text-align: right;"><?=my2digit($asvpurchase)?></td>
                    <?php 
                    foreach ($myresult as $key => $rows) { 
                      $purchase=$myobj->get_order_stock($rows['pid'],$start,$end);
                      ...
                      ?>  
                                ...
                                <?php $obpurchase=$myobj->get_order_stock('8',$start,$end); 
