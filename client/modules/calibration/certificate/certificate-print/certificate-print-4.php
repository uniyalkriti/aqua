...
//loading the special content
$spcontent = $myobj->calibration_result_html($_GET['id'], $_POST['rifId']);
$certstat = array('companyname'=>$companystat['cmp_name'],
				  ...
				  'equipment_master'=>'',
				  'calibration_result'=>$spcontent[1],
				  'page_detail'=>$spcontent[0],
...
<div id="certificate_container" style="padding:10px; font-size:14px; font-family:'Times New Roman', Times, serif;">
  ...
  <div id="certificate_detail">
    <table width="100%" class="certificate_detail" cellpadding="0" cellspacing="0">
      <tr class="row1">
        <td width="30%" align="left"><?php echo $certstat['page_detail']; ?></td>
        <td width="35%">&nbsp;</td>
  ...
  <div id="calib_result">
    <div class="mytitle" style="font-size:14px; margin-bottom:5px; text-align:left; font-weight:bold; margin-top:10px;"><?php echo $certstat['calibration_result']; ?></div>
    <?php //echo $myobj->calibration_result_html($_GET['id'], $_POST['rifId']);?>
    <div style="margin-top:10px;">UNCERTAINITY AT <?php echo $certstat['uncertainity']; ?> % CONFIDENCE LEVEL FOR A COVERAGE FACTOR k=2</div>
  </div>
