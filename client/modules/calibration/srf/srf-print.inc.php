...
<div id="certificate_container" style="padding:2px; font-size:14px; font-family:'Times New Roman', Times, serif; page-break-after:always;">
  <div class="mytitle" style="font-size:24px; margin-bottom:5px; text-align:center; margin-top:5px;"><strong style="text-decoration:underline">CALIBRATION ORDER</strong></div>				  
  ...
  <div id="calib_result">
    ...
    <?php include('data/srf-items.inc.php');?>    
  </div>
    ...
    <table width="100%" class="footremark">
      <tr class="rowgen">
        <td colspan="2" align="left" style="padding-top:10px;">
          <!-- table to adjust the remark starts here -->
          <table width="100%">
            <tr>	
              <td style="width:15%"><strong>Remarks :</strong></td>
        	  <td class="col2" style="border-bottom:1px solid #000;"><?php echo $value['remark']; ?></td>
            </tr>
          </table>
          <!-- table to adjust the remark ends here -->
        </td>      
      </tr>
    </table>
  </div>
