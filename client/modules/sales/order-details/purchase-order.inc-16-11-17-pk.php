...
<!--                 <td> &nbsp;Mfg Date.<br><span class="example">(dd/mm/yyyy)</span></td>
          ...
          <?php if(!isset($heid)){ ?>
               ...
               // pre($_SESSION);
                ...
                $count1 = 0;
                 $query = "SELECT focus.product_id,name,cprl.dealer_rate as rate FROM `focus` 
               ...
               //     pre($row);
                   ...
                   // $getstock = $reobj->get_available_stock($product_id1,$dealer_id);
                    $where = "dealer_id=$dealer_id AND product_id=$product_id1";
...
<!--                  <td>
          ...
          //        print_r($invalue);
               ...
               <td>
                     <input type="text" style="width:120px" id="quantity" placeholder="Quantity" name="quantity[]" onblur="qty_scheme_calculate();" placeholder="In Pieces"  value="<?php echo $invalue['cases']; ?>"  />
                 </td>
