...
//print_r($_SESSION);
$forma = 'Intransit Report'; // to indicate what type of form this is
$formaction = $p;
...
if(isset($_POST['filter']) && $_POST['filter'] == 'Filter')
{
  if(valid_token($_POST['hf'])) // checking if post value is same as timestamp stored in session during form load
  {
    ...
    if($checkpass)
    {
      ...
      //$filter[] = "challan_no = ''";
      $filter[] = "DATE_FORMAT(`receive_date`,'%Y-%m-%d') = '0000-00-00'";
      $filterused = implode($filterstr, '<span style="margin: 0 10px;">|</span>');      
        $rs = $myobj->$funcname($filter,  $records = '', $orderby ="ORDER BY $myorderby"); //get_purchase_order_listSorry
        if(empty($rs))
  ...
  <?php 
   ...
   ?>
                ...
                <!--                 <td>
                 ...
                 <td>
                     <input type="text" style="width:120px" onkeypress="javascript:return isNumber(event)" placeholder="Quantity" name="quantity[]" lang="quantity" placeholder="In Pieces"  value=""  />
                 </td>
<td>  </td>
                  <td>
...
<!--                  <td>
 ...
 <?php 
                ...
                <!--                 <td>
                 ...
                 <td>
                     <input type="text" style="width:120px" id="quantity" placeholder="Quantity" name="quantity[]" lang="quantity" onblur="qty_scheme_calculate();" placeholder="In Pieces"  value=""  />
                 </td>
                 
                   <td>
                     <input type="hidden" style="width:120px" id="scheme_quantity" placeholder="scheme quantity" name="scheme_quantity[]" lang="scheme_quantity" placeholder="In Scheme Pieces"  value=""  />
                 </td>
...
<!--                  <td>
          ...
          //        print_r($invalue);
               ...
               <td>
                 ...
                 <input type="text" style="width:100px" name="cases[]"  value="<?php echo $invalue['cases']; ?>"  />
                  ...
                  <td>
                     <input type="hidden" style="width:100px" name="purchase_inv[]" lang="purchase_inv"  value="<?php echo $invalue['batch_no']; ?>"  />
                 </td>
         ...
         <tr>
            ...
            <input  style="background-color: #307ECC" id="mysave" type="submit" name="submit" value="<?php if(isset($heid)) echo'Update'; else echo'Save';?>" />
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="table-header">
                 Intransit Report<div class="pull-right tableTools-container"></div> 
...
?>
    ...
    color:#000;
                     ...
                     <tr class="search1tr">
                        <th style="width: 120px; color:#fff;">Product Name</th>
                        <th style="width: 120px; color:#fff;">Rate</th>
                        <th style="width: 120px; color:#fff;">Quantity</th>
                        <th style="width: 120px; color:#fff;">Batch No</th>
                        <th style="width: 120px; color:#fff;">Total Purchase Value</th>
                   ...
                   //pre($rows['order_item']);   
                    ...
                    echo'
                        <tr bgcolor="#307ECC">
                          ...
                          <td style="border:none;width:120px;">-</td>
                          <td style="border:none;width:120px;">-</td>
                          <td style="border:none;width:120px;color:#fff;"><b>'.my2digit(array_sum($total_sales_value_array)).'</b></td>
                        </tr>';
...
function qtyscheme($qty,$product){
        $query = "select `scheme_quantity` from `scheme_product_details` where `buy_quantity`='$qty' AND product_id='$product'";                                
        $q = mysqli_query($dbc,$query);
        $row = mysqli_fetch_assoc($q); 
        $scheme = $row['scheme_quantity'];
...
<script>   
           function qty_scheme_calculate()
			...
			var d = qty_val.length-1;                       
                             var qtysch= "<?php qtyscheme(qty_val,product)?>";
                       // alert(qtysch);
				if(qty_val>=qtysch){                                    
