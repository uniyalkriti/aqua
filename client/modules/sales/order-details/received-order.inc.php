...
if(isset($_POST['filter']) && $_POST['filter'] == 'Filter')
{
  if(valid_token($_POST['hf'])) // checking if post value is same as timestamp stored in session during form load
  {
    ...
    if($checkpass)
    {
      ...
      $filter[] = "receive_date='0000-00-00 00:00:00'";                  
...
// to show the form when and only when needed?>
 <form method="post" action="<?php if(isset($eformaction)) echo  $eformaction; ?>"  name="genform" onsubmit="return checkForm_alert('genform');">
      <fieldset>
        ...
        <!-- below two hidden fields add because purchase order $_POST['submit'] == 'Update' is not satisfy -->
...
//                   }
   ...
   <input type="hidden" name="company_id" value="1" id="state_id">
         ...
         <td><span class="star">*</span><strong>Challan date</strong><br>
               ...
               <td><span class="star">*</span><strong>Order Number</strong><br>
                   
                      <input style="width:200px;height:25px;" type="text" style="width:100px" name="order_id"  value="<?php if(isset($_POST['order_id'])) echo $_POST['order_id'];  ?>" required="required" />
                 </td>
...
<!--                 <td> &nbsp;Expire Date<br><span class="example">(dd/mm/yyyy)</span></td>-->
 ...
 <?php 
                ...
                <!--                 <td>
                  ...
                  <td>
                      <input type="text"  class="nkget_dealer_mrp_rate" placeholder="MRP" name="base_price[]"  value=""  />
                 </td>
                 <td>
                      <!--<input type="text" class="nkset_dealer_rate" style="width:100px" placeholder="Landing Price" name="dealer_rate[]"  value="" readonly/>-->
                  <input type="text"  placeholder="Rate per unit" name="dealer_rate[]" onkeypress="javascript:return isNumber(event)" value="" readonly/>
  ...
  <td>
                     <input type="text"  id="quantity" placeholder="Quantity" name="quantity[]" lang="quantity"  onblur="qty_scheme_calculate();" placeholder="In Cases"  value=""  />
                 </td>
                  ...
                  <td>
                 <input  type="hidden" name="cases[]" onkeypress="javascript:return isNumber(event)" value=""  />
                 </td>
                  <td>
                 <input type="text"  placeholder="Batch Number" name="purchase_inv[]"  value="0"  />
                 </td>
<!--                  <td>
...
<!--  <td>
                 ...
                 <td>
                  ...
                  <td>
                     <input class="wid" type="text"  placeholder="ATD Amt." name="atd_amt[]"   value="<?php echo $invalue['atd_amt']; ?>"  />
                 </td>
                  <td>
                 ...
                 <td>
                     <input class="wid" type="text"  placeholder="IGST Amt." name="igst_amount[]"   value="<?php echo $invalue['igst_amount']; ?>"  />
                 </td>
                  <td>
                     <input class="wid" type="text"  placeholder="Total Amt." name="total_amount[]"   value="<?php echo $invalue['total_amount']; ?>"  />
                 </td>
                  <td>
                     <input class="wid" type="text"  placeholder="Batch Number" name="batch_no[]"  value="<?php echo $invalue['batch_no']; ?>"  />
                     <input  type="hidden"  placeholder="Batch Number" name="hbatch_no[]"  value="<?php echo $invalue['batch_no']; ?>"  />
                 </td>
                  
                  <td>
                      <input class="wid" type="text" class="datepicker"  name="mfg_date[]"  value="<?php echo $invalue['mfg_date']; ?>"  />
                      <input  type="hidden" class="datepicker"  name="hmfg_date[]"  value="<?php echo $invalue['mfg_date']; ?>"  />
                 </td>
<!--                  <td>
