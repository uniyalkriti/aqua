...
<div id="certificate_container" style="padding:0px; font-size:62.5%; font-family:'Times New Roman', Times, serif; page-break-after:auto; margin:0 auto; width:595pt;">
  ...
  <div id="pritn_what">
    <div class="mytitle" style="font-size:14pt;text-align:center; font-weight:bold; margin-top:0;">
      <span style="text-decoration:underlinel;">PURCHASE ORDER</span><br />
  ...
  <div id="certificate_header">
    <table width="100%" class="header_table" style="margin-top:0pt; border:1pt solid #000; border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="1">
      <tr>
        <td valign="top" colspan="3" style="width:50%;">
          ...
          <table border="0" style="font-family:kitfont; font-size:8pt;">
            ...
            <tr>
              <td colspan="8"><strong>Order No.: </strong><?php echo $value['order_id']; ?> <br><strong>Order Date : </strong><?php echo $value['order_date']; ?> </td>
              <td></td>
            </tr>
        ...
        <td valign="top" colspan="3">
	      ...
	      <td align="right"><strong>Authorised Signatory</strong> </td>
              ...
              <tr>
                <td colspan="2"> <br><strong>Receiving Date : </strong><?php echo $value['ch_date']; ?>
                </td>
             </tr>
             <tr>
                 <td colspan="2"><strong>Challan No.-:</strong> <?php  echo $value['challan_no']; ?></td>	
            </tr>
          </table>
      ...
      <tr style="font-weight:bold;">
        ...
        <td style="width:20%" align="center">Quantity (In Case)</td>
        <td style="width:20%"align="center">Qty (In Piece)</td>
        <td style="width:10%"align="center">M.R.P</td>
        <td style="width:15%" align="center">Total Amt.</td>
      </tr>
      <?php 
	  $inc =1; 
          $i=1;
          ...
          if($inc>10){
              ...
              echo '</table><div style="page-break-after:always;page-break-inside:avoid;width: 90%;">
                    ...
                    <tr style="font-weight:bold;">
                         <td style="width:3%">S No.</td>
        <td style="width:30%">Item Name</td>
        <td style="width:20%" align="right">Challan No.</td>
        <td style="width:20%">Qty</td>
        <td style="width:10%">M.R.P</td>
   ...
   ?>
      ...
      <tr style="font-size:11pt;">
        ...
        <td colspan="1" align="center"><strong><?php echo my2digit($qty1); ?><!--106425.00--></strong></td>
        <td colspan="1" align="center"><strong><?php echo my2digit($rate1); ?><!--106425.00--></strong></td>
        <td colspan="1" align="center"><strong><?php echo my2digit($total_amt); ?><!--106425.00--></strong></td>
         </tr> 
      <tr style="font-size:11pt;">
