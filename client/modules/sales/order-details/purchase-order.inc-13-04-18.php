...
<!--                 <td>
        ...
        db_pulldown($dbc, 'comp_id', $q, TRUE, TRUE,'style="width:200px;height:25px;"','','');
        ?>
                  </td>
<div class="col-xs-2">
...
<!--                 <td> &nbsp;Expire Date<br><span class="example">(dd/mm/yyyy)</span></td>-->
 ...
 <?php 
                db_pulldown($dbc , 'product_id[]', "SELECT catalog_product.id,catalog_product.name FROM catalog_product INNER JOIN catalog_3 ON catalog_product.catalog_id = catalog_3.id WHERE catalog_product.company_id = 1 order by name",TRUE,TRUE,' id="product_id" class="nkget_dealer_rate"');
                      ?>
                
                 </td>
                 <td>
 <input type="text" style="width:40px"  class="nkget_dealer_mrp_rate" placeholder="MRP" name="base_price[]"  value=""  />
                 </td> 
                 
                 <td>
    <input type="text" class="nkset_dealer_rate" style="width:100px" placeholder="Landing Price" name="dealer_rate[]"  value="" readonly/>
      <!-- <input type="text" style="width:40px"   class="nkget_dealer_mrp_rate" placeholder="Rate per unit" 
      name="dealer_rate[]" onkeypress="javascript:return isNumber(event)" value="" readonly/> -->
                 </td>
                 
                 <!-- <td>
 <input type="text" style="width:40px"  placeholder="Billed QTY" name="quantity[]"  value=""  />
                 </td> -->
                <td>
                     <input type="text" style="width:40px" placeholder="Quantity" name="quantity[]" lang="quantity" placeholder="In Pieces"  value=""  />
                 </td>
                 <td>
      <input type="text" style="width:40px"  id="quantity" placeholder="freeq quantity" name="scheme_quantity[]" lang="quantity"  onblur="qty_scheme_calculate();" placeholder="In Cases"  value=""  />
                 </td>
  <td>
      <input type="text" style="width:40px"  id="quantity" placeholder="Gross amt" name="gross_Amt[]" lang="quantity"  onblur="qty_scheme_calculate();" placeholder="In Cases"  value=""  />
                 </td>
                 <td>
 <input type="text" style="width:40px"  placeholder="Base MRP" name="trade_price[]"  value=""  />
                 </td>
                 <td>
                 <input type="text" style="width:40px"  placeholder="Cash Amt" name="cash_amt[]"  value="0"  />
                 </td> 
                 <td>
                 <input type="text" style="width:40px"  placeholder="scheme" name="scheme_amt[]"  value="0"  />
                 </td>  
                   
        <?php /*
 <td><input type="text" style="width:120px" id="scheme_quantity" placeholder="scheme quantity" name="scheme_quantity[]" placeholder="In Scheme Pieces"  value=""  /></td> */?>
                 
                  <!-- <td>
                 <input  type="hidden"  style="width:40px" name="cases[]" onkeypress="javascript:return isNumber(event)" value=""  />
                 </td> -->
                  <td>
                 <input type="text" style="width:40px"  placeholder="spl_amt" name="spl_amt[]"  value="0"  />
                 </td>
                 <td>
                 <input type="text" style="width:40px"  placeholder="atd_amt" name="atd_amt[]"  value="0"  />
                 </td>
                 <td>
                 <input type="text" style="width:40px"  placeholder="cgst_amt" name="cgst_amount[]"  value="0"  />
                 </td>
                 <td>
                 <input type="text" style="width:40px" placeholder="SCgst" name="sgst_amount[]"  value="0"  />
                 </td>       
                 <td>
                 <input type="text" style="width:40px" placeholder="Total Amt" name="total_amt[]"  value="0"  />
          </td>
         
          <td>
                     <input type="text" style="width:40px" name="batch_no[]"  value=""  />
                 </td>
