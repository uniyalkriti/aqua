...
<!--                <td><strong>User</strong><br>
          ...
          <tr>
           <td colspan="5"><div style="background-color: #CDEAF3;font-size: 150%;font-family: Arial, Georgia, Serif;">Order Detail</div></td>
         </tr>
         <tr>
           <td colspan="4">
...
<script type="text/javascript">
  ...
  ?> 
  <script>
    function tableExcel(table, name)
    {
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="table-header">
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;  
           <!--<input style="background-color:#09F;" type="button" onclick="tableExcel('searchdata', 'W3C Example Table')" value="Export to Excel">-->
          ...
          <table id="dynamic-table" class="table table-striped table-bordered table-hover">
            <thead>
             <tr>
              ...
              <th style="background-color:#C7CDC8; color:#000;" align="center" colspan="6">Order Details</th>
            ...
            <tr class="search1tr">
             <th style="width: 120px; color:#fff;" colspan="1">Product Name</th>
             <th style="width: 120px; color:#fff;">Rate</th>
             <th style="width: 120px; color:#fff;">Quantity</th>
             <!--<th style="width: 120px; color:#fff;">Scheme Qty</th>-->
             <th style="width: 120px; color:#fff;">Purchase_Inv.</th>
...
//      $editlink ='<a data-toggle="modal" href="#myModal" id"'.$rows['id'].'" ><img src="./images/b_edit.png"></a>&nbsp;&nbsp;';         
                 ...
                 //  pre($rows['order_item']);   
                      ...
                      if(!empty($rows['order_item']))
                      {
                        ...
                        foreach($rows['order_item'] as $inkey=>$invalue){
                         //   pre($rows['order_item']);
                          ...
                          <td style="border:none;width:120px;">'.round($total_sale_value).'</td>
                      ...
                      <td style="border:none;width:120px;">-</td>
                      <td style="border:none;width:120px;">-</td>
                      <td style="border:none;width:120px;color:#fff"><strong>'.my2digit(array_sum($total_sales_value_array)).'</strong></td>
                      </tr>';
                      ...
                      ';
                      $inc++;
                  }// foreach loop ends here  <td style=" display: table-cell; vertical-align: top;" class="options">'.$editlink.$deletelink.'</td>
