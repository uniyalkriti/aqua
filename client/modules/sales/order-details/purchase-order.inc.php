...
//                        }
                        ...
                        // $filterstr[] = "dealer_id = '{$_SESSION[SESS.'data']['dealer_id']}'";
  ...
  $rs = $myobj->$funcname($filter="$myfilter'$ajaxshowid'",  $records = '', $orderby='');
           ...
           // $user_data_str = implode(',' , $user_data);
            ...
            //  $filter[] = "DATE_FORMAT(`order_date`,'".MYSQL_DATE_SEARCH."') >= '$date'";
...
<div id="workarea" style="overflow: hidden;overflow-x: scroll;overflow-y: auto; height: 500px;">
    <?php
...
//                   }
              ...
              <style type="text/css">
                .header_strip{width:100px;}
              </style>
               <td style="width:1px;">
                 <input type="hidden" name="company_id" value="1" id="state_id">

               </td>
                 <td class="header_strip"><strong>Company Name</strong><br>
                   <?php                  
                     $bq = "SELECT id,cp_name,cp_short_name FROM other_company WHERE dealer_id=$dealer_id";

                     $bd = mysqli_query($dbc,$bq);
                     $opt = "<select name='comp_id' id='brand_id' class='chosen-select' required>";
                     $opt .= "<option value=''>==Select Brand==</option>";
                     while ($b_row = mysqli_fetch_assoc($bd)) {
                       $opt .= "<option value='".$b_row['id']."' sht-name='".$b_row['cp_short_name']."'>".$b_row['cp_name']."</option>";
                     }
                   echo $opt .= "</select>"; ?>

                 </td>
              <td class="header_strip"> <strong>Firm name<span class="star">*</span></strong> <br/>
                <input style="height:25px;" type="text" id="firm_name" name="firm_name"  value=""  required="required"  class="" />
              </td>
              <td class="header_strip"> <strong>Order Date</strong> <br/>
              ...
              <td class="header_strip"><span class="star">*</span><strong>Order Number</strong><br>

                <input style="width:200px;height:25px;text-transform: uppercase;font-size:14px;" type="text" style="width:100px" name="order_no"  value="<?php if(isset($_POST['order_no'])) echo $_POST['order_no'];  ?>" required="required" />
              </td>
              <td class="header_strip"><span class="star">*</span><strong>Challan date</strong><br>

                <input style="width:200px;height:25px;" type="text" class="datepicker"  name="ch_date"  value="<?php echo date("d/m/Y"); ?> " required="required" />
              </td>
              <td class="header_strip"><span class="star">*</span><strong>Challan Number</strong><br>
                   ...
                   <table width="100%" id="mytable_purchase">
                     ...
                     <tr class="tdata">
                       ...
                       <td>
                         ...
                         <?php
                         db_pulldown($dbc , 'product_id[]', "SELECT catalog_product.id,CONCAT(catalog_product.itemcode,' - ',catalog_product.name) FROM catalog_product INNER JOIN catalog_2 ON catalog_product.catalog_id = catalog_2.id  where catalog_product.company_id = $company_id_cus group by itemcode order by catalog_product.name",TRUE,TRUE,' id="product_id" class="nkget_dealer_rate chosen-select" style="width:290px;"');
                         ?>

                       </td>
                       <td>
                         <input type="text" style="width:60px" class="nkget_dealer_mrp_rate mrp" name="base_price[]" value=""/>
                       </td> 

                       <td>
                        <input type="text" class="nkset_dealer_rate" style="width:60px;" name="dealer_rate[]" value=""/>
                      </td>                
                      <td>
                       <input type="text" style="width:60px;" name="quantity[]" lang="quantity" value="" class="quantitycl calcpk"  />
                      </td>
                      <td>
                        <input type="text" style="width:60px;" class="free_qty calcpk" name="scheme_quantity[]"  value=""  />
                      </td>
                      <td>
                        <input type="text" style="width:60px;" class="grs_amt" name="gross_Amt[]" lang="quantity"  readonly="" />
                      </td>
                      <td>
                       <input type="text" style="width:60px;" name="trade_price[]" class="trd_amt calcpk" value="0"/>
                      </td>
                      <td>
                       <input type="text" style="width:60px;" name="cash_amt[]" class="cash_amt calcpk" value="0" />
                      </td> 
                      <td>
                       <input type="text" style="width:60px;" class="sch_amt calcpk" name="scheme_amt[]" value="0"  />
                      </td>
                       <td>
                         <input type="text" style="width:60px;" class="spl_amt calcpk" name="spl_amt[]" value="0"/>
                       </td>
                       <td>
                         <input type="text" style="width:60px;" class="atd_amt calcpk" name="atd_amt[]" value="0" readonly="" />
                       </td>
                    <!--    <td>
                         <input type="text" style="width:80px" class="cgst_amt" readonly="" name="cgst_amount[]" value="0"  class="cgst"/>
                       </td>
                       <td>
                         <input type="text" style="width:80px" class="sgst_amt" readonly="" name="sgst_amount[]" value="0"  class="sgst"/>
                       </td>        -->

                         <td>
                         <input type="text" style="width:60px;" class="cgst_amt calcpk" name="cgst_amount[]" value="0"  class="cgst"/>
                       </td>
                       <td>
                         <input type="text" style="width:60px;" class="sgst_amt calcpk" name="sgst_amount[]" value="0"  class="sgst"/>
                       </td>       


                       <td>
                         <input type="text" style="width:60px;" class="amount" readonly="" name="total_amt[]" value="0"/>
                       </td>

                       <td>
                         <input type="text" style="width:60px;" class="batch_no" name="batch_no[]" lang="batch_no" value=""/>
                       </td>

                       <td>
                        <input type="text" style="width:60px;" class="datepicker mfg_date" name="mfg_date[]"  value="<?php echo date('d/m/Y') ?>"  />
                      </td>
           ...
           <hr>
           <tfoot style="padding-top: 20px !important;">
            
                <tr>
                    <td colspan="" style="border-bottom:1px solid #efefef; "></td>
                    <td colspan="" style="border-bottom:1px solid #efefef; "></td>
                    <td colspan="" style="border-bottom:1px solid #efefef; "></td>
                    <td colspan="" style="border-bottom:1px solid #efefef; "></td>
                    ...
                    <strong>
                        <input type="text"  style="width:60px;" name="cus_qty" class="cus_qty" id="cus_qty" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_free_qty" class="cus_free_qty" id="cus_free_qty" >
                    </strong>
                    </td>
                    <td colspan="" style="border-bottom:1px solid #efefef; "></td>
                    <td>
                    ...
                    <strong>
                        <input type="text"  style="width:60px;" name="cus_trade_amt" class="cus_trade_amt" id="cus_trade_amt" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_cash_amt" class="cus_cash_amt" id="cus_cash_amt" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_sch_amt" class="cus_sch_amt" id="cus_sch_amt" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_spl_amt" class="cus_spl_amt" id="cus_spl_amt" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_atd_amt" class="cus_atd_amt" id="cus_atd_amt" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_cgst" class="cus_cgst" id="cus_cgst" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_sgst" class="cus_sgst" id="cus_sgst" >
                    </strong>
                    </td>
                    <td>

                    <strong>
                        <input type="text"  style="width:60px;" name="cus_t_amt" class="cus_t_amt" id="cus_t_amt" >
                    </strong>
                    </td>
...
<!--               <legend class="legend">Search <?php echo $forma;?></legend>-->
             ...
             <table>
               ...
               <?php 
                  if($dealer_id == '1170' || $dealer_id == '1169'){ ?>
                    <input class="btn btn-success"  onclick="$.colorbox({href:'index.php?option=<?php echo $formaction; ?>&showmode=1', iframe:true, width:'95%', height:'95%'});" type="button" value="New" title="add new <?php echo $formaction; ?>" /><?php
                  }
               ?>
            ...
            <div class="col-xs-12">
                ...
                <div>
                   ...
                   <tr>
                      ...
                      <th style="background-color:#C7CDC8; color:#000;" rowspan="2">Order Date</th>
                      <th style="background-color:#C7CDC8; color:#000;" rowspan="2">Bill Date</th>
...
<!--                      <th style="background-color:#C7CDC8; color:#000; text-align:center; width: 65%;" colspan="6">Order Details</th>-->
                      ...
                      <th style="background-color:#C7CDC8; color:#000;" rowspan="2" >Total Amount</th>
...
<!--                     <tr class="search1tr">
                 ...
                 $bg = TR_ROW_COLOR1;
                  ...
                  foreach($rs as $key=>$rows)
                  {
                      ...
                      $rorder = $rows['ch_date'];
                      $csa_name = !empty($rows['csa_name'])?$rows['csa_name']:$rows['firm_name'];
                      $rorder1 = $rows['receive_date'];
                      if($rorder1=='00/00/0000' || empty($rorder) || $rorder1=='01/01/1970' || $rorder1 == NULL){
                        // if( empty($rorder) || $rorder1=='01/01/1970' ){
...
// $test = '<a class="iframef" href="index.php?option=received-order-test&showmode=1&mode=1&id='.$uid.'">test</a>&nbsp;&nbsp;';
 ...
 //$rows['postat'] == 1 ? '<span class="seperator">|</span> <a class="iframef" title="print PO '.$uidname.'" href="index.php?option='.$formaction.'&showmode=1&mode=1&id='.$uid.'&actiontype=print"><img src="../icon-system/i16X16/print.png"></a>' : '';
                      ...
                      <tr  BGCOLOR="'.$bg.'" id="tr'.$uid.'" class="ihighlight">
                       ...
                       <!-- <td  style=" display: table-cell; vertical-align: top;">'.$rows['id'].'</td> -->
                            <td style=" display: table-cell; vertical-align: top;">'.$csa_name.'</td>
                               <td style=" display: table-cell; vertical-align: top;">'.$rows['challan_no'].'</td>
                               <td style=" display: table-cell; vertical-align: top;">'.$rows['total_purchase_amount'].'</td>';
...
<script type="text/javascript">
   $('#brand_id1').change(function(){
     ...
     if(bid=='')
     {
        $(".tdata .chzn-results .active-result").show();
     }

     $(".tdata .chzn-results .active-result").hide();
     $(".tdata .chzn-results .active-result").each(function(i,v){
       var text = $(this).text();
