...
<!--                 <td> &nbsp;Expire Date<br><span class="example">(dd/mm/yyyy)</span></td>-->
 ...
 <?php 
  ...
  <td>
                   ...
                   <td>
                     <input type="text" style="width:120px" id="scheme_quantity" placeholder="scheme quantity" name="scheme_quantity[]" placeholder="In Scheme Pieces"  value=""  />
                 </td>
                  <td>
                 <input style="width:100px" type="hidden" name="cases[]" onkeypress="javascript:return isNumber(event)" value=""  />
                 </td>
                  <td>
                 <input type="text" style="width:100px" placeholder="Batch" name="purchase_inv[]"  value="0"  />
                 </td>
<!--                  <td>
          ...
          //        print_r($invalue);
                ...
                <tr class="tdata">
                 ...
                 <td>
                   <?php 
                      db_pulldown170($dbc , 'product_id[]', "SELECT id,name FROM catalog_product ",TRUE,TRUE,' id ="product_id" onchange=getajaxdata(\'get_mrp_product\',\'mytable\',event);', '', $invalue['product_id']); ?>
                 </td>
<!--                 <td>
  ...
  <td>
                   ...
                   <td>
                     <input type="hidden" style="width:120px" id="scheme_quantity" placeholder="scheme quantity" name="scheme_quantity[]" placeholder="In Scheme Pieces"   value="<?php echo $invalue['scheme_qty']; ?>"  />
                 </td>
                  <td>
                 <input type="text" style="width:100px" name="cases[]" onkeypress="javascript:return isNumber(event)" value="<?php echo $invalue['cases']; ?>"  />
                 </td>
                  <td>
                     <input type="text" style="width:100px" name="purchase_inv[]" lang="Batch Number" value="<?php echo $invalue['batch_no']; ?>"  />
                 </td>
