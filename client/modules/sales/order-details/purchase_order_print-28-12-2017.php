  ...
  <div id="certificate_header">
    <table width="100%" class="header_table" style="margin-top:0pt; border:1pt solid #000; border-collapse:collapse; font-family:'Times New Roman', Times, serif; font-size:10pt;" border="1">
      ...
      <tr style="font-weight:bold;">
        ...
        <td style="width:10%" align="center">Rate (Each Case)</td>
	...
	//pre($value1);
               $total_sale_value=$value1['rate']*$value1['quantity'];
               ...
               $total2 = $total_sale_value+$tax2+tax1; 
	  ...
	  ?>
       <tr>
        ...
        <td style="border-bottom:none;border-top:none;height:10px;"align="center"> <?php echo my2digit($caserate);?></td>
     ...
     <?php if($state==10)
      ...
      <td style="border-bottom:none;border-top:none;height:36px;" align="center"><?php echo my2digit($tax1); ?></td>
      <td style="border-bottom:none;border-top:none;height:36px;" align="center"><?=$gst ?></td>
      <td style="border-bottom:none;border-top:none;height:36px;" align="center"><?php echo my2digit($tax2); ?></td>
       <?php }else{ ?>
	  ...
	  <?php
        ...
        echo'<td style="width:23%" align="center">Total Amt.</td>
      </tr>
                    ';
          }          
   ...
   ?>
      ...
      <tr style="font-size:11pt;">
        ...
        <tr>
           ...
           <td colspan="4" align="right" style="border-left:none;"><b>For : <?=$_SESSION[SESS.'data']['dealer_name']?> </b><br /><br /><br />Authorised Signatory</td>
        </tr>
    </table>
