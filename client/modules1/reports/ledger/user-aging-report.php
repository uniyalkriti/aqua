...
<?php 
$forma = 'AGING REPORT'; // to indicate what type of form this is
$formaction = $p;
$myobj = new sale();
$cls_func_str = 'user_aging'; //The name of the function in the class that will do the job
...
?>
    ...
    if(1){ //if no content available present no need to show the bottom part
    ?>
    ...
    <div class="col-xs-12">
         <div class="row">
            <div class="col-xs-12">
                ...
                LAST 15 DAYS INACTIVE USER <div class="pull-right tableTools-container"></div>
                </div>
                </div>
     <?php $total1=0;?>
