...
$formaction = $p;
$myobj = new sale();
$cls_func_str = 'aging'; //The name of the function in the class that will do the job
    ...
    <div class="col-xs-12">
         <div class="row">
            <div class="col-xs-12">
                ...
                LAST 15 DAYS INACTIVE RETAILER <div class="pull-right tableTools-container"></div>
                </div>
                </div>
     <?php $total1=0;?>
