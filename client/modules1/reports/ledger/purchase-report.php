...
$grand_total_value = array(0); 
                  foreach($rs as $key=>$rows)
                  {
                    ...
                    $total =$invalue['rate']*$invalue['quantity'];
    ...
    color:#000;
                        ...
                        <th style="background-color:#307ECC; width: 120px;color:#fff;">Quantity (In Case)</th>
                    ...
                    if(!empty($rows['order_item']))
                     {
                        ...
                        <tr class="bordered">
                          ...
                          <td style="border:none;width:120px;">'.$invalue['rate'].'</td>
                               <td style="border:none;width:120px;">'.$invalue['cases'].'</td> 
