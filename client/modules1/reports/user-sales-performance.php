...
$forma = 'User Sales Performance '; // to indicate what type of form this is
$formaction = $p;
$myobj = new report();
$cls_func_str = 'user_sales_performance'; //The name of the function in the class that will do the job
...
$rs = array();
$filterused = '';
$funcname = 'get_user_sales_performance_list';
