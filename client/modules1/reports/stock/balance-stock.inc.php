...
############################# Code to handle the user search starts here ###############################
  ...
  if (isset($_POST['filter']) && $_POST['filter'] == 'Filter')
  {
   ...
   <table id="dynamic-table" class="table table-striped table-bordered table-hover">
    <thead>
      <tr>
       <th style="text-align: center; background-color:#000; color:#fff;" colspan="4">Product Details</th>
       <th style="text-align: center; background-color:#000; color:#fff;" colspan="5" > Stock Details</th>
     </tr>
     <tr>       
 ...
 <td><b><?=$rows['cat']?></b></td>
 <td><b><?=number_format($rows['mrp'],2)?></b></td>
 <td><b><?=number_format($rows['dealer_rate'],2)?></b></td>
