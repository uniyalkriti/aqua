...
<?php 
$forma = 'Semi Finished Import Item Stock Report'; // to indicate what type of form this is
$formaction = $p;
$myobj = new report();
$cls_func_str = 'row_material_stcok'; //The name of the function in the class that will do the job

$report = new report();
$rs  = $report->get_row_material_stcok_list($filter=' groupId = 7',  $records = '', $orderby=' ORDER BY itemname ASC');
