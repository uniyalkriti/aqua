            ...
            <div class="col-xs-12">
                ...
                <br>
                 ...
                 <div class="table-header">
                    <a class="iframef" title="print All Selected Invoice" id="print_all" href="index.php?option=daily-dispatch-report&showmode=1&mode=1&actiontype=print&id="><i class="fa fa-print" style="color:#fff;"></i><span style="color:#fff;"> Dispatch List</span></a>
...
<!--                                <td>
                                    <?=$uidname?><div style="display:none" id="delDiv<?=$uid?>"></div></td>-->
                                <td><?=$rows['rname']?></td><td><?=$rows['van_no']?>
                                </td>
                                <td>
