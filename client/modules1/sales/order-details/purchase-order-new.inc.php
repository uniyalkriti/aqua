...
<div class="col-xs-2">
       ...
       // setlocale(LC_MONETARY, 'en_IN');
        //$price = money_format('%!i', $unit);
           // echo $amount;
        
        $price = number_format($unit, 2, '.', ',');
        echo "<strong>Achieved On Purchase : <br><span style='background-color:#F89406; font-size:20px;'>₹ ".$price."</span></strong>";
                ?>
                </td></tr>
        <tr><td> </td></tr>
...
<!--                 <td> &nbsp;Mfg Date.<br><span class="example">(dd/mm/yyyy)</span></td>
          ...
          <?php if(!isset($heid)){ ?>
               ...
               // pre($_SESSION);
                ...
                $count1 = 0;
                 $query = "SELECT product_id,name,cprl.rate as rate FROM `focus` INNER JOIN catalog_product ON catalog_product.id = focus.product_id
                     INNER JOIN catalog_product_rate_list cprl ON cprl.catalog_product_id = focus.product_id 
                     WHERE stateId ='$stateid' GROUP BY product_id";
  ...
  ?>
                ...
                <!--                 <td>
                 ...
                 <td>
                     <?php
                     $pod  = mysqli_query($dbc,"SELECT avg(cases) as cases FROM  `purchase_order_details` WHERE product_id='$product_id1' ");
                  //   $ip = 0;
                     ...
                     ?>
                     <input type="text" style="width:120px" placeholder="Quantity" name="quantity[]" lang="quantity" placeholder="In Pieces" onblur="qty_scheme_calculate();" onkeypress="javascript:return isNumber(event)" value="<?=$cases?>"  />
                 </td>
<td>  </td>
                  <td>
<!--                 <input type="text" name="cases[]"  value=""  />-->
                  ...
                  <td>
                     <center> <strong><?php
                      foreach($getstock as $key=>$kv)
                    {
                    $stock = $kv['balance_stock']+$kv['salable_stock']+$kv['manual'];
                     echo $stock; 
                    }
                            ?></strong></center>
  ...
  <?php 
   ...
   ?>
                ...
                <!--                 <td>
                 ...
                 <td>
                     <input type="text" style="width:120px" placeholder="Quantity" name="quantity[]" lang="quantity" placeholder="In Pieces" onblur="qty_scheme_calculate();" value=""  />
                 </td>
<td>  </td>
                  <td>
<!--                 <input type="text" name="cases[]"  value=""  />-->
...
<!--                  <td>
 ...
 <?php 
                ...
                <!--                 <td>
                  ...
                  <td>
                      <input type="text" style="width:100px" placeholder="MRP" name="base_price[]"  value=""  readonly/>
                 </td>
           
                 <td>
                     <input type="text" style="width:120px" id="quantity" placeholder="Quantity" name="quantity[]" onkeypress="javascript:return isNumber(event)" lang="quantity" onblur="qty_scheme_calculate();" placeholder="In Pieces"  value=""  />
                 </td>
...
<!--                  <td>
          ...
          //        print_r($invalue);
               ...
               <td>
                     <input type="text" style="width:120px" id="quantity" placeholder="Quantity" name="quantity[]" lang="quantity" onblur="qty_scheme_calculate();" placeholder="In Pieces"  value="<?php echo $invalue['cases']; ?>"  />
                 </td>
                ...
                <div>
                   ...
                   <!-- <th  style="background-color:#C7CDC8; color:#000;" rowspan="2">Purchase Id</th> -->
                     ...
                     <tr class="search1tr">
                        ...
                        <th style="background-color:#307ECC; color:#fff; width: 120px; text-align:center;">Batch No</th>
                    ...
                    if(!empty($rows['order_item']))
                     {
                        ...
                        <tr class="bordered">
                         ...
                         <td style="border:none;width:120px;text-align:center">'.$invalue['batch_no'].'</td>
