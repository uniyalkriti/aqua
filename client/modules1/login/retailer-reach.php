...
$forma = 'Retailer Reach'; // to indicate what type of form this is
$formaction = $p;
$myobj = new dashboard();
$cls_func_str = 'retailer_reach'; //The name of the function in the class that will do the job
...
if (isset($_POST['filter']) && $_POST['filter'] == 'Filter') {
    ...
    $rs1 = $myobj->get_pre_retailer_reach_list($filter, $records = '', $orderby = "ORDER BY $myorderby",$month);
}
...
<!--                <div class="table-header">
                ...
                <div>
                    ...
                    <style> th { background-color: #C7CDC8;color:#000; }</style>
                     <table id="dynamic-table" border="2" class="table table-striped table-bordered table-hover">
                         <!--<legend class="legend" style=""><?php echo $forma; ?></legend>-->
                        <thead>
                             <tr><th colspan="8" style="background-color:#307ECC;color:#fff;height:35px;font-size: 20px">Retailer Reach </th></tr>
                             
                            <tr>      
                         
                         <th colspan="3" style="text-align:center; ">Retailer Reach of <?php if(isset($month)){echo date("F-Y", strtotime($month));}?>(<?=$curm?>)</th>
                           <th colspan="3" style="text-align:center; ">Retailer Reach in <?php if(isset($pmonth)){echo date("F-Y", strtotime($pmonth));}?>(<?=$prem?>)</th>       
                            </tr>
                            <tr valign="top" class="search1tr">
                                
                                <th width="313px">Retailer Name</th>
                                <th>Productive Call</th>
                                <th>Non Productive Call</th>
                                 <th width="313px">Retailer Name</th>
                                <th>Productive Call</th>
                                <th>Non Productive Call</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            // pre($rs);
                             ...
                             ?>
                                       ...
                                       <tr><td>
                                     <td width="350px"style="background-color:<?php echo $col; ?> ">
                                    <?=$rows['rname']?>
                                </td>
                                  <td width="120px" style="text-align:center;background-color:<?php echo $col; ?>;">
                                    <?=$rows['productive']?>
                                </td>
                                  <td width="120px" style="text-align:center;background-color:<?php echo $col; ?>;">
                                    <?=$rows['non-productive']?>
                            ...
                            // pre($rs);
                             ...
                             ?>
                               ...
                               <td width="350px" style="background-color:<?php echo $col; ?>;">
                                  ...
                                  <td width="120px" style="text-align:center;background-color:<?php echo $col; ?>;">
                                    <?=$rows1['productive_pre']?>
                                </td>
                                 <td width="120px" style="text-align:center;background-color:<?php echo $col; ?>;">
                                    <?=$rows1['non-productive_pre']?>
                                </td>
