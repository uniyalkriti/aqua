...
db_pulldown($dbc, 'product[]', "SELECT catalog_product.id,catalog_product.name FROM catalog_product ", true, true, '', '', $invalue['product_id']);
 ?> 
                                                    </td>
...
<span class="label label-lg label-yellow arrowed-in arrowed-in-right">Make Challan/Invoice</span></button><div class="pull-right tableTools-container"> </div> 
    ...
    <td>' . $callstatus . '</td>';
                ...
                foreach ($rows['order_item'] as $inkey => $invalue) {
                 ...
                 //   echo'<td>'.$schqty.'</td>'; 
                    ...
                    echo'<td>₹ '. $rows['total_sale_value'].'</td>';
//     echo'
//    <table> <tbody>';
