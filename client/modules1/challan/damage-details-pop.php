...
db_pulldownsmall($dbc, 'retailer_id', $qrt, true, true, 'id="retailer_id" lang="Retailer" onchange="getdata(this.value, \'progress_div\', \'get-retailer-location\', \'location_id\');"','=====Please Select=====',$_GET['retailer_id']);
?>
...
<table width="100%" id="mytable1">
    ...
    color:#000;
         ...
         <?php
                    ...
                    db_pulldown($dbc, 'product_id[]', $q, TRUE, TRUE, 'id="product_id'.$z.'" class="item_details" ','',$_POST['challan_item'][$keys[$z-1]]['product_id']);
                    ?>    
