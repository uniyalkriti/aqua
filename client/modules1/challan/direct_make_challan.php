        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="table-header">
                    <a  title="print All Selected Invoice" id="print_all" href="index.php?option=make-challan&showmode=1&mode=1&actiontype=print&id="><img src="../icon-system/i16X16/print.png"></a>
                   Invoice List
                         ...
                         <tbody>
                            ...
                            foreach ($rs as $key => $rows) {
                                ...
                                $uidname = $rows['ch_no'];                              
                                 ...
                                 $editlink = '<a target="_blank" class="iframef" href="index.php?option=direct-challan&showmode=1&mode=1&id='. $uid . '"><img src="./images/b_edit.png"></a>';
                                 }  else {
                                 $editlink = '';    
                                 }
                            ...
                            ?>
                                ...
                                <td>
                                   ...
                                   <tr>
                                    ...
                                    <?php   $total += $amt - $cd_amt  + $surcharge_amt + $vat_amt1 ;
                                   }?>
                                    </table>
                                    </td>
                            <td><strong><img src="../icon-system/i16X16/rupee.png"><?=my2digit($total)?></strong></td>
