...
$formaction = $p;
$myobj = new catalog();
$cls_func_str = 'catalog'; //The name of the function in the class that will do the job
$myorderby = 'name ASC, id ASC'; // The orderby clause for fetching of the data
     ...
     <form method="post" action="<?php if(isset($eformaction)) echo  $eformaction; ?>" class="iform" name="genform" onsubmit="return checkForm_alert('genform');">
      <fieldset>
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="2" class="tableform">
         <tr>
           <td><span class="star">*</span><?php echo ucwords($category); ?><br />
             <input type="text" id="itemcode" name="name"  value="<?php if(isset($_POST['name'])) echo $_POST['name']; ?>" lang="Catalog Name" />
            </td>           
         </tr>
         <tr>
           <td align="center">
    ...
    <div class="col-xs-12">
         <div class="row">
            <div class="col-xs-12">
                ...
                Product Classification <div class="pull-right tableTools-container"></div>
                </div>
                </div>
              <?php
                    ...
                    if($auth['del_opt'] !=1) $deletelink = '';
                     echo'
                      <tr BGCOLOR="'.$bg.'" id="tr'.$uid.'" class="ihighlight">
                        ...
                        <td><strong><a class="iframe" href="indexpop.php?option=sub_catalog_product&id='.$uid.'">'.$uidname.'</strong><div style="display:none" id="delDiv'.$uid.'"></div></td>		
                        <td class="hidden"></td>
                      </tr>
                      ';
                      $inc++;
