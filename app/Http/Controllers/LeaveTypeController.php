...
class LeaveTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = LeaveType::select('id','name','status','sequence')
                ->where('status', '!=', 9)
    ...
    {
        $company_id = Auth::user()->company_id;
        $working_type = LeaveType::where('company_id',$company_id)->orderBy('sequence','desc')->first();
        // dd($working_type);
    ...
    public function edit($id)
    {
        ...
        $company_id = Auth::user()->company_id;
        $workType_info = LeaveType::where('company_id',$company_id)->pluck('name', 'id');
        $workType_data = LeaveType::where('company_id',$company_id)->where('id',$encrypt_id)->first();
        // dd($workType_data);
        return view('LeaveType.edit',
            [
    ...
    public function update(Request $request, $id)
    {
        ...
        $work_type_data= LeaveType::where('id', $uid)->where('company_id',$company_id)->update($work_type);
