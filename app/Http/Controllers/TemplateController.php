...
class TemplateController extends Controller
{
    public function __construct()
    {
        ...
        $this->module=Lang::get('common.template');
    }
    ...
    public function index(Request $request)
    {
        ...
        $query = Template::select('id','name','status','sequence')
                ->where('status', '!=', 9)
        ...
        // dd($working_type);
        return view('TemplateType.index', [
    ...
    {
        $company_id = Auth::user()->company_id;
        $working_type = Template::where('company_id',$company_id)->orderBy('sequence','desc')->first();
        // dd($working_type);
    ...
    public function edit($id)
    {
        ...
        $company_id = Auth::user()->company_id;
        $workType_info = Template::where('company_id',$company_id)->pluck('name', 'id');
        $workType_data = Template::where('company_id',$company_id)->where('id',$encrypt_id)->first();
        // dd($workType_data);
        return view('TemplateType.edit',
            [
    ...
    public function update(Request $request, $id)
    {
        ...
        $work_type_data= Template::where('id', $uid)->where('company_id',$company_id)->update($work_type);
