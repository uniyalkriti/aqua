...
class productTypeController extends Controller
{
    ...
    {
        $this->current = 'product_type';
        $this->module=Lang::get('common.product_type');
    }
    ...
    public function index(Request $request)
    {
        ...
        $query = ProductType::select('id','name','status','sequence')
                ->where('status', '!=', 9)
    ...
    {
        $company_id = Auth::user()->company_id;
        $working_type = ProductType::where('company_id',$company_id)->orderBy('sequence','desc')->first();
        // dd($working_type);
    ...
    public function store(Request $request)
    {
         ...
         */
        $work_type = ProductType::insert([
            'name' => trim(strtoupper($request->workType)),
            'sequence' => $request->sequence,
            'flag_neha'=> $request->unt_type,
    ...
    public function edit($id)
    {
        ...
        $company_id = Auth::user()->company_id;
        $workType_info = ProductType::where('company_id',$company_id)->pluck('name', 'id');
        $workType_data = ProductType::where('company_id',$company_id)->where('id',$encrypt_id)->first();
        // dd($workType_data);
    ...
    public function update(Request $request, $id)
    {
        ...
        $work_type_data= ProductType::where('id', $uid)->where('company_id',$company_id)->update($work_type);
