...
@section('title')
    <title>{{Lang::get('common.comp_price_intelligence')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.comp_price_intelligence')}}</li>
                </ul><!-- /.breadcrumb -->
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#competitive-price" class="btn btn-sm btn-default"><i class="fa fa-navicon mg-r-10"></i> Filter</a>
                </p>
                <!-- /.nav-search -->
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="user[]" id="user" multiple class="form-control chosen-select">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$r)
                                                            <option value="{{$k}}">{{$r}}</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">From</label>
                                                <input value="" autocomplete="off" type="text" placeholder="From Date" name="from_date" id="from_date" class="form-control date-picker">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">To</label>
                                                <input value="" autocomplete="off" type="text" placeholder="From Date" name="to_date" id="to_date" class="form-control date-picker">
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report21.js')}}"></script>
