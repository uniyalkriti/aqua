                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <input autocomplete="off" type="text" name="from_date" id="from_date" class="form-control" placeholder="From Date">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <input autocomplete="off" type="text" name="to_date" id="to_date" class="form-control" placeholder="To Date">
                                            </div>
                                        </div>
