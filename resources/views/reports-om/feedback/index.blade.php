...
@section('title')
    <title>{{Lang::get('common.feedback')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.feedback')}}</li>
                </ul><!-- /.breadcrumb -->
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#feedback" class="btn btn-sm btn-default"><i class="fa fa-navicon mg-r-10"></i> Filter</a>
                </p>
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="feedback" role="form"
...
@section('js')
    ...
    <script src="{{asset('msell/page/report22.js')}}"></script>
    ...
    <script src="{{asset('msell/page/reportfeed.js')}}"></script>
    <script src="{{asset('msell/js/common.js')}}"></script>
