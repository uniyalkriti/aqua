                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route($table_name.'.store')}}" method="POST" id="location2-form" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea required class="form-control" id="article-ckeditor" rows="3" name="workType"></textarea>
                            </div>
                            @endif
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                <label class="control-label" for="status">{{Lang::get('common.'.$table_name)}}</label>
