...
@section('title')
    <title>{{Lang::get('common.daily_schedule')}} - {{config('app.name')}}</title>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
                            {{Lang::get('common.daily_schedule')}}
                            <a href="{{url('daily_schedule/create')}}" class="btn btn-sm btn-success pull-right"><i
                            class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.daily_schedule')}}</a>
                        </div>
                        ...
                        <div>
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{Lang::get('common.daily_schedule')}}</th>
                                        <th>Sequence</th>
                                                ...
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    @if($working_type_data->status==1)
                                                        <button class="btn btn-xs btn-warning"
                                                                onclick="confirmAction('{{Lang::get('common.daily_schedule')}}','{{Lang::get('common.daily_schedule')}}','{{$working_type_data->id}}','_daily_schedule','inactive');">
                                                            <i class="ace-icon fa fa-ban bigger-120"></i>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-xs btn-success"
                                                                onclick="confirmAction('{{Lang::get('common.daily_schedule')}}','{{Lang::get('common.daily_schedule')}}','{{$working_type_data->id}}','_daily_schedule','active');">
                                                            <i class="ace-icon fa fa-check bigger-120"></i>
                                                        </button>
                                                    @endif

                                                    <a class="btn btn-xs btn-info"
                                                       href="{{url('daily_schedule/'.$encid.'/edit')}}">
                                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                    </a>

                                                    <button class="btn btn-xs btn-danger"
                                                            onclick="confirmAction('{{Lang::get('common.daily_schedule')}}','{{Lang::get('common.daily_schedule')}}','{{$working_type_data->id}}','_daily_schedule','delete');">
