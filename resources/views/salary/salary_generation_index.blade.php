...
@section('title')
    <title>{{Lang::get('common.salary')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.salary')}}</li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="sale-order" role="form"
                            ...
                            <input type="hidden" name="submit_url" id="submit_url" value="salary_generation_ajax">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
