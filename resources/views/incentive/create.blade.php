        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('incentive')}}">{{Lang::get('common.incentive')}}</a>
                    </li>

                    <li class="active">Create {{Lang::get('common.incentive')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('incentive.store')}}" method="POST" id="incentive-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="">
                                                <label class="control-label" for="status">Plan Category</label>
                                                <select name="plan_category_status" id="plan_category_status" class="form-control">
                                                    <option value="">Select</option>
                                                        ...
                                                        <option value="3">Outlet Creation</option>
                                                        <option value="4">Range Selling</option>
                                         ...
                                         <div class="col-lg-2" id="hide">
                                            <div class="">
                                                <label class="control-label" for="status">Value Sale</label><br>
                                    ...
                                    <br>
                                     ...
                                     <div class="row">
                                         ...
                                         <table id="maintable"  cellpadding="0" cellspacing="0" class="pdzn_tbl1" border="#729111 1px solid">

                                         <tr>
                                            <th align="center" >Sale unit</th>
                                            <th align="center" >Sale Value</th>
                                            <th align="center" >Incentive Type</th>
                                            <th align="center" >Value</th>
                                            <th align="center" >Role Wise Distribution</th>
                                        </tr>
                                         ...
                                         <tr id="rows">
                                            <div style="padding-left: 5px">
                                                ...
                                                <td>
                                                    @foreach($role_group as $r_key => $r_value)
                                                        <input type="text" readonly name="role_name[]" value="{{$r_value->group_name}}" id= "">
                                                        <input type="hidden" readonly name="role_name_id[]" value="{{$r_value->id}}" id= "">
                                                        
                                                        <input type="text" name="role_wise_amount[]" value="" id= "">
                                                        <br>
                                                    @endforeach
                                                </td>
                                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-5 col-md-7">
                                    ...
                                    <button class="btn" type="button" onclick="document.location.href='{{url('incentive')}}'">
     ...
     $(document).on('change', '#plan_category_status', function () {
       ...
       if(val==1)
        ...
        else
        {
            ...
            $('#unit_type').empty();
            $('#unit_type').append('<option value="">Select</option> <option value="1">Weight</option>  <option value="2">Pcs</option><option value="3">Cases</option>');
        }
