                        ...
                        <div class="row">
                            <div class="space-12"></div>
                                ...
                                <div class="infobox infobox-orange infobox-large infobox-light">
                                    ...
                                    <div class="infobox-data">
                                        <div class="infobox-data-number">{{$totalAttd}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="/public/userLiveLocation"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 infobox-container">
                                ...
                                <div class="infobox infobox-orange infobox-large infobox-dark">
                                        ...
                                        <div class="infobox-data">
                                            <div class="infobox-data-number">{{$totalSalesTeam}}</div>
                                            <a title="Sales Teams" state_id="{{ $location_3_filter }}" mdate="{{ $mdate }}" from_date="{{ $from_date }}" to_date="{{ $to_date }}" data-toggle="modal" data-target="#user_details_modal" class="user-modal totalSalesTeam">
                                            ...
                                            <div class="widget-main">
                                                <table class="table table-bordered table-striped">
                                                    <thead class="thin-border-bottom">
                                                        <tr>
                                                            <th>
                                                                <i class="ace-icon fa fa-caret-right blue"></i>Particulars
                                                            </th>

                                                            <th>
                                                                <i class="ace-icon fa fa-caret-right blue"></i>Total Universe
                                                            </th>

                                                            <th><i class="ace-icon fa fa-caret-right blue"></i><b>Visited</b></th>
                                                            <th><i class="ace-icon fa fa-caret-right blue"></i><b>Not Visited</b></th>
                                                           
                                                            <th><i class="ace-icon fa fa-caret-right blue"></i><b>Billed</b></th>
                                                            <th><i class="ace-icon fa fa-caret-right blue"></i><b>Unbilled</b></th>
                                                        </tr>
                                                    </thead>

                                                    <tbody class="compliance_summary_tbody">
                                                        <tr>
                                                            <td><i class="ace-icon fa fa-caret-right red"></i><b>{{Lang::get('common.retailer')}}</b></td>
                                                            <td>{{$summary_part1_retailer}}</td>
                                                            <td>{{$sumaary_part2_retailer}}</td>
                                                            <td>{{$retailer_count}}</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="ace-icon fa fa-caret-right red"></i><b>{{Lang::get('common.location7')}}</b></td>
                                                            <td>{{$summary_part1_beat}}</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                        ...
                                                        <tr>
                                                            <td><i class="ace-icon fa fa-caret-right red"></i><b>{{Lang::get('common.distributor')}}</b></td>
                                                            <td>{{$summary_part1_dealer}}</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>{{$sumaary_part2_dealer}}</td>
                                                            <td>{{$dealer_count}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td><i class="ace-icon fa fa-caret-right red"></i><b>{{Lang::get('common.csa')}}</b></td>
                                                            <td>{{$summary_part1_csa}}</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
                                                            <td>0</td>
