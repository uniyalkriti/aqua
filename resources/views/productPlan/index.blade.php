                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
                            {{Lang::get('common.productScheme')}}
                            <a href="{{url('productScheme/create')}}" class="btn btn-sm btn-success pull-right"><i
                            class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.productScheme')}}</a>
                        </div>
                        ...
                        <div>   
                            <table id="dynamic-table" class="table  table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>{{Lang::get('common.productScheme')}} Name</th>
                                    <th>status</th>
                                ...
                                @foreach($incentive as $key=>$incentive_data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">{{ucwords(strtolower($incentive_data->scheme_name))}}</a>
                                        </td>
                                       ...
                                       <!--   <td>
                                        ...
                                        <td class="hidden-480">
                                            ...
                                            <a class="btn btn-xs btn-info"
                                                   href="{{url('productScheme/'.$encid.'/edit')}}">
