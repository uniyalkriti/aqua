        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Create {{Lang::get('common.productScheme')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('productScheme.store')}}" method="POST" id="incentive-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-xs-6 col-sm-6 col-lg-2" id="hidden_div_">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right input-sm" for="name">Valid From</label>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right" for="name">Valid To</label>
                                        ...
                                        <table id="dynamic-table"  class="table table-bordered" >
                                            ...
                                            <tr id="rows">
                                                <div style="padding-left: 5px">
                                                    ...
                                                    <td>
                                                        <select name="product1[]" id="product12" class="form-control chosen-select">
                                                            <option disabled="disabled" value="">Select</option>
                                                            @if(!empty($product))
                                                                @foreach($product as $k=>$r)
                                                                    <option value="{{$k}}">{{$r}}</option>
