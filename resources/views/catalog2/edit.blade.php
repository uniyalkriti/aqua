        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a style="color: white" href="{{url('catalog_2')}}">{{Lang::get('common.catalog_2')}}</a>
                    </li>

                    <li class="active" style="color: white">Edit {{Lang::get('common.catalog_2')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
                                     ...
                                     <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                ...
                                                <select required name="catalog_1" id="catalog_0" class="form-control input-sm">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="{{$current_menu}}"> {{Lang::get('common.catalog_2')}} Name </label>
                                                    ...
                                                    <div class="widget-main">
                                                        ...
                                                        <div class="control-group">
                                                            <div class="bootstrap-colorpicker">
                                                                <input id="colorpicker1" type="text" autocomplete="off" name="color_picker" value="{{$catalog_data->c1_color_code}}" class="input-large form-control" />
                                                            </div>
                                                        </div>
