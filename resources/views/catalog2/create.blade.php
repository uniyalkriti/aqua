        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
                <ul class="breadcrumb">
                    ...
                    <li class="active" style="color: white">Add {{Lang::get('common.'.$current_menu)}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route($current_menu.'.store')}}" method="POST"
                              id="catalog-form2" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                                ...
                                                <select name="catalog_1" id="catalog_0" class="form-control input-sm">
                                                    ...
                                                    @if(!empty($cat1))
                                                        @foreach($cat1 as $c1_key=>$c1_data)
                                                            <option value="{{$c1_key}}">{{$c1_data}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="widget-main">
                                                        ...
                                                        <div class="control-group">
                                                            <div class="bootstrap-colorpicker">
                                                                <input id="colorpicker1" type="text" autocomplete="off"  name="color_picker" class="input-large form-control" />
                                                            </div>
                                                        </div>
