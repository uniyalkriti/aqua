        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('location2')}}">{{Lang::get('common.location2')}}</a>
                    </li>

                    <li class="active">Edit {{Lang::get('common.location2')}}</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::open(array('route'=>['location2.update',$encrypt_id] , 'method'=>'PUT','id'=>'location2-form','role'=>'form' ))!!}
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select name="location1" id="location1" class="form-control chosen-select">
                                                <option value="">Select</option>
                                                @foreach($location1_info as $key=> $val)
                                                    <option {{$loc_data->location_1_id==$key?'selected':''}} value="{{$key}}">{{$val}}</option>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-5 col-md-9">
                                ...
                                <button class="btn" type="button" onclick="document.location.href='{{url('location2')}}'">
