        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('location3')}}">{{Lang::get('common.location3')}}</a>
                    </li>

                    <li class="active">Edit {{Lang::get('common.location3')}}</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::open(array('route'=>['location3.update',$encrypt_id] , 'method'=>'PUT','id'=>'location3-form','role'=>'form' ))!!}
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select name="location_1" id="location_1" class="form-control chosen-select">
                                                ...
                                                @foreach($location1_info as $key=> $val)
                                                    <option {{$l1_code==$key ? 'selected':''}} value="{{$key}}">{{$val}} </option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="">
                                            <label class="control-label no-padding-right"
                                                   for="name">{{Lang::get('common.location2')}} Name</label>
                                            <select name="location_2" id="location_2" class="form-control chosen-select">
                                                <option value="">Select</option>
                                                @foreach($location2_info as $key=> $val)
                                                    <option {{$l2_code==$key ? 'selected':''}} value="{{$key}}">{{$val}}</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="">
                                            <label class="control-label no-padding-right"
                                                   for="name">{{Lang::get('common.location3')}} Name</label>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-5 col-md-9">
                                ...
                                <button class="btn" type="button" onclick="document.location.href='{{url('location3')}}'">
...
@section('js')
    ...
    <script src="{{asset('msell/page/location3.js')}}"></script>
