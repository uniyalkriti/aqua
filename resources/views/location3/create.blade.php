        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Add {{Lang::get('common.location3')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('location3.store')}}" method="POST" id="location-form312" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="">
                                                ...
                                                <input type="text" id="name" name="name"
                                                       value="{{old('name')}}"
                                                       placeholder="Enter {{Lang::get('common.location3')}}"
                                                       class="form-control"/>
                                            </div>
                                        </div>
