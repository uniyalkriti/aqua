        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user')}}">{{Lang::get('common.product-investigation')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.product-investigation')}} Dashboard</li>
                </ul><!-- /.breadcrumb -->
            </div>
            @else
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user_public_data')}}">{{Lang::get('common.product-investigation')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.product-investigation')}} Dashboard</li>
                </ul><!-- /.breadcrumb -->
            </div>
