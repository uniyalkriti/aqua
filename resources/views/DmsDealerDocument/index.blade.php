...
@section('title') 
    <title>{{Lang::get('common.document_upload')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.document_upload')}}</li>
                </ul><!-- /.breadcrumb -->
...
@section('js')
    ...
    <script src="{{asset('msell/page/report161.js')}}"></script>
