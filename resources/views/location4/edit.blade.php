        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit {{Lang::get('common.location4')}}</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::open(array('route'=>['location4.update',$encrypt_id] , 'method'=>'PUT','id'=>'location4-form','role'=>'form' ))!!}
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-lg-6">
...
@section('js')
    ...
    <script src="{{asset('msell/page/location4.js')}}"></script>
