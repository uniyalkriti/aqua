                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header center">
                            {{Lang::get('common.location4')}}
                                <p class="bs-component pull-right">
                                <span id="checkTrialLocation">
                                <a href="{{url('location4/create')}}" class="btn btn-sm btn-success pull-right ActionCreate"><i
                                class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.location4')}}</a>
                                </span>
                                </p>
                        </div>
                                            ...
                                            <div class="hidden-sm hidden-xs btn-group">
                                                @if($location4_data->status==1)
                                                    <button title="Inactive" class="btn btn-xs btn-warning ActionData"
                                                            onclick="confirmAction('{{Lang::get('common.location4')}}','Location4','{{$location4_data->id}}','location_4','inactive');">
                                                        <i class="ace-icon fa fa-ban bigger-120"></i>
                                                    </button>
                                                @else
                                                    <button title="Active" class="btn btn-xs btn-success ActionData"
                                                            onclick="confirmAction('{{Lang::get('common.location4')}}','Location4','{{$location4_data->id}}','location_4','active');">
                                                        <i class="ace-icon fa fa-check bigger-120"></i>
                                                    </button>
                                                @endif

                                                <a title="Edit" class="btn btn-xs btn-info ActionData"
                                                   href="{{url('location4/'.$encid.'/edit')}}">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>

                                                <button title="Delete" class="btn btn-xs btn-danger ActionDelete"
                                                        onclick="confirmAction('{{Lang::get('common.location4')}}','Location4','{{$location4_data->id}}','location_4','delete');">
