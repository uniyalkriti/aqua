                                ...
                                <div class="col-xs-12 col-sm-3 center">
                                    <div>
												<span class="profile-picture">
													<img id="avatar" style="height: 100px;" class="editable img-responsive" alt="Alex's Avatar" src="{{asset('msell/images/avatars/avatar2.png')}}" />
												</span>
                                        ...
                                        <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                            <div class="inline position-relative">
                                                    ...
                                                    &nbsp;
                                                    <span class="white">{{!empty($user->full_name)?$user->full_name:'N.A'}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix">
                                        <div class="grid2">
                                            <span class="bigger-175 blue">2</span>
                                        ...
                                        <div class="grid2">
                                            <span class="bigger-175 blue">3</span>
                                     ...
                                     <div class="profile-user-info profile-user-info-striped">
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="username">{{!empty($user->person_username)?$user->person_username:'N.A'}}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                ...
                                                <span class="editable" id="city">{{!empty($user->rolename)?$user->rolename:'N.A'}}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="signup">{{!empty($user->mobile)?$user->mobile:'N.A'}}</span>
                                            </div>
                                        </div>


                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> Head Quarter </div>
