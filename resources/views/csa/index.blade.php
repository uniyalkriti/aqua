            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
                <ul class="breadcrumb">
                    <li style="color: white">
                        ...
                        <a style="color: white" href="{{url('csa')}}">{{Lang::get('common.csa')}} {{Lang::get('common.master')}}</a>
                    </li>

                    <li class="active" style="color: white">{{Lang::get('common.csa')}}</li>
                </ul><!-- /.breadcrumb -->
            </div> <!-- /.nav-search -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for anything.." title="Type in a name">
                                    <a href="{{url($current_menu.'/create')}}" class="btn btn-sm btn-info pull-right ActionCreate" style="margin-left: 5px">
                            ...
                            <div class="col-xs-12" style="overflow-x: scroll;">
                                ...
                                <table id="dynamic-table" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{Lang::get('common.csa')}} Code</th>
                                    ...
                                    @foreach($records as $key=>$data)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->csa_code}}</td>
                                            <td><a href="{{url('#')}}">{{$data->csa_name}}</a></td>
