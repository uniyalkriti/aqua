        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Add {{Lang::get('common.csa')}}</li>
                </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right"
                                           ...
                                           <input type="text" placeholder="Enter Town Name" name="location_4" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input type="text" placeholder="Enter SS Name" name="ss_name"
                                 ...
                                 <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input type="text" placeholder="Enter SS Code" name="ss_code"
                                               id="ss_code" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input placeholder="Enter Mobile" type="text" name="mobile" id="mobile" class="form-control input-sm">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input placeholder="Enter Email" type="email" name="email" id="email" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="email">{{Lang::get('common.retailer_owner_name')}}</label>
                                        <input placeholder="Enter name" type="text" name="contact_person" id="contact_person" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right">{{Lang::get('common.status')}}</label>
                                        <select required="required" class="form-control input-sm" name="status"
                                                id="status">
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input type="text" name="tin_no" id="tin_no" class="form-control input-sm" placeholder="Tin No">
                                    </div>
                                </div>
                                        ...
                                        <select name="division" id="division" class="form-control input-sm">
                                            ...
                                            @if(!empty($division))
                                                @foreach($division as $div_key=>$div_data)
                                                    <option value="{{$div_key}}">{{$div_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
