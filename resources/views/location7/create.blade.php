        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Add {{Lang::get('common.location7')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('location7.store')}}" method="POST" id="location7-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="">
                                                <label class="control-label" for="location_1">{{Lang::get('common.location1')}} Name</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="">
                                                <label class="control-label" for="location_2">{{Lang::get('common.location2')}} Name</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="">
                                                <label class="control-label" for="location_3">{{Lang::get('common.location3')}} Name</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="location_4">{{Lang::get('common.location4')}} Name</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="location_5">{{Lang::get('common.location5')}} Name</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="location_6">{{Lang::get('common.location6')}} Name</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="">
                                                ...
                                                <input type="text" id="beat" name="beat_name"
                                                       value=""
