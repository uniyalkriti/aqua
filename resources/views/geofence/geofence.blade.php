        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->  
                         <form class="form-horizontal open collapse in" action="geofenceSubmit" method="POST" id="geofence" role="form" enctype="multipart/form-data">
                         {!! csrf_field() !!}
                                <div class="row">
                                     <div class="col-sm-3">
                                        <label class="control-label">Town</label>
                                         <select required="required" name="territory" id="territory" class="form-control chosen-select input-sm">
...
<script src="{{asset('msell/page/report7.js')}}"></script>
 <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD96suZt39wVDLJ_D1xRmDQ2JA3I5m4Xwg&libraries=geometry,places,drawing">
