        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Create {{Lang::get('common.dms_order_reason')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('dms_order_reason.store')}}" method="POST" id="location2-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                <label class="control-label" for="status">{{Lang::get('common.dms_order_reason')}}</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                ...
                                                <input class="form-control" type="text" name="msg" maxlength="100" minlength="1" id="msg">
                                            </div>
                                        </div>
