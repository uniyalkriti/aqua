    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
            <ul class="breadcrumb">
                ...
                <li class="active" style="color: white">Edit {{Lang::get('common.product_rate_list')}}</li>
            </ul><!-- /.breadcrumb -->
            <!-- /.nav-search -->
        </div>
                        ...
                        {!! Form::open(array('route'=>[$current_menu.'.update',$encrypt_id] , 'method'=>'PUT','id'=>'catalog-form','enctype'=>'multipart/form-data','role'=>'form' ))!!}
                            ...
                            <div class="row" style="overflow-x: scroll;">
                                <table id="simple-table" align="center" class="table table-bordered table-hover">
                                    <thead><tr><td colspan="13"><h3>Edit {{Lang::get('common.catalog_4')}} {{Lang::get('common.details')}}</h3></td></tr></thead>
                                    <tr>
                                        ...
                                        @if(count($check_assign_edit)>0)
                                            <th>Product Type</th>
                                            <th>Other {{Lang::get('common.retailer')}} {{Lang::get('common.rate')}}</th>
                                            <th>Other {{Lang::get('common.distributor')}} {{Lang::get('common.rate')}}</th>
                                        @endif
