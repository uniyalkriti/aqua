    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
            <ul class="breadcrumb">
                ...
                <li>
                    <a style="color: white" href="{{url('product_rate_list')}}">{{Lang::get('common.product_rate_list')}}</a>
                </li>

                <li class="active" style="color: white">Add {{Lang::get('common.product_rate_list')}}</li>
            </ul><!-- /.breadcrumb -->
            <!-- /.nav-search -->
        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="">
                                            <label class="control-label no-padding-right">{{Lang::get('common.location3')}}</label>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="">
                                            <label class="control-label no-padding-right">{{Lang::get('common.catalog_3')}}</label>
                                            <select name="cat_id" id="cat_id" class="form-control input-sm" required="">
                                                <option value="">Select</option>
                                                @if(!empty($catList))
                                    ...
                                    <div class="col-lg-2">
                                        <div class="">
                                            <br>
                                            <button type="submit" class="btn btn-sm btn-primary form-control" value="find">{{Lang::get('common.find')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" action="{{route($current_menu.'.store')}}" method="POST" id="catalog-form3" role="form" enctype="multipart/form-data">
                            ...
                            <div class="row" style="overflow-x: scroll;">
                                <table id="simple-table" align="center" class="table table-bordered table-hover">
                                    <thead><tr><td colspan="13"><h3>Add {{Lang::get('common.catalog_4')}} {{Lang::get('common.details')}}</h3></td></tr></thead>
                                    <tr>
                                    ...
                                    <tbody>
                                        <input type="hidden" name="state_id"  value="{{$cstate_id}}">
                                        ...
                                        @if(!empty($sku))
                                            @foreach($sku as $k=>$data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->name}}</td>
                                                    <td><input type="text" name="mrp_case_rate[]" placeholder="Cases M.R.P."></td>
                                                    <td><input type="text" name="mrp_pcs_rate[]" placeholder="M.R.P."></td>
                                                    <td><input type="text" name="ss_case_rate[]" placeholder="Super Stockiest Case Rate"></td>
                                                    <td><input type="text" name="ss_pcs_rate[]" placeholder="Super Stockiest Rate"></td>
                                                    <td><input type="text" name="dealer_case_rate[]" placeholder="Distributor Case Rate"></td>
                                                    <td><input type="text" name="dealer_pcs_rate[]" placeholder="Distributor Rate"></td>
                                                    <td><input type="text" name="retailer_cases_rate[]" placeholder="Retailer case Rate"></td>
                                                    <td><input type="text" name="retailer_pcs_rate[]" placeholder="Retailer Rate"></td>
                                                    ...
                                                    @else
                                                        @if(!empty($other_rate_ist_data[$data->id]))
                                                            ...
                                                            <td><input type="text" name="other_retailer_rate_type[]" placeholder="{{$other_rate_ist_data[$data->id]}} Rate"></td>
                                                            <td><input type="text" name="other_dealer_rate_type[]" placeholder="{{$other_rate_ist_data[$data->id]}} Rate"></td>
                                                        @endif
                                                    @endif
