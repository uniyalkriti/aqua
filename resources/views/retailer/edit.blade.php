        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit {{Lang::get('common.retailer_detail')}}</li>
                </ul>
                                        ...
                                        <select name="location_1" id="location_1" class="form-control input-sm">
                                            ...
                                            @if(!empty($location1))
                                                @foreach($location1 as $l1_key=>$l1_data)
                                                    <option {{$location->l1_id==$l1_key?'selected':''}} value="{{$l1_key}}">{{$l1_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="location_2" id="location_2" class="form-control input-sm">
                                            ...
                                            @if(!empty($location2))
                                                @foreach($location2 as $l2_key=>$l2_data)
                                                    <option {{$location->l2_id==$l2_key?'selected':''}} value="{{$l2_key}}">{{$l2_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="location_3" id="location_3" class="form-control input-sm">
                                            ...
                                            @if(!empty($location3))
                                                @foreach($location3 as $l3_key=>$l3_data)
                                                    <option {{$location->l3_id==$l3_key?'selected':''}} value="{{$l3_key}}">{{$l3_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="location_4" id="location_4" class="form-control input-sm">
                                            ...
                                            @if(!empty($location4))
                                                @foreach($location4 as $l4_key=>$l4_data)
                                                    <option {{$location->l4_id==$l4_key?'selected':''}} value="{{$l4_key}}">{{$l4_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="location_5" id="location_5"
                                            ...
                                            @if(!empty($location5))
                                                @foreach($location5 as $l5_key=>$l5_data)
                                                    <option {{$location->l5_id==$l5_key?'selected':''}} value="{{$l5_key}}">{{$l5_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="location_6" id="location_6"
                                            ...
                                            @if(!empty($location6))
                                                @foreach($location6 as $l6_key=>$l6_data)
                                                    <option {{$location->l6_id==$l6_key?'selected':''}} value="{{$l6_key}}">{{$l6_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="location_7" id="location_7"
                                            ...
                                            @if(!empty($location7))
                                                @foreach($location7 as $l7_key=>$l7_data)
                                                    <option {{$location->l7_id==$l7_key?'selected':''}} value="{{$l7_key}}">{{$l7_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <select name="distributor" id="distributor"
                                            ...
                                            <option value="">Select</option>
                                            @if(!empty($dealer))
                                                @foreach($dealer as $d_key=>$d_data)
                                                    <option {{($d_key == $retailer->dealer_id)?'selected':''}} value="{{$d_key}}">{{$d_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input type="text" value="{{$retailer->name}}" placeholder="Enter Retailer Name" name="retailer_name"
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <textarea name="address" id="address" class="form-control input-sm">{{$retailer->address}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="landline">{{Lang::get('common.landline')}}</label>
                                        <input placeholder="Enter Landline" value="{{$retailer->landline}}" type="text" name="landline" id="landline" class="form-control input-sm vnumerror" maxlength="12">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="mobile">{{Lang::get('common.user_contact')}} <b style="color:red;">*</b></label>
                                        <input placeholder="Enter Mobile" required="required" value="{{$retailer->other_numbers}}" type="text" name="mobile" id="mobile" class="form-control input-sm vnumerror" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="email">{{Lang::get('common.email')}} <b style="color:red;">*</b></label>
                                        <input placeholder="Enter Email" required="required" value="{{$retailer->email}}" type="email" name="email" id="email" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right">{{Lang::get('common.pin_no')}} <b style="color:red;">*</b></label>
                                        <input type="text" value="{{$retailer->pin_no}}" name="pin_no" id="pin_no" class="form-control input-sm vnumerror" placeholder="Pin No" maxlength="6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input type="text" value="{{$retailer->tin_no}}" name="tin_no" id="tin_no" class="form-control input-sm verror" placeholder="Tin No" maxlength="15">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="avg_per_month">{{Lang::get('common.avg_month')}}</label>
                                        <input type="text" value="{{$retailer->avg_per_month_pur}}" name="avg_per_month" id="avg_per_month" class="form-control input-sm rate" placeholder="Avg.Per Month Purchase">
                                    </div>
                                </div>
                                 <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <select name="outlet_type" id="outlet_type" class="form-control input-sm">
                                            ...
                                            @if(!empty($outlet_type))
                                                @foreach($outlet_type as $oid=>$outlet)
                                                    <option {{$retailer->outlet_type_id==$oid?'selected':''}} value="{{$oid}}">{{$outlet}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <input type="text" name="user_name" value="{{$retailer->username}}"   class="form-control input-sm " placeholder="User name" >
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <select name="is_golden" id="is_golden" class="form-control input-sm">
                                            <option {{$retailer->is_golden==0?'selected':''}} value="0">NO</option>
                                            <option {{$retailer->is_golden==1?'selected':''}} value="1">YES</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
