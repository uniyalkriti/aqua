                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
                            {{Lang::get('common.manual_attendance_reason')}}
                             <p class="bs-component pull-right">
                            <span id="checkTrialLocation">
                            <a href="{{url('manual_attendance_reason/create')}}" class="btn btn-sm btn-success pull-right"><i
                            class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.manual_attendance_reason')}}</a>
                            </span>
                            </p>
                        </div>
                        ...
                        <div>
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{Lang::get('common.manual_attendance_reason')}}</th>
                                        <th>Sequence</th>
                                                ...
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    @if($working_type_data->status==1)
                                                        <button class="btn btn-xs btn-warning"
                                                                onclick="confirmAction('{{Lang::get('common.manual_attendance_reason')}}','{{Lang::get('common.manual_attendance_reason')}}','{{$working_type_data->id}}','v','inactive');">
                                                            <i class="ace-icon fa fa-ban bigger-120"></i>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-xs btn-success"
                                                                onclick="confirmAction('{{Lang::get('common.manual_attendance_reason')}}','{{Lang::get('common.manual_attendance_reason')}}','{{$working_type_data->id}}','_attendance_reason','active');">
                                                            <i class="ace-icon fa fa-check bigger-120"></i>
                                                        </button>
                                                    @endif

                                                    <a class="btn btn-xs btn-info"
                                                       href="{{url('manual_attendance_reason/'.$encid.'/edit')}}">
                                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                    </a>

                                                    <button class="btn btn-xs btn-danger"
                                                            onclick="confirmAction('{{Lang::get('common.manual_attendance_reason')}}','{{Lang::get('common.manual_attendance_reason')}}','{{$working_type_data->id}}','_attendance_reason','delete');">
