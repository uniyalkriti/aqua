...
<div class="modal fade" id="user_assign_distributor" role="dialog">
    <div class="modal-dialog modal-lg2">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h3 class="modal-title" ><u>User Assign Distributor List</u></h3>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12 col-md-2">
                        ...
                        <div class="text-center" >
                                <img height="150" id="image_user" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="" alt=" " />
                    ...
                    success: function (data) 
                    {
                        ...
                        else if (data.code == 200) 
                        {
                            ...
                            $.each(data.result, function (u_key, u_value) {
                                console.log(u_value);
                                    $('.mytbody_distibutor_list').append("<tr><td>"+Sno+"</td><td>"+u_value.dealer_name+"</td><td>"+u_value.beat_count+"<td>"+u_value.retailer_count+"</td><td><button class='btn btn-xs btn-danger' ><i class='ace-icon fa fa-trash-o bigger-120'></i></button></td></tr>");
                                Sno++;
                            });   
