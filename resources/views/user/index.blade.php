                ...
                <form class="form-horizontal open collapse in" action="" method="get" id="user-search" role="form"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">  
                                <label class="control-label no-padding-right" for="name">{{Lang::get('common.department')}}</label>
                                <select name="department[]" multiple id="department" class="form-control chosen-select">
                                    <option value="">Select</option>
                                    @if(!empty($department))
                                        @foreach($department as $rk=>$rr)
                                             <?php if(empty($_GET['department']))
                                                $_GET['department']=array();
                                            ?>
                                            <option @if(in_array($rk,$_GET['department'])){{"selected"}} @endif   value="{{$rk}}"> {{$rr}} 
                                            </option>                                                        
                                        @endforeach 
                                    @endif
                                </select>
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="col-lg-2 ActionUser ActionCreate">
                            ...
                            <div class="col-xs-12" style="overflow-x: scroll;">
                                ...
                                <table id="dynamic-table" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <!--<th class="hideextra">{{Lang::get('common.image')}}</th>-->
                                        <!-- <th class="hideextra">{{Lang::get('common.location3')}}</th> -->
                                        <th class="hideextra">{{Lang::get('common.location4')}}</th>
                                        <!-- <th class="hideextra">{{Lang::get('common.location5')}}</th> -->
                                        <th class="hideextra">{{Lang::get('common.location6')}}</th>

                                        <!-- <th class="hideextra">{{Lang::get('common.department')}}</th> -->


                                        <th class="hideextra">{{Lang::get('common.emp_code')}}</th>
                                        <th class="hideextra">Employee Name</th>
                                        <th class="detail-col">Details</th>
                                        
                                        <th class="hideextra">{{Lang::get('common.user_name')}}</th>
                                        <th class="hideextra">{{Lang::get('common.password')}}</th>
                                        <th class="hideextra">{{Lang::get('common.role_key')}}</th>
                                        <th class="hideextra">{{Lang::get('common.senior_name')}}</th>
                                        <th class="hideextra">{{Lang::get('common.user_contact')}}</th>
                                        <th class="hideextra">{{Lang::get('common.user_address')}}</th>
                                        <th class="hideextra">{{Lang::get('common.email')}}</th>
                                        <!-- <th class="hideextra">{{Lang::get('common.created_date')}}</th> -->
                                        <!-- <th class="hideextra">{{Lang::get('common.deactivate_date')}}</th> -->
                                        <th class="hideextra">{{Lang::get('common.last_sync_date')}}</th>
                                        <th class="hideextra">{{Lang::get('common.app_version')}}</th>
                                        <th class="hideextra">{{Lang::get('common.user_imei')}}</th>
                                        {{--<th>--}}
                                        {{--<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>--}}
                                        {{--Created On--}}
                                        {{--</th>--}}
                                        @if(Auth::user()->is_admin == '1')
                                            <th class="hideextra">{{Lang::get('common.status')}}</th>
                                            @else
                                            <th class="hideextra">Documents</th>
                                        @endif
                                        <th class="hideextra">{{Lang::get('common.action')}}</th>
                                    ...
                                    @foreach($records as $key=>$data)
                                        ...
                                        <tr class="search_from_this">
                                            ...
                                            <!--        <img id="user_image"   src="{{asset('users-profile/')}}{{'/'.$data->person_image}}" alt=" " onerror="this.onerror=null;this.src='{{asset('msell/images/avatars/avatar2.png')}}';" />-->
                                            <!--    </a>-->
                                            <!--</td>-->
                                            <!-- <td class="hideextra">{{!empty($data->state)?$data->state:'N/A'}}</td> -->
                                            <!-- <td class="hideextra">{{!empty($location_5[$data->head_quater])?$location_5[$data->head_quater]:''}}</td> -->
                                            <td class="hideextra">{{!empty($depoData[$data->id])?$depoData[$data->id]:''}}</td>

                                            <td class="hideextra">{{!empty($location_6[$data->town_name])?$location_6[$data->town_name]:''}}</td>

                                            <!-- <td class="hideextra">{{!empty($department[$data->department_id])?$department[$data->department_id]:''}}</td> -->


                                            <td class="hideextra">{{!empty($data->emp_code)?$data->emp_code:'N/A'}}</td>
                                            <td class="hideextra">
                                            ...
                                            <td class="hideextra">{{$data->person_username}}</td>
                                            <td class="hideextra">{{$data->person_password}}</td>
                                            <td class="hideextra">{{$data->rolename}}</td>
                                            <td class="hideextra"><a href="{{url('user/'.$sencid)}}">{{$data->srname}}</a></td>
                                            <td class="hideextra">{{$data->mobile}}</td>
                                            
                                            <td class="hideextra">{{!empty($data->personaddress)?$data->personaddress:'N/A'}}</td>
                                            <td class="hideextra">{{!empty($data->email)?$data->email:'N/A'}}</td>
                                            <!-- <td class="hideextra">{{!empty($data->created_on)?date("d-M-Y H:i:s", strtotime($data->created_on)):'N/A'}}</td> -->

                                            @if($data->person_status == 1)
                                            <!-- <td class="hideextra">  </td> -->
                                            @else
                                            <!-- <td class="hideextra"> {{!empty($data->deactivate_date)?date("d-M-Y H:i:s", strtotime($data->deactivate_date)):'N/A'}}</td> -->
                                            @endif

                                            <td class="hideextra"> {{!empty($data->last_sync)?date("d-M-Y H:i:s", strtotime($data->last_sync)):'N/A'}}</td>


                                            <td class="hideextra"> {{!empty($data->version_code_name)?$data->version_code_name:'N/A'}}</td>
                                            <td id="{{$data->id.'imei'}}" class="hideextra">{{!empty($data->imei_number)?$data->imei_number:'N/A'}}</td>
                                            ...
                                            @if(Auth::user()->is_admin == '1')
                                                ...
                                                <td >
                                                    ...
                                                    <!-- for clear imei  -->
                                                        <a title="Clear Imei" class="btn btn-xs btn-danger ActionData" onclick="confirmAction('Clear IMEI','IMEI','{{$data->id}}','{{$status_table}}','clear');">
                                                        ...
                                                        <div id="{{$data->id.'active_incative'}}"> 
                                                            @if($data->person_status==1)
                                                                <a title="Inactive" class="btn btn-xs btn-warning ActionData" onclick="confirmAction('{{Lang::get('common.'.$current_menu)}}','{{Lang::get('common.'.$current_menu)}}','{{$data->id}}','{{$status_table}}','inactive');">
                                                                    <i class="ace-icon fa fa-ban bigger-120"></i>
                                                                </a>
                                                                
                                                            @else
                                                                <a title="Active" class="btn btn-xs btn-success ActionData" onclick="confirmAction('{{Lang::get('common.'.$current_menu)}}','{{Lang::get('common.'.$current_menu)}}','{{$data->id}}','{{$status_table}}','active');">
                                                        ...
                                                        <a title="Edit" class="btn btn-xs btn-primary ActionData" href="{{url($current_menu.'/'.$encid.'/edit')}}">
                                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                        </a>

                                                         <a title="Copy" class="btn btn-xs btn-success ActionData"
                                                           href="{{url('userCopy/'.$encid)}}">
                                                        ...
                                                        <a title="Delete" user_id="{{ $data->id }}" role_id="{{ $data->role_id }}" data-toggle="modal"  data-target="#immediate_junior_list" class="btn btn-xs btn-danger immediate_junior_list ActionDelete">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </a>
                                                        ...
                                                        <button title="Assign Distributor" userid="{{$data->id}}"
                                                                ...
                                                                class="user-modal btn btn-xs btn-default ActionData">
                                                        ...
                                                        <button title="Assign State for Travel" usersid="{{$data->id}}"
                                                            data-toggle="modal" data-target="#myModalForState"
                                                            class="user-state-modal btn btn-xs btn-default ActionData">
                                                        <i class="ace-icon fa fa-stop-circle bigger-120"></i>
                                                        </button>
                                                        @endif
...
<!-- 
                                                ...
                                                <input type="text" readonly="readonly" style="width:100px; height: 0px; border: none; border-color: transparent; background: transparent;"> -->
                                                </td>
                                                @else
                                                <td>
                                                    <button type="button" userid="{{$data->id}}" 
                                                        data-toggle="modal" data-target="#reciept_modal" class="btn btn-default reciept_modal btn-round btn-white ActionData">
                                                ...
                                                <td>
                                                    @foreach($master_documents as $key=>$value)
                                                        ...
                                                        <?php 
                                                            $image_name_doc = !empty($person_documents_data[$data->id.$key])?$person_documents_data[$data->id.$key]:''; 
                                                        ?>
                                                        <img id="user_image" width="50" height="50"  src="{{$image_name_doc}}" alt=" " />
                                                        <br>
                                                        <br>
    ...
    <!-- Modal -->
     <div class="modal fade" id="myModalForState" role="dialog">
        <div class="modal-dialog modal-lg2">
            ...
            <div class="modal-content">
                <div class="modal-header widget-header widget-header-small">
                    ...
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="smaller">Assign Multiple States for Travelling</h4>
                 
                </div>
                <div class="modal-body ui-dialog-content ui-widget-content">
                    <form method="GET" id="assign_mult_states" action="assign_mult_states">
                        <input type="hidden" id="uusid" name="uusid" value="">
                        <div class="row">
                           
                             
                            @foreach($location_3 as $lkey=>$ldata)
                                <div class="checkbox">
                                    <label>
                                        <input value="{{$lkey}}" name="multstate[]" type="checkbox" class="ace">
                                        <span class="lbl"> {{$ldata}}</span>
                                    </label>
                                </div>
                            @endforeach
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                ...
                                <th>{{Lang::get('common.location3')}} Name</th>
                                <th>{{Lang::get('common.location4')}} Name</th>
                                <th>{{Lang::get('common.location5')}} Name</th>
                                <th>{{Lang::get('common.location6')}} Name</th>
    ...
    <div class="modal-dialog" style="width:900px;">
        ...
        <div class="modal-content" id ="modalDiv">
            ...
            <div class="modal-body" id="qwerty">
                <form action="user_upload_documents" method="post" id="reciept_modal_form" enctype="multipart/form-data">
                    {!! csrf_field() !!}

                    <input type="hidden" id="userid_c" name="userid" value="">
...
<!-- document upload modal ends here  -->
...
@section('js')
    ...
    <script type="text/javascript">
        $('.user-state-modal').click(function () {
            $('#uusid').val($(this).attr('usersid'));
        });
    </script>
                            ...
                            else if (data.code == 200) 
                            {
                                ...
                                $.each(data.result_data, function (b_key, b_value) {
                                    ...
                                    else
                                    {
                                        ...
                                        template_beat += ("<tr><td>"+Sno_beat+"</td><td>"+b_value.l3_name+"</td><td>"+b_value.l4_name+"</td><td>"+b_value.l5_name+"</td><td>"+b_value.l6_name+"</td><td>"+b_value.l7_name+"</td><td>"+retailer_count+"</td></tr>");
                                    Sno_beat++;
                                });   
                                template_beat += "<tr><td colspan = '6'>Grand Total</td><td>"+total_retailer_count+"</td></tr>";
                                        ...
                                        else if (data.code == 200) 
                                        {
                                            ...
                                            $.each(data.result, function (u_key, u_value) {
                                                // console.log(u_value);
                                                    beat_total += parseInt(u_value.beat_count);
                                                    dealer_retailer_total += parseInt(u_value.retailer_count);
                                                    beat_retailer_total += parseInt(data.actual_retailer_count[u_value.dealer_id]);
                                                    if(data.actual_retailer_count[u_value.dealer_id])
                                                    {
                                                        retailer_count_beat_wise = data.actual_retailer_count[u_value.dealer_id];
                                                    }
