...
@section('title')
    <title>{{Lang::get('common.type_of_meeting')}} - {{config('app.name')}}</title>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
                            {{Lang::get('common.type_of_meeting')}}
                            <a href="{{url('type_of_meeting/create')}}" class="btn btn-sm btn-success pull-right"><i
                            class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.type_of_meeting')}}</a>
                        </div>
                        ...
                        <div>
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{Lang::get('common.type_of_meeting')}}</th>
                                        <th>Sequence</th>
                                                ...
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    @if($working_type_data->status==1)
                                                        <button class="btn btn-xs btn-warning"
                                                                onclick="confirmAction('{{Lang::get('common.type_of_meeting')}}','{{Lang::get('common.type_of_meeting')}}','{{$working_type_data->id}}','_meeting_with_type','inactive');">
                                                            <i class="ace-icon fa fa-ban bigger-120"></i>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-xs btn-success"
                                                                onclick="confirmAction('{{Lang::get('common.type_of_meeting')}}','{{Lang::get('common.type_of_meeting')}}','{{$working_type_data->id}}','_meeting_with_type','active');">
                                                            <i class="ace-icon fa fa-check bigger-120"></i>
                                                        </button>
                                                    @endif

                                                    <a class="btn btn-xs btn-info"
                                                       href="{{url('type_of_meeting/'.$encid.'/edit')}}">
                                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                    </a>

                                                    <button class="btn btn-xs btn-danger"
                                                            onclick="confirmAction('{{Lang::get('common.type_of_meeting')}}','{{Lang::get('common.type_of_meeting')}}','{{$working_type_data->id}}','_meeting_with_type','delete');">
