        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Create {{Lang::get('common.vehicle_details')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('vehicle_details.store')}}" method="POST" id="location2-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                ...
                                                <input class="form-control" type="text" name="weight" maxlength="100" minlength="1" id="workType">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="">
                                                <label class="control-label" for="status">Minimum Quantity</label>
                                                <input class="form-control" type="text" name="min_qty" maxlength="100" minlength="1" id="workType">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="">
                                                <label class="control-label" for="status">Maximum Quantity</label>
                                                <input class="form-control" type="text" name="max_qty" maxlength="100" minlength="1" id="workType">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="">
