                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
                            {{Lang::get('common.scheme')}}
                            <a href="{{url('scheme/create')}}" class="btn btn-sm btn-success pull-right"><i
                            class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.scheme')}}</a>
                        </div>
                                    ...
                                    <tr>
                                       ...
                                       <!--   <td>
                                        ...
                                        <a class="btn btn-xs btn-info"
                                            href="{{url('scheme/'.$encid.'/edit')}}">
                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                        </a>

                                        <a class="btn btn-xs btn-info"
                                            href="{{url('scheme/'.$encid)}}">
