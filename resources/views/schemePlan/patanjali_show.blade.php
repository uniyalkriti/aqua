        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">View {{Lang::get('common.productScheme')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {!! Form::open(array('route'=>['scheme.update',$encrypt_id] , 'method'=>'PUT','id'=>'scheme-form','role'=>'form' ))!!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="plan_category_status" id="plan_category_status" class="form-control" disabled="disabled">
                                         ...
                                         <div class="col-lg-2">
                                            <div class="">
                                                ...
                                                <select id="vs_status" class="form-control" name="vs_status" disabled="disabled">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select name="item_status_id" id="item_status_id" onchange="showDiv(`hidden_div`,`hidden_div2`, this)" class="form-control" disabled="disabled">
                                            <option value="">Select</option> 
                                        ...
                                        <table id="dynamic-table"  class="table table-bordered" >
                                            ...
                                            <tr id="rows">
                                                <div style="padding-left: 5px">
                                                    ...
                                                    <td>
                                                        <select name="product1[]" id="product12" class="form-control chosen-select" disabled="disabled">
                                                    ...
                                                    <td style="padding:5px;">
                                                        <select name="unit_type[]" id="unit_type" class="form-control chosen-select" disabled="disabled">
                                                            <option value="">Select</option>
                                                    ...
                                                    <td style="padding:5px;">
                                                        <select name="amt_type[]" id="amt_type" class="form-control chosen-select" disabled="disabled">
                                                            <option value="">Select</option>
     ...
     $(document).on('change', '#plan_category_status', function () {
       ...
       if(val==1)
        ...
        else if(val == 3)
        {
            ...
            $('#vs_status').append('<option value="">Select</option> <option value="1">Total Sale Wise</option>  <option value="2">Item Wise</option> ');
            $('#unit_type').empty();
            $('#unit_type').append('<option value="">Select</option> <option value="3">pcs</option>');
        }
        else
        {
            $('#vs_status').empty();
