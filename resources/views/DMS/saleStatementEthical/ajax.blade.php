...
<div class="table-header center" style="background-color: white; color: black; text-align: center; font-size: 40px; font-weight:100px;">
     <b style="background-color: ; color: black; font-family: 'Times New Roman', Times, serif;">Ethical Sale Statement</b>
    <div class="pull-left">
    ...
    <thead >
        <tr>
            ...
            @endforeach
              ...
              <th width="200px;" style=" background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;" >JPS<br>
                (VALUE)
            </th>


               <th width="200px;" style=" background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;" >JP2<br>
                (VALUE)
            </th>
