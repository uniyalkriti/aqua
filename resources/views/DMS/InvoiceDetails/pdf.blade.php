        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #90d781; color: black;">
            <ul class="breadcrumb">
                <li style="color: white">
                    ...
                    <a style="color: white" href="#">{{Lang::get('common.order_details_dms')}} </a>
                </li>
                <li class="active" style="color: white">Invoice Details</li>
            </ul><!-- /.breadcrumb -->
            <!-- /.nav-search -->
        </div>
                                ...
                                @if(!empty($order_details_body))
                                    @foreach($order_details_body as $key=>$value)
                                        <tr style="height:4.5mm;">
                                            ...
                                            <?php 
                                                $QTYISSUED_c = !empty($value->QTYISSUED)?$value->QTYISSUED:'0';
                                                $QTYFREE_c = !empty($value->QTYFREE)?$value->QTYFREE:'0';
                                                $billed_qty = $QTYISSUED_c-$QTYFREE_c;
