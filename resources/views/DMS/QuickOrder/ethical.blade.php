                                ...
                                <table id="dynamic-1table" class="table table-bordered ">
                                    <thead >
                                        <tr>
                                            <th colspan="11" style="background-color: #90d781;color: black;text-align: center; font-size: 40px; font-weight:100px; ">
                                                <b style="background-color: ; color: black; font-family: 'Times New Roman', Times, serif;">Marketing Category Ethical</b>
                                            </th>
                                            <tr >
                                    ...
                                    <tbody style="text-align: left;">
                                        ...
                                        <tr style="text-align: left;">
                                            ...
                                            ?>
                                            <td style="text-align: right;">{{number_format(($total_ann_target_1/100000),2)}}</td>
