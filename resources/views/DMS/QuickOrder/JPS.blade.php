        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #90d781; color: black;">
                <ul class="breadcrumb">
                    ...
                    <li class="active" style="color: black;">Marketing Category JPS</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
                                ...
                                <table id="dynamic-1table" class="table table-bordered ">
                                    <thead >
                                        <tr>
                                            <th colspan="11" style="background-color: #90d781;color: black;text-align: center; font-size: 40px; font-weight:100px; ">
                                                <b style="background-color: ; color: black; font-family: 'Times New Roman', Times, serif;">Marketing Category Ethical-I</b>
                                            </th>
                                            <tr >
                                    ...
                                    <tbody style="text-align: left;">
                                        ...
                                        <tr style="text-align: left;">
                                            ...
                                            <?php
                                            // if(!empty($prod_wise_target_um[$value->PROD_CATG])){
                                            //     $um = $prod_wise_target_um[$value->PROD_CATG];
                                            // }elseif($um_array[$value->PROD_CATG]){
                                            //     $um = $um_array[$value->PROD_CATG];
                                            // }else{
                                            //     $um = "N/A";
                                            // }
                                            ...
                                            <td style="text-align: left;">{{!empty($prod_wise_target_um[$value->PROD_CATG])?$prod_wise_target_um[$value->PROD_CATG]:"N/A"}}</td>
