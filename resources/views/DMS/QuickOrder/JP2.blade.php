        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #90d781; color: black;">
                <ul class="breadcrumb">
                    ...
                    <li class="active" style="color: black;">Marketing Category JP2</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
                                ...
                                <table id="dynamic-1table" class="table table-bordered ">
                                    <thead >
                                        <tr>
                                            <th colspan="11" style="background-color: #90d781;color: black;text-align: center; font-size: 40px; font-weight:100px; ">
                                                <b style="background-color: ; color: black; font-family: 'Times New Roman', Times, serif;">Marketing Category Ethical-II</b>
                                            </th>
                                            <tr >
                                    ...
                                    <tbody style="text-align: left;">
                                        ...
                                        <tr style="text-align: left;">
                                            ...
                                            <td style="text-align: right;">{{!empty($prod_wise_target_mast[$value->PROD_CATG])?number_format(($prod_wise_target_mast[$value->PROD_CATG]/100000),2):0}}</td>
                                        ...
                                        <tr style="text-align: left;">
                                            ...
                                            <?php
                                                $total_ann_target_1 = array_sum($total_ann_target);
                                                 ...
                                                 $total_ann_target_1 = ($total_ann_target_1 == 0) ? (!empty($jp2_wise_target_data)?round($jp2_wise_target_data/100000,2):0) : $total_ann_target_1;
