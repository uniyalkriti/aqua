                ...
                ?>
                                ...
                                <table class=" table-bordered" style="background-color: #f8f8f8; " >
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:200px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">{{Lang::get('common.item_name')}}</th>
                                        ...
                                        <th style="width: 200px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0; ">{{Lang::get('common.remark')}}</th>
                                    </tr>
                                    </thead>
