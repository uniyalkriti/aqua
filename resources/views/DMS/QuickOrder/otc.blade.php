        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #90d781; color: black;">
                <ul class="breadcrumb">
                    ...
                    <li class="active" style="color: black;">Marketing Category OTC</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
                                ...
                                <table id="dynamic-1table" class="table table-bordered ">
                                    <thead >
                                        ...
                                        <th colspan="11" style="background-color: #90d781;color: black;text-align: center; font-size: 40px; font-weight:100px; ">
                                            <b style="background-color: ; color: black; font-family: 'Times New Roman', Times, serif;">Marketing Category OTC</b>
                                        </th>
                                        <tr >
                                        ...
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;" rowspan="2">Category</th>
                                        ...
                                        <th style="background-color: #237a00c4;color: black; height: 10px; " ><b style="font-weight: bolder; font-size: 17px;">CURRENT QUARTER</b></th>
                                        <th style="background-color: #237a00c4;color: black; height: 10px; "><b style="font-weight: bolder; font-size: 17px;">CURRENT MONTH</b></th>
                                    </tr>
                                    <tr>
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">Target</th>
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">Achieved</th>
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">Sales<br> (in rupees)  </th>
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">Achieved<br>(%)</th>
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">Achieved<br> (in qty)</th>
                                        <th style="width: 50px; background-color: #90d781; font-family: 'Open Sans';  color: #000000e0;">Achieved<br> (in qty)</th>
                                    </tr>
                                    </thead>
                                    <tbody style="text-align: left;">
                                        ...
                                        $total_ann_sale_val_m[] = !empty($month_prod_wise_sales_mast_data_qty[$value->PROD_CATG])?$month_prod_wise_sales_mast_data_qty[$value->PROD_CATG]:0;
                                        $total_ann_sale_val_q[] = !empty($quat_prod_wise_sales_mast_data_qty[$value->PROD_CATG])?$quat_prod_wise_sales_mast_data_qty[$value->PROD_CATG]:0;
                                        ...
                                        <tr style="text-align: left;">
                                            ...
                                            <td style="text-align: right;">{{!empty($prod_wise_target_mast[$value->PROD_CATG])?ROUND($prod_wise_target_mast[$value->PROD_CATG],2):0}}</td>
                                            ...
                                            <td style="text-align: right;">{{!empty($quat_prod_wise_sales_mast_data_qty[$value->PROD_CATG])?round($quat_prod_wise_sales_mast_data_qty[$value->PROD_CATG],2):0}}</td>
                                        ...
                                        <tr style="text-align: left;">
                                            ...
                                            $y = !empty($total_ann_sale_qty_1)?$total_ann_sale_qty_1:0;
                                            $achieved_1 = ($x === 0 || $y === 0) ? 0 : round((($y/$x)*100), 2)."%" ;
                                            ?>
                                            <td style="text-align: right;">{{$achieved_1}}</td>
                                            
                                            <td style="text-align: right;">{{round(($total_ann_sale_val_1_q),2)}}</td>
                                            <td style="text-align: right;">{{round(($total_ann_sale_val_1_m),2)}}</td>
                                        </tr>
                                    </tbody>
                                </table>
