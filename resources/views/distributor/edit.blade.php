        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit {{Lang::get('common.dealer_detail')}}</li>
                </ul>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{--<form class="form-horizontal" action="{{route($current_menu.'.store')}}" method="POST" id="{{$current_menu}}-form" role="form" enctype="multipart/form-data">--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <textarea name="address" class="form-control input-sm"
                                              id="address">{{$dealer->address}}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <input type="text" id="landline" name="landline" value="{{$dealer->landline}}"
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <input type="email" value="{{$dealer->email}}" id="email" name="email"
                                           class="form-control input-sm"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <input type="text" value="{{$dealer->pin_no}}" id="pin_no" name="pin_no"
                                           class="form-control input-sm vnumerror" maxlength="6"/>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <input type="text" value="{{$dealer->tin_no}}" id="tin_no" name="tin_no"
                                           class="form-control input-sm verror" maxlength="15"/>
                                </div>
                            </div>
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <input type="text" required="required" value="{{$dealer->other_numbers}}" id="mobile" name="mobile"
                                           class="form-control input-sm vnumerror" maxlength="10" />
                                </div>
                            </div>
                                    ...
                                    <select class="form-control input-sm" name="ownership_type" id="ownership_type">
                                        ...
                                        @if(!empty($ownership))
                                            @foreach($ownership as $k=>$d)
                                                <option {{$dealer->ownership_type_id==$k?'selected':''}} value="{{$k}}">{{$d}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <input placeholder="Enter Email" type="text" id="avg_per_month"
                                           value="{{$dealer->avg_per_month_pur}}"
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <select required="" name="town_id" id="town_id" class="form-control input-sm">
                                        <option value="">Select</option>
                                        @if(!empty($location6))
                                            @foreach($location6 as $l6_key=>$l6_data)
                                                <option {{$dealer->town_id==$l6_key?'selected':''}} value="{{$l6_key}}">{{$l6_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="pan_no" name="pan_no" value="{{!empty($dealer_personal_details->pan_no)?$dealer_personal_details->pan_no:''}}" class="form-control input-sm " />
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="aadar_no" name="aadar_no" value="{{!empty($dealer_personal_details->aadar_no)?$dealer_personal_details->aadar_no:''}}" class="form-control input-sm" maxlength="15"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  placeholder="Enter  Food License" type="text" id="food_license"
                                               name="food_license" class="form-control input-sm "value="{{!empty($dealer_personal_details->food_license)?$dealer_personal_details->food_license:''}}"/>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="">
                                        ...
                                        <select required="required" multiple name="vehicle_details_array[]" id="vehicle_details_array" class="form-control input-sm chosen-select">
                                            ...
                                            @if(!empty($vehicle_details))
                                                @foreach($vehicle_details as $l6_key=>$l6_data)
                                                    ...
                                                    <option {{in_array($l6_key,$vehicle_details_edit)?'selected':''}} value="{{$l6_key}}">{{$l6_data}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" placeholder="Enter Bank Name" id="bank_name" name="bank_name" value="{{!empty($dealer_personal_details->bank_name)?$dealer_personal_details->bank_name:''}}" class="form-control input-sm " />
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="security_amt" name="security_amt" value="{{!empty($dealer_personal_details->security_amt)?$dealer_personal_details->security_amt:''}}" class="form-control input-sm" maxlength="15"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="refrence_no" name="refrence_no"  value="{{!empty($dealer_personal_details->refrence_no)?$dealer_personal_details->refrence_no:''}}"class="form-control input-sm" maxlength="30"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="security_date" name="security_date" value="{{!empty($dealer_personal_details->security_date)?$dealer_personal_details->security_date:''}}" class="form-control input-sm date-picker" maxlength="15"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="reciept_issue_date" name="reciept_issue_date" value="{{!empty($dealer_personal_details->reciept_issue_date)?$dealer_personal_details->reciept_issue_date:''}}" class="form-control input-sm date-picker" maxlength="15"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  placeholder="Enter  Remarks" type="text" id="security_remarks"
                                               name="security_remarks" class="form-control input-sm " value="{{!empty($dealer_personal_details->security_remarks)?$dealer_personal_details->security_remarks:''}}"/>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="commencement_date" name="commencement_date" value="{{!empty($dealer_personal_details->commencement_date)?$dealer_personal_details->commencement_date:''}}" class="form-control input-sm date-picker" maxlength="15"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="termination_date" name="termination_date" value="{{!empty($dealer_personal_details->termination_date)?$dealer_personal_details->termination_date:''}}" class="form-control input-sm date-picker" maxlength="15"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="certificate_issue_date" name="certificate_issue_date" value="{{!empty($dealer_personal_details->certificate_issue_date)?$dealer_personal_details->certificate_issue_date:''}}" class="form-control input-sm date-picker" maxlength="15"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6">
                                    <div class="">
                                        ...
                                        <input  placeholder="Enter  Remarks" type="text" id="agreement_remarks"
                                               name="agreement_remarks" class="form-control input-sm " value="{{!empty($dealer_personal_details->agreement_remarks)?$dealer_personal_details->agreement_remarks:''}}"/>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="refund_amt" name="refund_amt" class="form-control input-sm" value="{{!empty($dealer_personal_details->refund_amt)?$dealer_personal_details->refund_amt:''}}"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="refund_ref_no" name="refund_ref_no" class="form-control input-sm "  value="{{!empty($dealer_personal_details->refund_ref_no)?$dealer_personal_details->refund_ref_no:''}}"/>
                                    </div>
                                </div>
                                <div class="col-xs-2">
                                    <div class="">
                                        ...
                                        <input  type="text" id="refund_date" name="refund_date" value="{{!empty($dealer_personal_details->refund_date)?$dealer_personal_details->refund_date:''}}" class="form-control input-sm date-picker" />
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6">
                                    <div class="">
                                        ...
                                        <input  placeholder="Enter  Remarks" type="text" id="refund_remarks"
                                               name="refund_remarks" class="form-control input-sm " value="{{!empty($dealer_personal_details->refund_remarks)?$dealer_personal_details->refund_remarks:''}}"/>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                    ...
                                    <select name="location_1" id="location_1" class="form-control  input-sm ">
                                        ...
                                        @if(!empty($location1))
                                            @foreach($location1 as $l1_key=>$l1_data)
                                                <option {{!empty($dlrl2->l1_id) && $dlrl2->l1_id==$l1_key?'selected':''}} value="{{$l1_key}}">{{$l1_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <select name="location_2" id="location_2" class="form-control input-sm ">
                                        <option value="">Select</option>
                                        @if(!empty($location2))
                                            @foreach($location2 as $l2_key=>$l2_data)
                                                <option {{!empty($dlrl2->l2_id) && $dlrl2->l2_id==$l2_key?'selected':''}} value="{{$l2_key}}">{{$l2_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <select name="location_3" id="location_3" class="form-control input-sm ">
                                        ...
                                        @if(!empty($location3))
                                            @foreach($location3 as $l3_key=>$l3_data)
                                                <option {{!empty($dlrl2->l3_id) && $dlrl2->l3_id==$l3_key?'selected':''}} value="{{$l3_key}}">{{$l3_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <select name="location_4" multiple id="location_4" class="form-control input-sm chosen-select">
                                        <option value="">Select</option>
                                        @if(!empty($location4))
                                            @foreach($location4 as $l4_key=>$l4_data)
                                                <option {{in_array($l4_key,$l4_array)?'selected':''}}  value="{{$l4_key}}">{{$l4_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <select  name="location_5" multiple id="location_5"
                                            class="form-control input-sm chosen-select">
                                        <option value="">Select</option>
                                        @if(!empty($location5))
                                            @foreach($location5 as $l5_key=>$l5_data)
                                                <option {{in_array($l5_key,$l5_array)?'selected':''}}  value="{{$l5_key}}">{{$l5_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <select multiple  name="location_6[]" id="location_6"
                                            class="form-control input-sm chosen-select">
                                        <option value="">Select</option>
                                        @if(!empty($location6))
                                            ...
                                            @foreach($location6 as $l6_key=>$l6_data)
                                                ...
                                                <option {{in_array($l6_key,$town_id_array)?'selected':''}} value="{{$l6_key}}">{{$l6_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-xs-2">
                                <div class="">
                                    ...
                                    <select multiple name="location_7[]" id="location_7"
                                            class="form-control input-sm chosen-select">
                                        <option value="">Select</option>
                                        @if(!empty($location7))
                                            @foreach($location7 as $l7_key=>$l7_data)
                                                <option {{in_array($l7_key,$dlrl)?'selected':''}} value="{{$l7_key}}">{{$l7_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                    ...
                                    <select name="csa" id="csa_id" class="form-control input-sm">
                                        ...
                                        @if(!empty($csa))
                                            @foreach($csa as $csa_key=>$csa_data)
                                                <option {{$csa_key==$dealer->csa_id?'selected':''}} value="{{$csa_key}}">{{$csa_data}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                        ...
                                        <div class="">
                                            ...
                                            <select  name="template_product_id" id="template_product_id" class="form-control input-sm">
                                                ...
                                                @if(!empty($template_product))
                                                    ...
                                                    <?php
                                                    $template_id = !empty($dealer->template_id)?$dealer->template_id:'';
                                                    ?>
                                                        <option {{ $csa_key == $template_id?'selected':''}} value="{{$csa_key}}">{{$csa_data}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
