            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs" style="background-color: #4287BA;">
                <ul class="breadcrumb">
                    <li style="color: white">
                        ...
                        <a style="color: white" href="#">{{Lang::get('common.dealer_module')}}</a>
                    </li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-2">
                                ...
                                <select name="status" id="status" class="form-control chosen-select">
                                    ...
                                    <option {{ Request::get('status')==9?'selected':'' }} value='9'>Sleepy</option>
                                </select>
                            </div>
                            <div class="col-xs-2">
                    ...
                    <div class="col-xs-12" style="overflow-x: scroll;">
                        ...
                        <table id="dynamic-table" class="table table-bordered table-hover">
                            <thead>
                                    ...
                                    <th>{{Lang::get('common.user')}} Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-480">
                                            ...
                                            @elseif($data->dealer_status==9)
                                                <span class="label label-sm label-danger">Sleeping</span>
                                            @else
                                            ...
                                            <div class="hidden-sm hidden-xs btn-group">
                                                ...
                                                @if($edit_status == 1 || $is_admin == 1)
                                                    ...
                                                    @if($delete_status == 1 || $is_admin == 1)
                                                        ...
                                                        <button title="Sleep" class="btn btn-xs btn-danger"
                                                                onclick="confirmAction('{{Lang::get('common.'.$current_menu)}}','{{Lang::get('common.'.$current_menu)}}','{{$data->id}}','{{$status_table}}','Sleep');">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header widget-header widget-header-small">
                {{--<div class="widget-header widget-header-small">--}}
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="smaller">Distributor Credentials</h4>
                {{--</div>--}}
            </div>
            <div class="modal-body ui-dialog-content ui-widget-content">
                @if(count($errors)>0)
                ...
                <form method="post" id="filter_distributor2"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-lg-3">
                            <div class="">
                                <label class="control-label no-padding-right"
                                       for="user_password">Update Password</label>
                        ...
                        <div class="col-xs-6 col-sm-6 col-lg-3">
                            <div class="">
                                ...
                                <select required="required" name="role_name" id="role_name2"
                                        class="form-control input-sm">
                                    <option value="">Distribuor</option>
            ...
            success: function (data) {
                if (data.code == 401) {
                    ...
                    $.ajax({
                        ...
                        url: domain + '/getLocation',
                        dataType: 'json',
                        data: "id=" + val+"&type="+level+"&flag=84",
                        success: function (data2) {
                            if (data2.code == 401) {
                                ...
                                $('#location_5').empty();
                                $('#location_5').append(template2).trigger("chosen:updated");
