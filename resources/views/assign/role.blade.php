...
<div class="main-content">
                                ...
                                <div class="col-xs-6 col-sm-6 col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right"
                                               for="name">Role</label>
                                        <select name="role" id="role" class="form-control chosen-select input-sm" required>
    ...
    <div id="form-wrapper" style="max-width:700px;margin:auto;">
        <form  method="get" action="RoleAddModules"  enctype="multipart/form-data">
             {!! csrf_field() !!}
                                     ...
                                     <tr>
                                            ...
                                            ?>
                                                ...
                                                <td>  
                                                            ...
                                                            <input name="module[]" value="{{$d->id.'|'.$d->name}}" id="module" type="checkbox" {{in_array($d->id,$check_app_module)?'checked':''}}>
                                                ...
                                                @if(!empty($arr2[$d->id]))
                                                 <?php $sub_inc = 1; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                                <input id ="dist12" name="submodule[]" value="{{$data->id.'|'.$data->title_name}}" type="checkbox" {{in_array($data->id,$checksub_module)?'checked':''}}>  
