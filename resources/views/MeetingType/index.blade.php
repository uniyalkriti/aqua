                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="table-header">
                            {{Lang::get('common.meeting_type')}}
                            <p class="bs-component pull-right">
                            <span id="checkTrialLocation">
                            <a href="{{url('meeting_type/create')}}" class="btn btn-sm btn-success pull-right"><i
                            class="fa fa-plus mg-r-10"></i> Add {{Lang::get('common.meeting_type')}}</a>
                            </span>
                            </p>
                        </div>
                        ...
                        <div>
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{Lang::get('common.meeting_type')}}</th>
                                        <th>Sequence</th>
                                                ...
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    @if($working_type_data->status==1)
                                                        <button class="btn btn-xs btn-warning"
                                                                onclick="confirmAction('{{Lang::get('common.meeting_type')}}','{{Lang::get('common.meeting_type')}}','{{$working_type_data->id}}','_meeting_type','inactive');">
                                                            <i class="ace-icon fa fa-ban bigger-120"></i>
                                                        </button>
                                                    @else
                                                        <button class="btn btn-xs btn-success"
                                                                onclick="confirmAction('{{Lang::get('common.meeting_type')}}','{{Lang::get('common.meeting_type')}}','{{$working_type_data->id}}','_meeting_type','active');">
                                                            <i class="ace-icon fa fa-check bigger-120"></i>
                                                        </button>
                                                    @endif

                                                    <a class="btn btn-xs btn-info"
                                                       href="{{url('meeting_type/'.$encid.'/edit')}}">
                                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                    </a>

                                                    <button class="btn btn-xs btn-danger"
                                                            onclick="confirmAction('{{Lang::get('common.meeting_type')}}','{{Lang::get('common.meeting_type')}}','{{$working_type_data->id}}','_meeting_type','delete');">
