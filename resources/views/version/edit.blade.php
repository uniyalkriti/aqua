        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit {{Lang::get('common.version')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::open(array('route'=>['version.update',$encrypt_id] , 'method'=>'PUT','id'=>'version-form','role'=>'form' ))!!}
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="">
                                            ...
                                            <select name="company" id="company" class="form-control">
                                                ...
                                                @foreach($company as $key=>$name)
                                                    <option {{ $version_data->company_id==$key ? 'selected':'' }} value="{{$key}}">{{$name}}</option>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="">
                                                ...
                                                <input type="text" id="vcode" name="vcode"
                                                       value="{{$version_data->version_code}}"
