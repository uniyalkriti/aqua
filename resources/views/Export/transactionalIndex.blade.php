...
@section('title')
    <title>{{Lang::get('common.export')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.export')}}</li>
                </ul><!-- /.breadcrumb -->
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#compliant" class="btn btn-sm btn-default"><i class="fa fa-navicon mg-r-10"></i> Filter</a>
                </p>
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="compliant" role="form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="town[]" id="town" multiple class="form-control chosen-select">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($town))
                                                        @foreach($town as $k=>$r)
                                                            <option value="{{$k}}">{{$r}}</option>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report82.js')}}"></script>
