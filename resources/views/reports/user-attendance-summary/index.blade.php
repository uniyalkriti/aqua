...
@section('title')
    <title>{{Lang::get('common.attendance-summary-report')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.attendance-summary-report')}}</li>
                </ul><!-- /.breadcrumb -->
...
@section('js')
    ...
    <script src="{{asset('msell/page/report142.js')}}"></script>
