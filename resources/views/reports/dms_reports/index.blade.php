...
@section('title')
    <title>Order Booking Report - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Product Wise Order Booking Report</li>
                </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select  multiple name="state_id[]" id="state" class="form-control chosen-select">
                                                <option  value="">select</option>
                                                @if(!empty($l3_filter))
                                                    @foreach($l3_filter as $k=>$r)
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="control-label no-padding-right" for="name">Distributor</label>
                                                <select multiple name="dealer_id[]"  id="user" class="form-control chosen-select">
                                                    <option value="">select</option>
                                                    @if(!empty($dealer))
                                        ...
                                        <div class="col-md-3">
                                            <div class="">
                                                ...
                                                <select multiple name="product_id[]" id="product" class="form-control chosen-select" >
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($product_filter))
                                                        @foreach($product_filter as $k=>$r)
                                                            <option value="{{$k}}">{{$r}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                     ...
                                     <div class="row">  
                                        ...
                                        <div class="col-md-3">
                                            <button type="submit" class="btn btn-sm btn-primary btn-block mg-b-10"
                                                ...
                                                Orber Booking Report
                                            </button>
                                        </div>
                                        <div class="col-md-3">
                                            <button id="saleOrderReport" type="button" class="btn btn-sm btn-primary btn-block mg-b-10"
                                                    style="margin-top: 28px;"><i class="fa fa-search mg-r-10"></i>
                                                Sale Order Report
                                            </button>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report162.js')}}"></script>
