...
<table id="simple-table" class="table table-bordered" style="font-size: 13px;border: 1px black">
    ...
    @if(count(array($r->order_id))>0)
        ...
        <tr>
            ...
            <td>
                ...
                <table class="table">
                    ...
                    @if(!empty($r))
                        ...
                        <?php $value = 0; 
                        $volume = !empty($productWeight[$data1->product_id])?$productWeight[$data1->product_id]:'0';

                        $finalWeight = (($volume*$data1->quantity)/1000);
            ...
            <tr>
                <th colspan="17"><strong>Grand Total</strong></th>
                <td>
