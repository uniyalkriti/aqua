...
if( !empty($attendance_data[$record->user_id.$record->travellingDate]) && $attendance_data[$record->user_id.$record->travellingDate] != 90 && $attendance_data[$record->user_id.$record->travellingDate] != 93 && $attendance_data[$record->user_id.$record->travellingDate] != 95 && $attendance_data[$record->user_id.$record->travellingDate] != 96 ){
