...
<!-- <th rowspan="2">{{Lang::get('common.image')}}</th> -->
...
<th rowspan="2">No. Of {{Lang::get('common.distributor')}}</th>
<th colspan="2">Primary Orders Booked</th>
<th colspan="2">Secondary Orders Booked</th>
...
<th>Check In {{Lang::get('common.time')}}</th>
<th>{{Lang::get('common.location6')}}</th>
<th>Check Out {{Lang::get('common.time')}}</th>
<th>Rs.</th>
<th>Rs.</th>
<th>Rs.</th>
<th>Rs.</th>
