...
@section('title')
    <title>{{Lang::get('common.notification-non-contacted')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.notification-non-contacted')}}</li>
                </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">From {{Lang::get('common.date')}}</label>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">To {{Lang::get('common.date')}}</label>
                                                <input value="{{ !empty(Request::get('to_date'))?date('Y-m-d',strtotime(Request::get('to_date'))):date('Y-m-d') }}" autocomplete="off" type="text" placeholder="From Date" name="to_date" id="to_date" class="form-control date-picker">
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report145.js')}}"></script>
