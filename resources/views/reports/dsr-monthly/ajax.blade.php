...
<table id="dynamic-table" class="table table-bordered" style="font-size: 13px;border: 1px black">
            ...
            ?>
                <tr>
                    ...
                    <td>{{!empty($productData[$data->user_id][$data->date]['total_call'])?round(((($productData[$data->user_id][$data->date]['productive_call'])/($productData[$data->user_id][$data->date]['total_call']))*100)).'%':'N/A'}}
                      ...
                      $total_qty[$cdata->id][]=!empty($dsr[$data->user_id.$cdata->id.$data->date])?$dsr[$data->user_id.$cdata->id.$data->date]:'0';
                       ?>
                      <td>{{!empty($dsr[$data->user_id.$cdata->id.$data->date])?$dsr[$data->user_id.$cdata->id.$data->date]:'0'}}</td>
                    @endforeach
                      ...
                      @if($company_id == 44)
                      <td>{{!empty($scheme_amount[$data->user_id.$data->date])?round($scheme_amount[$data->user_id.$data->date]):'0'}}</td>
                      @endif
    ...
    <tfoot>
        <tr>
          <th colspan="15"> {{Lang::get('common.grand')}} {{Lang::get('common.total')}} </th>
                            ...
                            jQuery(function ($) {
                                ...
                                var myTable =
                                        ...
                                        .DataTable({
                                            ...
                                            "aoColumns": [
                                                {"bSortable": false},
                                                  null,null,null,null, null, null,null,null,null,null, null, null,null,null,<?= $implode ?>,<?=$nehanull?>
