...
<thead>
    ...
    <tbody>
        <?php $h=1; $count=0; $track_count=29; ?>
            ...
            @foreach($records as $key=>$data)
             <?php $encid = Crypt::encryptString($data->user_id);?>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td ><strong style="color: red;">{{'User Name: '}}</strong><a href="{{url('user/'.$encid)}}">{{$data->person_fullname}}</a><strong style="color: red;">{{' Date: '}}</strong><a href="#">{{$data->track_date}}</a> <strong style="color: red;">{{' State: '}}</strong><a href="#">{{$data->state_name}}</a> </td>
                    <td></td>
                    <td></td>
                </tr>
                        ...
                        @foreach($track_time[$data->user_id][$data->track_date] as $Tkey => $Tvalue)
                            ...
                            @foreach($Tvalue as $T1key => $T1value)
                                ...
                                <tr>
                                    ...
                                    <td>{{$T1value->track_time}}</td>
                                    <td>{{$T1value->location}}</td>
                                    <td>{{$T1value->status}}</td>
