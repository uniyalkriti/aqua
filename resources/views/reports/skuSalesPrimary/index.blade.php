...
@section('title')
    <title>Primary SKU Sales - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Primary SKU Sales</li>
                </ul><!-- /.breadcrumb -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <label class="control-label no-padding-right" for="name">{{__('common.location3')}}</label>
                                        ...
                                        <div class="col-md-2">
                                            <label class="control-label no-padding-right" for="name">{{__('common.location5')}}</label>
                                            <select  multiple name="head_quarter[]" id="head_quarter" class="form-control chosen-select">
                                                <option  value="">select</option>
                                        ...
                                        <div class="col-md-2">
                                            <label class="control-label no-padding-right" for="name">{{__('common.location6')}}</label>
                                            <select  multiple name="town[]" id="town" class="form-control chosen-select">
                                                <option  value="">select</option>
                                                @if(!empty($town))
                                                    @foreach($town as $k=>$r)
                                                        <option value="{{$k}}">{{$r}}</option>
                                        ...
                                        <div class="col-md-2">
                                            <label class="control-label no-padding-right" for="name">{{__('common.distributor')}}</label>
                                            <select  multiple name="retailer[]" id="retailer" class="form-control chosen-select">
                                                <option  value="">select</option>
                                                @if(!empty($retailer))
                                        ...
                                        <div class="col-md-2">
                                            <label class="control-label no-padding-right" for="name">{{__('common.catalog_product')}}</label>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report166.js')}}"></script>
...
$(document).on('change', '#head_quarter', function () {
   val = $(this).val();
   _hq = $('#town');
   //alert(_current_val);
   if(val != '')
