        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.distributor')}} {{Lang::get('common.sales_trends')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
                ...
                <form id="month_form" method="get">
                       <div class="col-xs-6 col-sm-6 col-lg-2">
                                                <div class="">
                                                    ...
                                                    <input value="{{$crmonth}}" autocomplete="off" type="text" placeholder="Select Month" name="year" id="year" class="form-control date-picker">
                                                </div>
...
<table id="dynamic-table" class="table table-bordered" >
   <thead>
    <tr>
        ...
        <th rowspan="3"> {{Lang::get('common.location1')}}</th>

        <th rowspan="3"> {{Lang::get('common.location2')}}</th>
        <th rowspan="3"> {{Lang::get('common.location3')}}</th>
        {{--<th rowspan="3"> BELT</th>--}}
        ...
        {{-- <th colsspan="4">MONTH BALANCE DAYS & MONTH TOTAL</th> --}}
    </tr>
    <tr>
    ...
    @if(!empty($records))
        @foreach($records as $key=>$data)
            <tr>
                <?php $a = []; $b = [];$c = [];?>
                <td rowspan="3">{{$i}}</td>
                <td rowspan="3">{{$data->l1_name}}</td>
                <td rowspan="3">{{$data->l2_name}}</td>
