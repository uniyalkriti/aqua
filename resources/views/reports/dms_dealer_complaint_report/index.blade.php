...
@section('title') 
    <title>{{Lang::get('common.dms_dealer_complaint')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.dms_dealer_complaint')}}</li>
                </ul><!-- /.breadcrumb -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select multiple name="state[]" id="location_3" class="form-control chosen-select">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($state))
...
@section('js')
    ...
    <script src="{{asset('msell/page/report149.js')}}"></script>
