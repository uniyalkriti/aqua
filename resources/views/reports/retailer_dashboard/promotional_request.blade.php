        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.retailer')}} Promotional Request</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <table id="dynamic-table" class="table table-bordered table-hover">
                <thead>
                   <tr>
                        ...
                        <th>{{Lang::get('common.merchandise')}} Name</th>
                        <th>Quantity</th>
                        <th>{{Lang::get('common.remarks')}}</th>
                    ...
                    <tbody>
                        ...
                        @if(!empty($promotional_request_query) && count($promotional_request_query)>0)
                            @foreach($promotional_request_query as $key=>$data)
                                <?php    
                                ...
                                <tr  class="">
                                    ...
                                    <td>{{!empty($data->retailer_name)?$data->retailer_name:''}}</td>
