        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.retailer')}} {{Lang::get('common.merchandise')}} Report</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <table id="dynamic-table" class="table table-bordered table-hover">
                <thead>
                   <tr>
                        ...
                        <th>{{Lang::get('common.merchandise')}} </th>
                        <th>Qty </th>
                        ...
                        @if(!empty($records) && count($records)>0)
                            @foreach($records as $key=>$data)
                                ...
                                <tr  class="">
                                    ...
                                    <td>{{$data->l3_name}}</td>
                                    <td>{{$data->l4_name}}</td>
                                    <td><a href="{{url('distributor/'.$dencid)}}"> {{$data->dealername}} </a></td> 
                                    <td>{{$data->emp_code}}</td>
                                    <td><a href="{{url('user/'.$encid)}}">{{$data->user_name}}</a></td>

                                    <td>{{$data->rolename}}</td> 

                                    <td><a href="{{url('user/'.$sencid)}}">{{$data->seniorname}}</a></td> 
