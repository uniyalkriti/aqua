        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.retailer')}} RDS Report</li>
                </ul><!-- /.breadcrumb -->
            </div>
                        ...
                        @if(!empty($main_query_data) && count($main_query_data)>0)
                            @foreach($main_query_data as $key=>$data)
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->city}}</td>
                                    <td> {{!empty($senior_name[$data->user_id][$data->date])?$senior_name[$data->user_id][$data->date]:'NA'}}</td>
                                    <td><a href="{{url('user/'.$encid)}}"> {{$data->person_name}}</a></td>
                                    <td><a href="{{url('distributor/'.$dencid)}}"> {{$data->dealer_name}}</a></td>
                                    <td><a href="{{url('retailer/'.$rencid)}}">{{$data->retailer_name}}</a></td>
                                    @php 
