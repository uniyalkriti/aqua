        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.retailer')}} Comment Report</li>
                </ul><!-- /.breadcrumb -->
            </div>
                ...
                <thead>
                   <tr>
                    ...
                    <tbody>
                        ...
                        @if(!empty($retailer_comment_query) && count($retailer_comment_query)>0)
                            @foreach($retailer_comment_query as $key=>$data)
                                <?php    
                                    $encid = Crypt::encryptString($data->user_id);
                                    $rencid = Crypt::encryptString($data->dealer_id);
                                    $dencid = Crypt::encryptString($data->retailer_id);
                                ?>
                                ...
                                <tr  class="">
                                    ...
                                    <td>{{$data->state}}</td>
                                    <td><a href="{{url('user/'.$encid)}}" >{{!empty($data->user_name)?$data->user_name:''}}</a></td>
                                    <td>{{$data->designation}}</td>
                                    <td><a href="{{url('distributor/'.$dencid)}}"> {{!empty($data->dealer_name)?$data->dealer_name:''}}</a></td>
                                    <td><a href="{{url('retailer/'.$rencid)}}"> {{!empty($data->retailer_name)?$data->retailer_name:''}}</a></td>
                                    <td>{{$data->address}}</td>
                                    <td>{{$data->time_in}}</td>
                                    <td>{{$data->time_out}}</td>
                                    <td>{{$data->comment}}</td>
                                    <td>{{$data->batter_status}}</td>
