...
@section('title')
    <title>{{Lang::get('common.competitive_price_intelligence')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user')}}">Prospecting</a>
                    </li>
                    <li class="active">{{Lang::get('common.competitive_price_intelligence')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            @else
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user_public_data')}}">{{Lang::get('common.competitive_price_intelligence')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.competitive_price_intelligence')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
