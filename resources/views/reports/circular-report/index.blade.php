...
@section('title')
    <title>{{Lang::get('common.circular_report')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.circular_report')}}</li>
                </ul><!-- /.breadcrumb -->
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">Category Type</label>
                                                <select multiple name="category_type[]" id="category_type" class="form-control chosen-select">
                                                    <option value="">All</option>
                                                    <option Request::get('category_type')=='sms'?'selected':'' value="sms">SMS</option>
                                                    <option Request::get('category_type')=='email'?'selected':'' value="email">E-Mail</option>
                                                    <option Request::get('category_type')=='notifi'?'selected':'' value="notifi">Notification</option>
                                                </select>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report86.js')}}"></script>
