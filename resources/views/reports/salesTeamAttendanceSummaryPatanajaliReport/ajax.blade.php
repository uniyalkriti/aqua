    ...
    @if(!empty($records) && count($records)>0)
        ...
        ?>
                <tr  class="">
                    ...
                    <td>{{$datediff+1}}</td>
                       <td>
                        {{!empty($total_att[$data->user_id])?$total_att[$data->user_id]:0}}
                    </td>
                    <td>
                        ...
                        @if(isset($working_status[$data->user_id.$dvalue]))
                            ...
                            @else
                             <td style="background:#85F092;text-align:center">  
                                <font color="black"> {{!empty($att_time[$data->user_id.$dvalue])?$att_time[$data->user_id.$dvalue]:''}}  </font> <br>
                                <font color="black"> {{!empty($checkOutTime[$data->user_id.$dvalue])?$checkOutTime[$data->user_id.$dvalue]:''}}  </font> 
                             </td> 
                             @endif
