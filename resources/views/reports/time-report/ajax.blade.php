    ...
    @if(!empty($records))
        ...
        <?php $encid = Crypt::encryptString($data["user_id"]); ?>
                ...
                <tr  class="">
                    ...
                    <td style="background-color:#f5d0a9">{{!empty($location_6_name[$data['user_id']])?$location_6_name[$data['user_id']]:'-'}}</td>
                    ...
                    <td style="background-color:#f5d0a9">{{$data['senior_name']}}</td>
                    <td style="background-color:#f5d0a9">{{$data['status']}}</td>
                    <td style="background-color:#f5d0a9">{{$data['date_de']}}</td>
                     {{--<td style="background-color:#f5d0a9">{{$data['date_cse']}}</td> --}}
                    @if(!empty($datesArr))
                    <?php 
                    $total_attd=0; 
                    $absent=0;
                    ...
                    @if(!empty($data[$keydd]->work_status))
                            @if($data[$keydd]->work_status=='LEAVE')
                            <td style="background-color:#FFFF00">{{$data[$keydd]->work_status}}</td>
                                @else
                                <td style="background-color:#85f092">{{$data[$keydd]->work_status}}</td>
                            @endif
                    @else
                    <?php  
