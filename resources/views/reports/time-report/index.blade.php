...
@section('title')
    @if($company_id == 61)
    <title>{{Lang::get('common.attendance')}} Report </title>
    @else
    <title>{{Lang::get('common.mothly_attendance')}}</title>
    @endif
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    @if($company_id == 61)
                    <li class="active">{{Lang::get('common.attendance')}} Report</li>
                    
                    @else
                    <li class="active">{{Lang::get('common.mothly_attendance')}}</li>
                    @endif
                </ul><!-- /.breadcrumb -->
...
@section('js')
    ...
    <script src="{{asset('msell/page/report87.js')}}"></script>
