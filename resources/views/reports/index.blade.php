...
@section('title')
    <title>Distributor SKU wise Monthly Target vs Achievement - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Distributor SKU wise Monthly Target vs Achievement</li>
                </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select  multiple name="region[]" id="state" class="form-control input-sm" style="overflow-y: scroll; ">
                                                @if(!empty($region))
                                        ...
                                        <!-- <div class="col-md-2">
                                            ...
                                            <label class="control-label no-padding-right" for="name">UserName</label>
                                                <select multiple name="user_id[]"  id="user" class="form-control input-sm" style="overflow-y: scroll; ">
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$d)
                                        ...
                                        <div class="col-md-2">
                                            <div class="">
                                                ...
                                                <select multiple name="product[]" id="product" class="form-control input-sm" style="overflow-y: scroll; ">
                                                    @if(!empty($product))
...
@section('js')
    ...
    <script src="{{asset('msell/page/report124.js')}}"></script>
