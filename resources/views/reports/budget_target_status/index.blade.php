...
@section('title')
    <title>{{Lang::get('common.distributer_sales_trend')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{('Tablet Working Status')}}</li>
                </ul><!-- /.breadcrumb -->
                                  ...
                                  <div class="col-xs-6 col-sm-6 col-lg-2">
                                        ...
                                        {{-- <div class="col-xs-6 col-sm-6 col-lg-2">
                                         ...
                                         {{-- <div class="col-xs-6 col-sm-6 col-lg-2">
                                               ...
                                               <input value="{{ !empty(Request::get('start_date'))?date('Y-m-d',strtotime(Request::get('start_date'))):date('Y-m-d') }}" type="text" class="form-control input-sm" name="start_date" id="start_date">
                                                </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                               ...
                                               <input value="{{ !empty(Request::get('end_date'))?date('Y-m-d',strtotime(Request::get('end_date'))):date('Y-m-d') }}" type="text" class="form-control input-sm" name="end_date" id="end_date">
                                                </div>
                                            
                                        </div>  --}}
                                          <div class="col-xs-6 col-sm-6 col-lg-2">
                                      <div class="">
                                                    <label class="control-label no-padding-right" for="name">Month</label>
                                                    <input value="" autocomplete="off" type="text" placeholder="Select Month" name="year" id="year" class="form-control date-picker input-sm valid" aria-required="true" aria-describedby="year-error" aria-invalid="false">
                                                </div>
                                         </div> 
...
@section('js')
    ...
    <script src="{{asset('msell/page/report66.js')}}"></script>
