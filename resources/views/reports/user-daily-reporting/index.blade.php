...
@section('title')
    <title>{{Lang::get('common.daily-reporting-report')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.daily-reporting-report')}}</li>
                </ul><!-- /.breadcrumb -->
...
@section('js')
    ...
    <script src="{{asset('msell/page/report85.js')}}"></script>
