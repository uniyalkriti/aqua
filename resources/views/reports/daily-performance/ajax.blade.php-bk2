...
<table id="simple-table" class="table table-bordered" style="font-size: 13px;border: 1px black;">
    ...
    <tr>
        <td colspan="64"><h3>Day Wise Performance</h3></td>
    </tr>
    <tr>
        ...
        <th rowspan="3">As Per Tour Program(Town)</th>
        <th rowspan="3">As Per Tour Program(Distributor)</th>
        <th rowspan="3">As Per Tour Program(Beat)</th>
        <th rowspan="3">Start Time</th>
        <th rowspan="3">Today's Task</th>
        <th rowspan="3">Actual(Town)</th>
        <th rowspan="3">Actual(Distributor)</th>
        <th rowspan="3">Actual(Beat)</th>
