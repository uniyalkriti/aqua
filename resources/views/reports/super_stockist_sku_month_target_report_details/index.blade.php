...
@section('title')
    <title>{{Lang::get('common.ss_sku_wise_monthly')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.ss_sku_wise_monthly')}}</li>
                </ul><!-- /.breadcrumb -->
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select  multiple name="region[]" id="state" class="form-control chosen-select">
                                                @if(!empty($region))
                                   ...
                                   {{-- <div class="col-md-3">
                                            <div class="">
                                                ...
                                                <select multiple name="call_status[]" id="call_status" class="form-control input-sm" style="overflow-y: scroll; ">
...
@section('js')
    ...
    <script src="{{asset('msell/page/report123.js')}}"></script>
