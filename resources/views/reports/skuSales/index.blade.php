...
@section('title')
    <title>SKU Sales - {{config('app.name')}}</title>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report165.js')}}"></script>
