...
@section('title')
    <title>{{Lang::get('common.user_wise_mtp')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.user_wise_mtp')}}</li>
                </ul><!-- /.breadcrumb -->
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="stock-status" role="form"
                            ...
                            @include('common_filter.filter')
                                      ...
                                      <!--   <div class="col-md-2">
                                            ...
                                            <select  required="required" multiple name="state[]" id="state" class="form-control chosen-select">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <label class="control-label no-padding-right" for="name">UserName</label>
                                                <select required="required" multiple name="user[]"  id="user" class="form-control chosen-select">
                                                    <option value="">select</option>
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$d)
...
@section('js')
    ...
    <script src="{{asset('msell/page/report92.js')}}"></script>
