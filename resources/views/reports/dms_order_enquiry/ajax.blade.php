...
{{Lang::get('common.order_enquiiry')}}
...
<table id="dynamic-table" class="table table-bordered" >
    ...
    <tr>
        ...
        <th >Contact No.</th>
        <th >Distributor Remarks</th>

        <th >Support Team Remarks</th>
        <th >Support Team Remarks Submit Date & Time</th>
        <th >Status</th>
    ...
    @foreach($main_query_data as $k=> $r)
        ...
        <tr>
            ...
            <td>{{!empty($r->support_team_remarks_submit_date_time)?$r->support_team_remarks_submit_date_time:''}}</td>
            ...
            <td>
                <button type="button" dealerid="{{$r->dealer_id}}" date="{{!empty($r->date)?$r->date:''}}" enquiry_id="{{$r->enquiry_id}}"
    ...
    <div class="modal-dialog" style="width:900px;">
        ...
        <div class="modal-content" id ="modalDiv">
            ...
            <div class="modal-body" id="qwerty">
                <form action="dms_update_enquiry_details" method="post" id="reciept_modal_form" enctype="multipart/form-data">
                    {!! csrf_field() !!}

                    <input type="hidden" id="dealer_id_c" name="dealer_id" value="">
                    <input type="hidden" id="date_c" name="date" value="">
                    <input type="hidden" id="enquiry_id_c" name="enquiry_id" value="">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            <td style="text-align: left; ">&nbsp;&nbsp;Support Team Remarks</td>
                            <td style="text-align: left;">&nbsp;&nbsp;<textarea style=" height: 85px; width:513px; " style="top-margin:100px;" type="text" class="form-control-file" name="team_remarks" id="team_remakrs" required></textarea></td>
                        </tr>
