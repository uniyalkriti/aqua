        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#market-beat-plan" class="btn btn-sm btn-default"><i
            ...
            <div class="page-content" style="padding-top: 0;">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="market-beat-plan"
                              role="form"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="belt[]" multiple class="form-control chosen-select input-sm"
                                                        id="belt">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="distributor[]"
                                                        class="form-control chosen-select distributor" id="distributor">
                                                    <option disabled="disabled" value="">Select</option>
                                            ...
                                            <span id="dis-err" class="val-error" style="color: red;display: none">Select distributor first.</span>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="">
                                                <label for="beat" class="control-label">Beat</label>
                                                <select name="beat[]" multiple class="form-control chosen-select"
                                                        id="beat">
                                                    <option disabled="disabled" value="">Select</option>
                                                    @if(!empty($beat))
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="select month"
                                                       name="month" id="month" class="form-control input-sm">
                                            </div>
                                        </div>
