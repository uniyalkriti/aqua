        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user')}}">{{Lang::get('common.competitors_new_product')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.competitors_new_product')}} Dashboard</li>
                </ul><!-- /.breadcrumb -->
            </div>
            @else
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        <i class="ace-icon fa fa-home home-icon"></i>
                        <a href="{{url('user_public_data')}}">Home</a>
                    </li>

                    <li>
                        <a href="{{url('user_public_data')}}">{{Lang::get('common.competitors_new_product')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.competitors_new_product')}} Dashboard</li>
                </ul><!-- /.breadcrumb -->
            </div>
