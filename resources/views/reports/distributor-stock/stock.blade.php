        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.distributor')}} {{Lang::get('common.stock')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <table id="dynamic-table" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Submit {{Lang::get('common.date')}}</th>
                    </tr>
                </thead>
                    <tbody>
                        @if(!empty($records) && count($records)>0)
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>{{(!empty($record->mfg_date) && $record->mfg_date!='0000-00-00' && $record->mfg_date!='1970-01-01')?date('d-M-Y',strtotime($record->mfg_date)):'NA'}}</td>
                                    <td>{{!empty($record->exp_date) && $record->exp_date!='0000-00-00' && $record->exp_date!='1970-01-01' ?date('d-M-Y',strtotime($record->exp_date)):'-'}}</td>
