...
<table style="border: 1px solid black; border-style: collapse;">
    <tr style="border: 1px solid black; padding: 10px;"><td style="border: 1px solid black; padding: 10px; background-color: #6b5b95" colspan="20" align="center"><h3>Daily Sale Report({{$yesterday}})</h3></td></tr>

     <tr style="border: 1px solid black; padding: 10px;">

        <td style="border: 1px solid black; padding: 10px; background-color: #5b9bd5" colspan="12" align="center">
            <h3>Values</h3>
        </td>
    ...
    ?>
    @if(!empty($locationFive))
        @foreach($locationFive as $key1=>$data1)
        <?php 

        $key = $data1->id;
        $data = $data1->name;

        $manager = !empty($data1->user_name)?$data1->user_name:'NA';
