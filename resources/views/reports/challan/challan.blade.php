...
@section('title')
    <title>{{Lang::get('common.stock')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('distributor')}}">Distributor Stock</a>
                    </li>
                    <li class="active">Distributor Stock</li>
                </ul><!-- /.breadcrumb -->
            </div>
            <div class="page-content">
                ...
                <form id="month_form" method="get">
                        <div class="col-sm-2">
                            <div class="center">
                                    <input data-date-format="YYYY-MM-DD" value="{{ !empty(Request::get('start_date'))?date('Y-m-d',strtotime(Request::get('start_date'))):date('Y-m-d') }}" type="date" class="form-control input-sm" name="start_date" id="start_date">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="center">
                                    <input data-date-format="YYYY-MM-DD" value="{{ !empty(Request::get('end_date'))?date('Y-m-d',strtotime(Request::get('end_date'))):date('Y-m-d') }}" type="date" class="form-control input-sm" name="end_date" id="end_date">
                            </div>
                        </div>
                        <div class="col-sm-2">
...
<table id="dynamic-table" class="table table-bordered table-hover">
    ...
    @if(!empty($challan))
        ...
        <th>Value</th>
               ...
               <?php $total=0;
                $totalqty=0; ?>
                 @foreach($details[$data->id] as $k1=>$data1)
