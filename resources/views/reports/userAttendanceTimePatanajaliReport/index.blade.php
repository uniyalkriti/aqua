...
@section('title')
    <title>{{Lang::get('common.attendance_time_report')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.attendance_time_report')}}</li>
                </ul><!-- /.breadcrumb -->
...
@section('js')
    ...
    <script src="{{asset('msell/page/report170.js')}}"></script>
