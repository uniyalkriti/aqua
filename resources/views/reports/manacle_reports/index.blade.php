...
@section('title')
    <title>{{Lang::get('common.manacle_reports')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.manacle_reports')}}</li>
                </ul><!-- /.breadcrumb -->
...
@section('js')
    ...
    <script src="{{asset('msell/page/report118.js')}}"></script>
