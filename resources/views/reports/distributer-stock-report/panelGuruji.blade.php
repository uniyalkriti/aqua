...
<table id="dynamic-table" class="table table-bordered" style="font-size: 13px;border: 1px black">
   <thead>
    <tr>
        <th>{{Lang::get('common.depo')}} Code</th>
        <th>{{Lang::get('common.depo')}} Name</th>
        <th>{{Lang::get('common.bill')}} No</th>
        <th>{{Lang::get('common.bill')}} Date</th>
        <th>Stockist Code</th>
        <th>Stockist Name</th>
        <th>{{Lang::get('common.catalog_4')}}</th>
        <th>{{Lang::get('common.catalog_4')}} Code </th>
        <th>Batch No </th>
        <th>Expiry {{Lang::get('common.date')}} </th>
        <th>Quantity </th>
        <th>Free Qty </th>
        ...
        ?>
            @if(!empty($order_detial_arr[$record->order_id]))
                @foreach($order_detial_arr[$record->order_id] as $order_data)
                    <tr>
                         <td>{{$record->csa_code}}</td>
                        <td>{{$record->csa_name}}</td>
                        ...
                        <td>{{$order_data->itemcode}}</td>
                        <td></td>
                        <td></td>
                        <td>{{$pcs=(($order_data->pcs)+($order_data->cases*$order_data->quantity_per_case))}}</td>
                        <td></td>
                        <td>{{!empty($product_rate_details[$order_data->product_id.$record->l3_id])?$product_rate_details[$order_data->product_id.$record->l3_id]:''}}</td>
