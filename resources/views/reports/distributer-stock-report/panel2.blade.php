...
<table id="dynamic-table" class="table table-bordered" style="font-size: 13px;border: 1px black">
   <thead>
    <tr>
      ...
      <th>{{Lang::get('common.date')}} {{Lang::get('common.time')}}</th>

      <th>{{Lang::get('common.return')}} Id</th>
    ...
    <tbody>
      ...
      $sid = Crypt::encryptString($record->person_id_senior);
      ...
      ?>
        ...
        <tr>
          ...
          <td><a href="{{('user/'.$uid)}}">{{$record->user_name}}</a></td>
          <td>{{$record->rolename}}</td>
          <td>{{$record->mobile}}</td>
          <td><a href="{{('user/'.$sid)}}">{{!empty($senior_name[$record->person_id_senior])?$senior_name[$record->person_id_senior]:''}}</a></td>

          <td><a href="{{('distributor/'.$did)}}">{{$record->dealer_name}}</a></td>
