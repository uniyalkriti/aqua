...
@section('title')
    <title>{{Lang::get('common.dailyAttendanceEditReport')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.dailyAttendanceEditReport')}}</li>
                </ul><!-- /.breadcrumb -->
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="sale-order" role="form"
                            ...
                            @include('common_filter.filter')
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right" for="name">Date</label>
                                                <input value="" autocomplete="off" type="text" placeholder="From Date" name="date" id="date" class="form-control date-picker" required>
                                            </div>
                                        </div>
                                  <!--   <div class="col-xs-6 col-sm-6 col-lg-2">
...
@section('js')
    ...
    <script src="{{asset('msell/page/report171.js')}}"></script>
