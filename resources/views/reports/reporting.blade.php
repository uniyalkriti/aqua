        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.daily-reporting-report')}} {{Lang::get('common.dashboard')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            @else
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <div class="page-content">
                ...
                <form id="month_form" method="get">
                        <div class="col-sm-2">
                            <div class="center">
                                    <input data-date-format="YYYY-MM-DD" value="{{ !empty(Request::get('start_date'))?date('Y-m-d',strtotime(Request::get('start_date'))):date('Y-m-d') }}" type="text" class="form-control date-picker input-sm" name="start_date" id="start_date">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="center">
                                    <input data-date-format="YYYY-MM-DD" value="{{ !empty(Request::get('end_date'))?date('Y-m-d',strtotime(Request::get('end_date'))):date('Y-m-d') }}" type="text" class="form-control date-picker input-sm" name="end_date" id="end_date">
                            </div>
                        </div>
                        <div class="col-sm-2">
...
<div class="pull-right tableTools-container"></div>
    ...
    <tr>
        ...
        <th>Work With</th>
        <th>Work {{Lang::get('common.status')}}</th>
    </tr>
    </thead>
    <tbody>
    @if(!empty($sale_data))
