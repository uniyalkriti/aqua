...
@section('title')
    <title>{{Lang::get('common.competitors_new_product')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.competitors_new_product')}}</li>
                </ul><!-- /.breadcrumb -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="position[]" id="position" multiple class="form-control chosen-select input-sm">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($position))
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="user" id="user" class="form-control chosen-select input-sm">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$r)
                                                            <option value="{{$k}}">{{$r}}</option>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report7.js')}}"></script>
