...
@section('title')
    <title>{{Lang::get('common.finalStock')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.finalStock')}}</li>
                </ul><!-- /.breadcrumb -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="row">
                                      ...
                                      <!--   <div class="col-md-2">
                                            <label class="control-label no-padding-right" for="name">SS</label>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <label class="control-label no-padding-right" for="name">Distributor</label>
                                                <select multiple name="dealer[]"  id="dealer" class="form-control chosen-select" required>
                                                    <option value="">select</option>
                                                    @if(!empty($dealer))
...
@section('js')
    ...
    <script src="{{asset('msell/page/report167.js')}}"></script>
