...
<div class="table-header center">
   {{Lang::get('common.unbilledOutletReport')}}
...
<table id="dynamic-table" class="table table-bordered" style="font-size: 13px;border: 1px black">
   <thead>
    <tr class="info" style="color: black;">
        ...
        <th>Senior Name One</th>
        <th>Senior Name Two</th>
        ...
        <th>Remarks (Productive/ Non Productive/ NoVisit)</th>
    ...
    @if(!empty($records) && count($records)>0)
        ...
        ?>
                <tr  class="">
                    ...
                    <td>{{$data['senior_name_one']}}</td>
                    <td>{{$data['senior_name_two']}}</td>
                    ...
                    <td>{{$data['retailer_contact']}}</td>
                    <td>{{$data['sale_remarks']}}</td>
