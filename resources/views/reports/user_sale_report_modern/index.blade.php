...
@section('title')
    <title>Modern Order Booking Report - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Modern Order Booking Report</li>
                </ul><!-- /.breadcrumb -->
                        ...
                        <label class="control-label no-padding-right" for="name">{{Lang::get('common.location2')}}</label>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="control-label no-padding-right" for="name">UserName</label>
                                                <select multiple name="user_id[]"  id="user_id" class="form-control chosen-select">
                                                    <option value="">select</option>
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$d)
...
@section('js')
    ...
    <script src="{{asset('msell/page/reportmodern90.js')}}"></script>
