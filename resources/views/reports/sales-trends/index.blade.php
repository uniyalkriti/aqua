...
@section('title')
    <title>{{Lang::get('common.sales_trends')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.sales_trends')}}</li>
                </ul><!-- /.breadcrumb -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-lg-2">
                                    <div class="">
                                        ...
                                        <select multiple name="distributor[]" id="distributor" class="form-control chosen-select input-sm">
                                            <option disabled="disabled"  value="">Select</option>
                                ...
                                <div class="col-xs-6 col-sm-6 col-lg-2">
                                    <div class="">
                                        <label class="control-label no-padding-right"
                                               for="name">Year</label>
                                        <input value="" autocomplete="off" type="text" placeholder="Select Year" name="year" id="year" class="form-control date-picker input-sm">
                                    </div>
                                </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report18.js')}}"></script>
