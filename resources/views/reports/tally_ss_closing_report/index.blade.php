...
@section('title')
    <title>Tally Reports - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Tally SS-Bill-Stock</li>
                </ul><!-- /.breadcrumb -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                         ...
                                         <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">Super Stockist</label>
                                                <select multiple name="stockist[]" id="stockist" class="form-control chosen-select">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($super_stockist_name))

                                                        @foreach($super_stockist_name as $k=>$r)
                                                            <option value="{{$r->c_id}}">{{$r->csa_name}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report80.js')}}"></script>
