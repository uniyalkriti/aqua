...
@section('title')
    <title>{{Lang::get('common.db_monthly')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.db_monthly')}}</li>
                </ul><!-- /.breadcrumb -->
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">User</label>
                                                <select multiple name="user[]" id="user" class="form-control input-sm" style="overflow-y: scroll; ">
                                                    @if(!empty($users))
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-1">
                                            <button type="submit" class="form-control btn btn-sm btn-primary btn-block mg-b-10"
...
@section('js')
    ...
    <script src="{{asset('msell/page/report126.js')}}"></script>
