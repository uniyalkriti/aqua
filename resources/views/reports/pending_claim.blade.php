        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user')}}">{{Lang::get('common.pending_claim')}}</a>
                    </li>
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user_public_data')}}">{{Lang::get('common.pending_claim')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.pending_claim')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <thead>
                        ...
                        <?php $dencid = Crypt::encryptString($record->distributor_id); ?>
                            <tr>
                                <td>{{$key+1}}</td>
