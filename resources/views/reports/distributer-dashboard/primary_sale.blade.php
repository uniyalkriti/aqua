        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.distributor')}} {{Lang::get('common.primary_sale')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <table id="dynamic-table" class="table table-bordered table-hover">
                <thead>
                   <tr>
                        ...
                        <th rowspan="2">{{Lang::get('common.distributor')}} {{Lang::get('common.location6')}}</th>
                        {{--<th>Created Date</th>--}}
                            ...
                            @foreach($records as $record)
                                @if(!empty($order_detial_arr[$record->order_id]))
                                    @foreach($order_detial_arr[$record->order_id] as $order_data)
                                     <?php 
                                         $encid = Crypt::encryptString($record->created_person_id);
                                    ?>
                                        <tr>
                                            <td>{{$i++}}</td>
