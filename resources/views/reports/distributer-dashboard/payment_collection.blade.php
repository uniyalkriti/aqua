        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.dealer_detail')}} {{Lang::get('common.payment_collection')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <table id="dynamic-table" class="table table-bordered table-hover">
                <thead>
                   <tr>
                        ...
                        <th>Payment Mode</th>
                        <th>Invoice</th>
                        <th>Payment Recevied {{Lang::get('common.date')}}</th>
                        <th>Amount</th>
                        <th>Drawn from Bank</th>
                        <th>Deposited Bank</th>
                        <th>Deposited {{Lang::get('common.date')}}</th>
                    </tr>
                </thead>
                    <tbody>
