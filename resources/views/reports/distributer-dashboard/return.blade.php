        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.distributor')}} {{Lang::get('common.return')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            ...
            <table id="dynamic-table" class="table table-bordered table-hover">
                <thead>
                   <tr>
                      ...
                      <th>{{Lang::get('common.catalog_4')}} Qty</th>
                      <th>{{Lang::get('common.catalog_4')}} value</th>
                      <th>{{Lang::get('common.date')}} Time</th>
                      {{--<th>Location</th>--}}
                      {{--<th>Reason</th>--}}
                    ...
                    <tbody>
                      ...
                      <?php 
                            ...
                            $dencid = Crypt::encryptString($record->dealer_id);
                            $rencid = Crypt::encryptString($record->retailer_id);

                        ?>
                        
                        <tr>
                          <td>{{$i++}}</td>
                          <td><img id="user_image" style="height: 60px;width: 60px;" class="nav-user-photo"  
                    src="http://bambinoagro.msell.in/bambinoagro_api/webservices/mobile_images/Dealer_Damage_Image/{{!empty($record->image)?$record->image:'N/A'}}" alt= " "/></td>
                          <td>{{$record->replaceid}}</td>


                          <td>
                            <a href="{{url('user/'.$encid)}}" >
                                {{$record->user_name}}
                            </a>
                          </td>
