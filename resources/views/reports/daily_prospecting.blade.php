...
@section('title')
    <title>{{Lang::get('common.daily_prosecting')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.daily_prosecting')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
            @else
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('user_public_data')}}">{{Lang::get('common.daily_prosecting')}}</a>
                    </li>
                    <li class="active">{{Lang::get('common.daily_prosecting')}}</li>
                </ul><!-- /.breadcrumb -->
            </div>
