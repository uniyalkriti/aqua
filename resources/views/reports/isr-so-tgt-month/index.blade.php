...
@section('title')
    <title>{{Lang::get('common.isr_so_tgt')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.isr_so_tgt')}}</li>
                </ul><!-- /.breadcrumb -->
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#isr-so-tgt" class="btn btn-sm btn-default"><i class="fa fa-navicon mg-r-10"></i> Filter</a>
                </p>
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="isr-so-tgt" role="form"
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">User</label>
                                                <select multiple name="user[]" id="user" class="form-control chosen-select  input-sm">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$r)
                                                            <option value="{{$k}}">{{$r}}</option>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">From Month</label>
                                                <input autocomplete="off" type="text" name="from_date" id="from_date" class="form-control input-sm" placeholder="From Date">
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                <label class="control-label no-padding-right"
                                                       for="name">To Month</label>
                                                <input autocomplete="off" type="text" name="to_date" id="to_date" class="form-control input-sm" placeholder="To Date">
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report17.js')}}"></script>
