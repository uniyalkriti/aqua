...
<table style="border: 1px solid black; border-style: collapse;">
    ...
    <tr  style="border: 1px solid black; padding: 10px;">
        ...
        <th  style="border: 1px solid black; padding: 10px; background-color: #b2ad7f;" colspan="14">{{date('d-M-Y',strtotime($datad))}}</th>
        @endforeach
                ...
                <tr  class="" style="border: 1px solid black; padding: 10px;">
                    @if(!empty($location_5[$data['user_id']]))
                        @if($location_5[$data['user_id']] != 'Head Office')
                            ...
                            <td style="border: 1px solid black; padding: 10px; background-color: lightgrey;">0</td>
