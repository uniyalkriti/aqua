...
@section('title')
    <title>{{Lang::get('common.new_sd_dist_prospecting')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.new_sd_dist_prospecting')}}</li>
                </ul><!-- /.breadcrumb -->
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#new-sd-dist-prospecting" class="btn btn-sm btn-default"><i class="fa fa-navicon mg-r-10"></i> Filter</a>
                </p>
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="new-sd-dist-prospecting" role="form"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="zone[]" id="zone" multiple class="form-control chosen-select input-sm">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="region[]" id="region" multiple class="form-control chosen-select input-sm">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($region))
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="state[]" id="state" multiple class="form-control chosen-select input-sm">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($state))
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="user[]" id="user" multiple class="form-control chosen-select input-sm">
                                                    <option disabled="disabled" value="">select</option>
                                                    @if(!empty($user))
                                                        @foreach($user as $k=>$r)
                                                            <option value="{{$k}}">{{$r}}</option>
                                            ...
                                            <span id="user-err" class="val-error" style="color: red;display: none;">Select user first.</span>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report24.js')}}"></script>
