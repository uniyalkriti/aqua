...
@section('title')
    <title>Product Tracker - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Product Tracker</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="Post" id="stock-status" role="form"
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select  multiple name="dealer_id[]" id="dealer_id" class="form-control chosen-select">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="control-label no-padding-right" for="name">Product Name</label>
                                                <select multiple name="catalog_id[]"  id="catalog_id" class="form-control chosen-select">
                                                    <option value="">select</option>
                                                    @if(!empty($product))
                                                        @foreach($product as $k=>$d)
...
@section('js')
    ...
    <script src="{{asset('msell/page/report110.js')}}"></script>
