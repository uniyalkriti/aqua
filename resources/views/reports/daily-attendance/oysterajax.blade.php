   ...
   <thead>
    ...
    @if(!empty($records) && count($records)>0)
        @foreach($records as $key=>$data)
            ...
            {
                if(date('H:i:s',strtotime($data[$u['person_id']]->work_date))>'10:15:00')
                {
                    $color_code = '#e60000';
        ...
        //                         }
                    ...
                    <td>{{ !empty($data[$u['person_id']]->work_date)?date('d-M-Y H:i:s',strtotime($data[$u['person_id']]->work_date)):'Mispunch' }}</td>
                    ...
                    {{--
                    @if( !empty($data[$u['person_id']]->work_date) && date('H:i:s',strtotime($data[$u['person_id']]->work_date))>'10:15:00' )
                    <td>Half Day</td>
                    @elseif(!empty($data[$u['person_id']]->att_status) && $data[$u['person_id']]->att_status == 1)
                    <td>By SFA</td>
                    ...
                    <td>{{ !empty($data[$u['person_id']]->check_out_date)?date('d-M-Y H:i:s',strtotime($data[$u['person_id']]->check_out_date)):'Mispunch' }}</td>
