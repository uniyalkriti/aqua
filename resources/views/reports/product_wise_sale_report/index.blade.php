...
@section('title')
    <title>{{Lang::get('common.date_wise_product_wise_report')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.date_wise_product_wise_report')}}</li>
                </ul><!-- /.breadcrumb -->
                                    ...
                                    <div class="row">
                                         <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select multiple name="zone[]" id="zone" class="form-control chosen-select">
...
@section('js')
    ...
    <script src="{{asset('/msell/page/report83.js')}}"></script>
