...
@section('title')
    <title>{{Lang::get('common.aging')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.aging')}}</li>
                </ul><!-- /.breadcrumb -->
                <p class="bs-component pull-right">
                    <a href="#" data-toggle="collapse" data-target="#aging" class="btn btn-sm btn-default"><i class="fa fa-navicon mg-r-10"></i> Filter</a>
                </p>
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="aging" role="form"
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            ...
                                            <span id="region-err" class="val-error" style="color: red;display: none">Select {{Lang::get('common.location3')}} First</span>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-lg-2">
                                            <div class="">
                                                ...
                                                <select name="distributor" id="distributor" class="form-control chosen-select">
                                                    <option value="">select</option>
                                                </select>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{asset('msell/page/report10.js')}}"></script>
