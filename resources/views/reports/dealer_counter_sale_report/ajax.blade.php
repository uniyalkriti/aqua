...
{{Lang::get('common.dealer_counter_sale')}}
...
<thead>
    <tr class="info" style="color: black;">
        ...
        <th>{{Lang::get('common.total')}} Sale Value</th>
        ...
        @foreach($main_query_data as $key=>$data)
            ...
            ?>
                <tr  class="">
                    ...
                    <td>{{$data->cases}}</td>
                    <td>{{$data->case_rate}}</td>
                    <td>{{$data->pieces}}</td>
                    <td>{{$data->piece_rate}}</td>
                    <td>{{ROUND($data->total_sale,2)}}</td>

                    @php 
                    $cases_sum[] = !empty($data->cases)?$data->cases:'0';
                    $pieces[] = !empty($data->pieces)?$data->pieces:'0';
                    $sale_value[] = !empty($data->total_sale)?$data->total_sale:'0';
                    @endphp 
    ...
    <tfoot>
          ...
          <th>{{array_sum($cases_sum)}}</th>
          <th>-</th>
          <th>{{array_sum($pieces)}}</th>
          <th>-</th>
          <th>{{array_sum($sale_value)}}</th>
        </tr>
        </tfoot>
