...
@section('title')
    <title>{{Lang::get('common.payment_details')}} - {{config('app.name')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.payment_details')}}</li>
                </ul><!-- /.breadcrumb -->
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="GET" id="daily-attendance" role="form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-lg-1">
                                    <div class="">
                                        <label class="control-label no-padding-right"
                                               for="name">Date</label>
                                        <input placeholder="Select Date" type="text" name="date" id="date" class="form-control input-sm">
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-lg-1">
                            ...
                            <div class="row">
                                {{--<div class="col-xs-6 col-sm-6 col-lg-2">--}}
                                    {{--<div class="">--}}
                                        {{--<label class="control-label no-padding-right" for="name">Receipt</label>--}}
                                        {{--<select name="receipt" id="receipt" class="form-control chosen-select">--}}
                                            {{--<option value="">Select</option>--}}
                                        {{--</select>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
...
@section('js')
    ...
    <script src="{{asset('msell/page/report6.js')}}"></script>
