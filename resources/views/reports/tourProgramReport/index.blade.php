...
@section('title')
    <title>{{Lang::get('common.tour_program')}}</title>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">{{Lang::get('common.tour_program')}}</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal open collapse in" action="" method="post" id="sale-order" role="form"
                              enctype="multipart/form-data">
                            {!! csrf_field() !!}
                              <input type="hidden" name="submit_url" id="submit_url" value="tourProgramReport">
