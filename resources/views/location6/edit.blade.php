        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('location6')}}">{{Lang::get('common.location6')}}</a>
                    </li>

                    <li class="active">Edit {{Lang::get('common.location6')}}</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::open(array('route'=>['location6.update',$encrypt_id] , 'method'=>'PUT','id'=>'location6-form','role'=>'form' ))!!}
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select name="location_1" id="location_1" class="form-control chosen-select">
                                                ...
                                                @foreach($location1_info as $key =>$country)
                                                    <option {{ $country_code==$key ? 'selected':''}} value="{{$key}}">{{$country}}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select name="location_3" id="location_3" class="form-control chosen-select">
                                                <option value="">select</option>
                                                @foreach($location3_info as $key =>$state)
                                                    <option {{ $s_code == $key ? 'selected':''}} value="{{$key}}">{{$state}}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select name="location_4" id="location_4" class="form-control chosen-select">
                                                <option value="">select</option>
                                                @foreach($location4_info as $key =>$hq)
                                                    <option {{ $h_code == $key ? 'selected':''}} value="{{$key}}">{{$hq}}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select name="location_5" id="location_5" class="form-control chosen-select">
                                                <option value="">select</option>
                                                @foreach($location5_info as $key =>$district)
                                                    <option {{ $t_code == $key ? 'selected':''}} value="{{$key}}">{{$district}}</option>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-5 col-md-7">
                                ...
                                <button class="btn" type="button" onclick="document.location.href='{{url('location6')}}'">
...
<script type="text/javascript">
    ...
    <script src="{{asset('msell/page/location6.js')}}"></script>
