        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Add {{Lang::get('common.location1')}}</li>
                </ul><!-- /.breadcrumb -->
                <!-- /.nav-search -->
            </div>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{route('location1.store')}}" method="POST" id="location1-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="">
                                                ...
                                                <input class="form-control" type="text" name="zone" maxlength="100" minlength="1" id="zone">
                                            </div>
                                        </div>
