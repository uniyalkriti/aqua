        ...
        <div class="main-content-inner" style="background-color: #dff0d8;">
            <div class="breadcrumbs ace-save-state center" id="breadcrumbs" style="background-color: #fcf8e3;">
                <ul class="breadcrumb">
                    ...
                    <li class="active" style="text-align: center;"><b>Approval View</b></li>
                </ul>
            ...
            <div class="page-content" style="background-color: #dff0d8;">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{url('update_expense_approval')}}" method="get"
                              id="{{$current_menu}}-form" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                          
                          <!-- important hidden fields -->
                          <input type="hidden" name="expense_primary_id" value="{{$expense_primary_id}}">
                          ...
                          <!-- important hidden fields -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
                                    <div class="">
                                         <label class="control-label no-padding-right" for="module">  Fare <b style="color: red;">*</b></label>
                                        <input required="required" value="{{$value->fare}}" placeholder="Fare" type="text"
                                               id="fare" name="fare" class="form-control input-sm vnumerror">
                                        <a id="appen_data_validation" style="color: red;"></a>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="module">  DA <b style="color: red;">*</b></label>
                                        <input required="required"  value="{{$value->da}}" placeholder="DA" type="text"
                                               id="da" name="da" class="form-control input-sm vnumerror" />
                                        <a id="appen_data_validation" style="color: red;"></a>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 widget-container-col ui-sortable">
                                    <div class="">
                                        <label class="control-label no-padding-right" for="module">  Telephone Expense <b style="color: red;">*</b></label>
                                        <input required="required" value="{{$value->telephoneExpense}}" placeholder="Telephone Expense" type="text"
                                               id="telephoneExpense" name="telephoneExpense" class="form-control input-sm vnumerror" />
                                        <a id="appen_data_validation" style="color: red;"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-5 col-md-7">
                                    <input class="btn btn-info btn-sm" type="submit" name="submit" value="Approve">
                                    <input class="btn btn-danger btn-sm" type="submit" name="cancel" value="Cancel">
                                </div>
                            </div>
                            </div>
                            <!-- <div class="clearfix form-actions">
