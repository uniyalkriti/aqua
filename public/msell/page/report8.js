...
$(function () {
    ...
    $('#daily-attendance').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "GET",
                url: domain + '/travelling-expenses-report',
                // dataType: 'json',
                data: $('form').serialize(),
...
function fnExcelReport() {
    var filename = "Travelling Expense";
    ...
    tab_text = tab_text.replace(/<A[^>]*>|<\/A>/g, "");//remove if u want links in your table
        tab_text = tab_text.replace(/<img[^>]*>/gi, ""); // remove if u want images in your table
            ...
            tab_text = tab_text.replace(/<A[^>]*>|<\/A>/g, "");//remove if u want links in your table
    tab_text = tab_text.replace(/<img[^>]*>/gi, ""); // remove if u want images in your table
    // tab_text = tab_text.replace(/<ul[^>]*>/gi, ""); // remove if u want images in your table
    // tab_text = tab_text.replace(/<ul[^>]*>/gi, ""); // remove if u want images in your table
    tab_text = tab_text.replace(/<input[^>]*>|<\/input>/gi, ""); // reomves input params
    tab_text = tab_text.replace(/<button[^>]*>|<\/button>/gi, ""); // reomves input params
    tab_text = tab_text.replace(/<ul[^>]*>|<\/ul>/gi, ""); // reomves input params
    tab_text = tab_text.replace(/<li[^>]*>|<\/li>/gi, ""); // reomves input params
